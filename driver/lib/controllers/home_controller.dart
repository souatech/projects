...
class HomeController extends GetxController {
  ...
  Future<void> changeData() async {
    // print("currentOrder.value.status :: ${currentOrder.value.id} :: ${currentOrder.value.status} :: ( ${orderModel.value.driver?.vendorID != null} :: ${orderModel.value.status})");
  ...
  Rx<location.LatLng> current = location.LatLng(0.0, 0.0).obs;
