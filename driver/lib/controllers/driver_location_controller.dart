...
class DriverLocationController extends GetxController {
  StreamSubscription? _driverListSubscription;
  ...
  Future<void> getDriverList() async {
    ...
    _driverListSubscription = FireStoreUtils.fireStore.collection(CollectionName.users).where("ownerId", isEqualTo: FireStoreUtils.getCurrentUid()).where("isOwner", isEqualTo: false).snapshots().listen(
      (event) {
  ...
  @override
  void onClose() {
    _driverListSubscription?.cancel();
    super.onClose();
  }
}
