...
class CabOrderModel {
  ...
  CabOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    scheduleDateTime = _parseTimestamp(json['scheduleDateTime']);
    duration = json['duration'];
    roundTrip = json['roundTrip'];
    paymentStatus = json['paymentStatus'];
    discount = json['discount'] == null ? "0.0" : json['discount'].toString();
    destinationLocationName = json['destinationLocationName'] ?? json['destinationName'];
    authorID = json['authorID'] ?? json['customerId'];
    ...
    sourceLocationName = json['sourceLocationName'] ?? json['sourceName'];
    rideType = json['rideType'];
    triggerDelevery = _parseTimestamp(json['trigger_delevery']);
    id = json['id'];
    adminCommission = json['adminCommission'];
    couponCode = json['couponCode'];
    scheduleReturnDateTime = _parseTimestamp(json['scheduleReturnDateTime']);
    ...
    subTotal = (json['subTotal'] ?? json['price'])?.toString();
    ...
    collectedAt = _parseTimestamp(json['collected_at']);
