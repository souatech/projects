const Map<String, String> trFR = {
  ...
  'Sign in to your JOXMAKO account and manage your deliveries seamlessly.':
      'Sign in to your JOXMAKO account and manage your deliveries seamlessly.',
  ...
  "Payé": "Payé",
  "Argent collecté": "Argent collecté",
  "Espèces à remettre": "Espèces à remettre",
  "Historique des gains": "Historique des gains",
  ...
  "Check out JOXMAKO, your ultimate delivery application!":
      "Découvre JOXMAKO, ton application de livraison.",
  ...
  "Active": "Active",
  "New Order not found.": "Aucune nouvelle livraison",
  "deliver_to_the": "Livrer à",
  ...
  "Bill Details": "Détails du paiement",
  ...
  "Your Setup is pending": "Configuration en attente",
  ...
  "Continue": "Continuer",
  "Historique des livraisons du jour": "Historique des livraisons du jour",
  "Withdrawal History": "Historique des paiements",
  "Aucune livraison aujourd’hui": "Aucune livraison aujourd’hui",
  "Gain driver": "Gain driver",
  "Méthode de paiement": "Méthode de paiement",
  "Demande de paiement": "Demande de paiement",
  "Disponible": "Disponible",
  "Montant demandé": "Montant demandé",
  "Numéro de paiement": "Numéro de paiement",
  "Note": "Note",
  "Optionnel": "Optionnel",
  "Envoyer la demande": "Envoyer la demande",
  "Envoi…": "Envoi…",
  "Entrer un montant valide": "Entrer un montant valide",
  "Entrer le numéro de paiement": "Entrer le numéro de paiement",
  "Demande envoyée": "Demande envoyée",
  "Montant supérieur aux gains disponibles":
      "Montant supérieur aux gains disponibles",
  "Le montant minimum pour demander un paiement est de 5 000 FCFA.":
      "Le montant minimum pour demander un paiement est de 5 000 FCFA.",
  "Langue mise à jour": "Langue mise à jour",
  "Welcome to JOXMAKO Driver": "Bienvenue sur JOXMAKO Driver",
  "Your Favorite Ride, Parcel, Rental & Item Delivered Fast!":
      "Vos courses, colis, locations et livraisons — rapides et fiables !",
  'The customer is not renting the car at the moment and has scheduled the car rental for':
      'Le client ne loue pas le véhicule pour l\'instant et a planifié la location pour le',
  'Alert': 'Alerte',
  'Okay': 'OK',
  ...
  'Enter your registered email address and we\'ll send you a secure link to reset your password. Open the link in your inbox and follow the steps to create a new password.':
      'Entrez votre adresse e-mail enregistrée et nous vous enverrons un lien sécurisé pour réinitialiser votre mot de passe.',
  'Please enter a valid email.': 'Veuillez entrer une adresse e-mail valide.',
  'Reset Password link sent your': 'Lien de réinitialisation envoyé à',
  ...
  'Please select a car model': 'Veuillez sélectionner un modèle de véhicule',
  "Profile": "Profil",
  "Ce compte est déjà connecté sur un autre appareil.": "Ce compte est déjà connecté sur un autre appareil.",
  'Help & Support': 'Aide & Support',
  'Navigation': 'Navigation',
  'Wave / Orange Money': 'Wave / Orange Money',
  'Aller au point de ramassage': 'Aller au point de ramassage',
  'Livrer le colis au client': 'Livrer le colis au client',
