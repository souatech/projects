const Map<String, String> enUS = {
  ...
  "En attente": "Pending",
  "Payé": "Paid",
  "Argent collecté": "Cash collected",
  "Espèces à remettre": "Cash to remit",
  ...
  "Continue": "Continue",
  "Historique des livraisons du jour": "Today's delivery history",
  "Withdrawal History": "Payout history",
  "Aucune livraison aujourd’hui": "No deliveries today",
  "Gain driver": "Driver earning",
  "Méthode de paiement": "Payment method",
  "Demande de paiement": "Payout request",
  "Disponible": "Available",
  "Montant demandé": "Requested amount",
  "Numéro de paiement": "Payout number",
  "Note": "Note",
  "Optionnel": "Optional",
  "Envoyer la demande": "Send request",
  "Envoi…": "Sending...",
  "Entrer un montant valide": "Enter a valid amount",
  "Entrer le numéro de paiement": "Enter the payout number",
  "Demande envoyée": "Request sent",
  "Montant supérieur aux gains disponibles":
      "Amount is higher than available earnings",
  "Le montant minimum pour demander un paiement est de 5 000 FCFA.":
      "The minimum amount to request a payout is 5,000 FCFA.",
  "Langue mise à jour": "Language updated",
  "Welcome to JOXMAKO Driver": "Welcome to JOXMAKO Driver",
  ...
  "Profile": "Profile",
  "Ce compte est déjà connecté sur un autre appareil.": "This account is already connected on another device.",
