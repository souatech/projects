const Map<String, String> lnAr = {
  ...
  "Payé": "مدفوع",
  "Argent collecté": "المبلغ المحصل",
  "Espèces à remettre": "النقد الواجب تسليمه",
  "Historique des gains": "سجل الأرباح",
  ...
  "Get Started": "ابدأ",
  "Continue": "متابعة",
  "Historique des livraisons du jour": "سجل توصيلات اليوم",
  "Withdrawal History": "سجل المدفوعات",
  "Aucune livraison aujourd’hui": "لا توجد توصيلات اليوم",
  "Gain driver": "ربح السائق",
  "Méthode de paiement": "طريقة الدفع",
  "Demande de paiement": "طلب دفع",
  "Disponible": "متاح",
  "Montant demandé": "المبلغ المطلوب",
  "Numéro de paiement": "رقم الدفع",
  "Note": "ملاحظة",
  "Optionnel": "اختياري",
  "Envoyer la demande": "إرسال الطلب",
  "Envoi…": "جارٍ الإرسال...",
  "Entrer un montant valide": "أدخل مبلغًا صحيحًا",
  "Entrer le numéro de paiement": "أدخل رقم الدفع",
  "Demande envoyée": "تم إرسال الطلب",
  "Montant supérieur aux gains disponibles": "المبلغ أكبر من الأرباح المتاحة",
  "Le montant minimum pour demander un paiement est de 5 000 FCFA.":
      "الحد الأدنى لطلب الدفع هو 5,000 فرنك CFA.",
  "Langue mise à jour": "تم تحديث اللغة",
  "Welcome to JOXMAKO Driver": "مرحبًا بك في JOXMAKO Driver",
  "Your Favorite Ride, Parcel, Rental & Item Delivered Fast!":
      "رحلاتك، طرودك، تأجيرك وتوصيلاتك — بسرعة وموثوقية!",
  'The customer is not renting the car at the moment and has scheduled the car rental for':
      'العميل لا يستأجر السيارة في الوقت الحالي وقد جدول استئجارها في',
  'Alert': 'تنبيه',
  'Okay': 'حسنًا',
  ...
  'Reset Password link sent your': 'تم إرسال رابط إعادة التعيين إلى',
  ...
  'Please select a car model': 'يرجى اختيار طراز السيارة',
};
