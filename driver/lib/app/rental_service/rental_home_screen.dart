                              ...
                              RoundedButtonFill(
                                ...
                                onPress: () async {
                                  RentalDashboardController
                                      dashBoardController = Get.isRegistered<
                                              RentalDashboardController>()
                                          ? Get.find<
                                              RentalDashboardController>()
                                          : Get.put(
    ...
    Get.dialog(
      StatefulBuilder(
        builder: (context, setState) {
          final bool otpRequired = Constant.enableOTPTripStartForRental == true;
          final bool hasOtp =
              (rentalBookingData.otpCode ?? '').trim().isNotEmpty;
          final bool showOtpMissing = otpRequired && !hasOtp;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (showOtpMissing) ...[
                      Text(
                        "OTP introuvable pour cette commande.".tr,
                        textAlign: TextAlign.center,
                        style: AppThemeData.mediumTextStyle(
                          color: isDark
                              ? AppThemeData.greyDark400
                      ...
                      RoundedButtonFill(
                        ...
                        onPress: () async {
                          ...
                          rentalBookingData.otpCode = newOtp;
                          ...
                          FireStoreUtils.getUserProfile(
                            ...
                            if (user != null &&
                              ...
                              SendNotification.sendOneNotification(
                                token: user.fcmToken!,
                                title: 'Nouveau code OTP'.tr,
                                body:
                                    '${'Votre code OTP est'.tr} : $newOtp',
                                payload: {'type': 'otp_regenerated'},
                              );
                            }
                          });
                          setState(() {});
                          ShowToastDialog.showToast("Nouvel OTP généré.".tr);
                        },
                      ),
                    ] else if (otpRequired) ...[
                      MaterialPinField(
                    ...
                    if (!showOtpMissing)
                      RoundedButtonFill(
                        ...
                        textColor: AppThemeData.grey50,
                        onPress: () async {
                          if (controller.currentKilometerController.value.text
                                  .isEmpty ||
                          ...
                          await FireStoreUtils.rentalOrderPlace(rentalBookingData)
                            ...
                            controller.currentKilometerController.value
                                .clear();
