                                                                    ...
                                                                    child: FutureBuilder(
                                                                        ...
                                                                        builder: (context, snapshot) {
                                                                          if (snapshot.connectionState ==
                                                                            ...
                                                                            return _OrderLoadingCard(isDark: isDark);
                                                                          } else {
                                                                            if (snapshot
                                                                                .hasError) {
                                                                              return Center(child: Text('Error: ${snapshot.error}'));
                                                                                ...
                                                                                null) {
                                                                              return _OrderUnavailableCard(isDark: isDark);
                                                                            } else {
                                                                              OrderModel orderModel = snapshot.data!;
                                                                              print("[DRIVER_ORDER_CARD_RENDER] orderId=${orderModel.id} canAccept=true");
                                                                              print("[DRIVER_NEW_ORDER] serviceType=delivery-service sectionId=${orderModel.sectionId} orderId=${orderModel.id} status=${orderModel.status}");
                                                                                          ...
                                                                                          return Padding(
                                                                                            ...
                                                                                            child: index == 0
                                                                                                ? Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      Text(
                                                                                                        _safeText(orderModel.vendor?.title, fallback: "Store".tr),
                                                                                                      ...
                                                                                                      Text(
                                                                                                        _safeText(orderModel.vendor?.location, fallback: "Pickup address".tr),
                                                                                                        textAlign: TextAlign.start,
                                                                                                        style: TextStyle(
                                                                                                          fontFamily: AppThemeData.medium,
                                                                                                          fontSize: 14,
                                                                                                ...
                                                                                                : Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      Text(
                                                                                                        _safeText(orderModel.address?.getFullAddress(), fallback: "Delivery address".tr),
                                                                                                        textAlign: TextAlign.start,
                                                                                                        style: TextStyle(
                                                                                                          fontFamily: AppThemeData.medium,
                                                                                                          fontSize: 14,
                                                                        ...
                                                                        builder: (context, snapshot) {
                                                                          if (snapshot.connectionState ==
                                                                            ...
                                                                            if (snapshot
                                                                              ...
                                                                              OrderModel orderModel = snapshot.data!;
                                                                              print("[DRIVER_ORDER_CARD_RENDER] orderId=${orderModel.id} canAccept=false");
                                                                              double distanceInMeters = Geolocator.distanceBetween(orderModel.vendor?.latitude ?? 0.0, orderModel.vendor?.longitude ?? 0.0, orderModel.address?.location?.latitude ?? 0.0, orderModel.address?.location?.longitude ?? 0.0);
                                                                              double kilometer = distanceInMeters / 1000;
                                                                              return InkWell(
                                                                                onTap: () {
...
class _OrderLoadingCard extends StatelessWidget {
  final bool isDark;

  const _OrderLoadingCard({required this.isDark});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _LoadingLine(width: 160, isDark: isDark),
          const SizedBox(height: 10),
          _LoadingLine(width: double.infinity, isDark: isDark),
          const SizedBox(height: 10),
          _LoadingLine(width: 220, isDark: isDark),
        ],
      ),
    );
  }
...
class _LoadingLine extends StatelessWidget {
  ...
  const _LoadingLine({required this.width, required this.isDark});
...
class _OrderUnavailableCard extends StatelessWidget {
  final bool isDark;

  const _OrderUnavailableCard({required this.isDark});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        "Order details unavailable".tr,
        style: TextStyle(
          color: isDark ? AppThemeData.grey100 : AppThemeData.grey700,
          fontFamily: AppThemeData.medium,
          fontSize: 14,
        ),
      ),
