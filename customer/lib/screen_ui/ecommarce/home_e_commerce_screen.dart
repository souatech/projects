    ...
    child: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: box(h: 44, radius: 10),
          ),
          const SizedBox(height: 20),
          // Top Brands title
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: box(w: 100, h: 16),
          ),
          const SizedBox(height: 10),
