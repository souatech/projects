...
class OnDemandOrderDetailsScreen extends StatelessWidget {
              ...
              controller.isLoading.value
                  ...
                  : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        (controller.onProviderOrder.value?.status ?? '') ==
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 10),
                                Text(
                                  "${'Booking Address :'.tr}  ${Utils.shortAddressFromText(controller.onProviderOrder.value?.address?.getFullAddress(), fallback: "Choisir une adresse".tr)}",
                                  style: AppThemeData.mediumTextStyle(
                                    fontSize: 15,
                                    color:
                                        isDark
                        ...
                        (controller.onProviderOrder.value?.status ==
                                ...
                                (controller.onProviderOrder.value?.workerId !=
                                        null &&
                                    controller
                                        .onProviderOrder
                                        .value!
                                                          ...
                                                          arguments: {
                                                            "senderName":
                                                                Constant
                                                                    ...
                                                                    ?.fullName(),
                                                            "receivedName":
                                                                "${controller.worker.value?.firstName ?? ''} ${controller.worker.value?.lastName ?? ''}",
                                                            "orderId":
                                                                controller
                                                                    .onProviderOrder
                                                                    .value
                                                    ...
                                                    arguments: {
                                                      "senderName":
                                                          Constant.userModel
                                                              ?.fullName(),
                                                      "receivedName":
                                                          "${controller.providerUser.value?.firstName ?? ''} ${controller.providerUser.value?.lastName ?? ''}",
                                                      "orderId":
                                                          controller
                                                              .onProviderOrder
                                                              .value
                        ...
                        controller.onProviderOrder.value?.extraCharges
                                    .toString() !=
                                ""
                            ? Container(
                        ...
                        controller.onProviderOrder.value?.extraPaymentStatus ==
                            ...
                            : SizedBox(),
                        controller.onProviderOrder.value?.provider.priceUnit !=
                                    "Fixed" &&
                                controller
                                        .onProviderOrder
                                        .value
                              ...
                              child: Padding(
                                ...
                                child: RoundedButtonFill(
                                  ...
                                  onPress: () async {
                                    ...
                                    controller.onProviderOrder.value?.discount =
                                        controller.discountAmount.toString();
                                    controller
                                            .onProviderOrder
                                            .value
                                            ?.discountType =
                                        controller.discountType.toString();
                                    controller
                                            .onProviderOrder
                                            .value
                                            ?.discountLabel =
                                        controller.discountLabel.toString();
                                    controller
                                            .onProviderOrder
                                            .value
                                            ?.couponCode =
                                        controller.offerCode.toString();
  ...
  Widget buildOfferItem(
    OnDemandOrderDetailsController controller,
    int index,
    bool isDark,
  ) {
    return Obx(() {
                    ...
                    Padding(
                      ...
                      child: RoundedButtonFill(
                        ...
                        onPress: () {
                          ...
                          print(
                            "Available coupons: ${controller.couponList.map((e) => e.code).toList()}",
                          );
          ...
          children: [
            ...
            if (Constant.platformFeeModel?.enable == true)
              rowText(
                "Platform fee".tr,
                Constant.amountShow(
                  amount: Constant.platformFeeModel?.fee.toString(),
                ),
                isDark,
              ),
