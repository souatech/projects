// ignore_for_file: depend_on_referenced_packages, deprecated_member_use, unnecessary_underscores, unused_element
...
class HomeScreenTwo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _LegacyHomeScreenTwo();
  }
}

class _LegacyHomeScreenTwo extends StatelessWidget {
  const _LegacyHomeScreenTwo();
                                                ...
                                                InkWell(
                                                  ...
                                                  child: Text.rich(
                                                    ...
                                                    TextSpan(
                                                      children: [
                                                        TextSpan(
                                                          text: Utils.shortAddressFromText(
                                                            Constant
                                                                .selectedLocation
                                                                .getFullAddress(),
                                                            fallback:
              ...
              child: Row(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items:
                        <String>['Delivery', 'TakeAway'].map((String rawValue) {
                ...
                children: [
                  ...
                  GradientText(
                    ...
                    gradient: LinearGradient(
                      colors: [Color(0xFF39F1C5), Color(0xFF97EA11)],
                    ),
                  ),
                ],
              ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  for (var element in controller.couponList) {
                    if (vendorModel.id == element.vendorID &&
                        element.expiresAt!.toDate().isAfter(DateTime.now())) {
                      tempList.add(element);
                      discountAmountTempList.add(
