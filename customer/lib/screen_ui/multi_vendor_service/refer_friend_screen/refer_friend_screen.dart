                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "${'Invite your friends to sign up with JOXMAKO using your code, and you’ll earn'.tr} ${Constant.amountShow(amount: Constant.sectionConstantModel!.referralAmount)} ${'after their Success the first order! 💸🍔'.tr}"
                                      .tr,
