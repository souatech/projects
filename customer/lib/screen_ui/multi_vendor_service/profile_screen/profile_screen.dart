                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  // temporairement masqué — retirer le if(false) pour réactiver
                                  if (false)
                                    cardDecoration(
                                      isDark,
                                      controller,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  cardDecoration(
                                    ...
                                    () {
                                      Share.share(
                                        '${'Check out JOXMAKO, the ultimate all-in-one multi-vendor eBusiness platform.'.tr} \n\n${'Google Play:'.tr} ${Constant.googlePlayLink} \n\n${'App Store:'.tr} ${Constant.appStoreLink}',
