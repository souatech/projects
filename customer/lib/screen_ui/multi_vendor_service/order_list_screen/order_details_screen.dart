                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  if (controller.orderModel.value.platformFee !=
                                          '0.0' &&
                                      controller.orderModel.value.platformFee !=
                                          '0' &&
                                      controller.orderModel.value.platformFee !=
                                          null)
                                    Row(
                          ...
                          controller.orderModel.value.status ==
                              ...
                              ? Constant
                                  ...
                                  : RoundedButtonFill(
                                    ...
                                    onPress: () async {
                                      TrackingNavigation.openFood(
                                        order: controller.orderModel.value,
                                      );
                                    },
                                  )
                              : RoundedButtonFill(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.orderModel.value.takeAway != true &&
                      controller.orderModel.value.packagingTax?.isNotEmpty ==
                          true)
                    sectionDivider(isDark),
                  ListView.builder(
                    shrinkWrap: true,
