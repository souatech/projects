                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [_parcelFormShadow(isDark)],
                      ),
                      child: Center(
                        child: Padding(
          ...
          body: SafeArea(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _ParcelFlowHero(controller: controller, isDark: isDark),
                  ...
                  buildInfoSectionView(
                    ...
                    locationController:
                        controller.senderLocationController.value,
                    ...
                    countryISOCodeController:
                        controller.senderCountryISOCodeController.value,
                    showWeight: !controller.isExpress,
                    isDark: isDark,
                    context: context,
                  ...
                  buildInfoSectionView(
                    ...
                    countryISOCodeController:
                        controller.receiverISOCountryCodeController.value,
                    showWeight: false,
                    isDark: isDark,
                    context: context,
                    controller: controller,
            ...
            prefix: Row(
              ...
              children: [
                CountryCodePicker(
                  ...
                  initialSelection:
                      countryISOCodeController.text.isNotEmpty
                          ? countryISOCodeController.text
...
class _ParcelFlowHero extends StatelessWidget {
  final BookParcelController controller;
  final bool isDark;

  const _ParcelFlowHero({required this.controller, required this.isDark});

  @override
  Widget build(BuildContext context) {
    final title = controller.selectedCategory?.title ?? '';
    final isGP = controller.isGP;
    return Container(
              ...
              children: [
                RichText(
                  text: TextSpan(
                    style: AppThemeData.boldTextStyle(
                      fontSize: 32,
                      color: isDark ? Colors.white : BookParcelScreen._ink,
                    ...
                    children: [
                      ...
                      TextSpan(
                        text:
                            isGP
                                ? 'GP'
                                : (title.toLowerCase().contains('express')
                                    ? 'Express'
                                    : title),
                        style: AppThemeData.boldTextStyle(
                          fontSize: 32,
                          color: BookParcelScreen._orange,
                        ),
                      ),
                    ],
                  ),
...
BoxShadow _parcelFormShadow(bool isDark) {
  return BoxShadow(
