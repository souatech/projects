...
class FireStoreUtils {
  ...
  static Future<List<FavouriteModel>> getFavouriteRestaurant() async {
    ...
    try {
      ...
      log('FireStoreUtils.getFavouriteRestaurant error: $e');
    }
  ...
  static Future<List<BrandsModel>> getBrandList() async {
    ...
    try {
      ...
      log('FireStoreUtils.getBrandList error: $e');
    }
    return brandList;
  }
  ...
  static Future<List> getVendorCuisines(String id) async {
    ...
    try {
      ...
      log('FireStoreUtils.getVendorCuisines error: $e');
    }
    return tagList;
  }
  ...
  static Future<List<FavouriteItemModel>> getFavouriteItem() async {
    ...
    try {
      ...
      log('FireStoreUtils.getFavouriteItem error: $e');
    }
    return favouriteList;
  }
  ...
  static Future<List<CouponModel>> getOfferByVendorId(String vendorId) async {
    ...
    try {
      ...
      log('FireStoreUtils.getOfferByVendorId error: $e');
    }
    return couponList;
  }
  ...
  static Future<List<AttributesModel>?> getAttributes() async {
    ...
    try {
      ...
      log('FireStoreUtils.getAttributes error: $e');
    }
  ...
  static Future<void> sendCabBookEmail({
    ...
    try {
      ...
      EmailTemplateModel? emailTemplateModel =
          await FireStoreUtils.getEmailTemplates(Constant.newCabRideBook);
      String newString = emailTemplateModel!.message.toString();
      newString = newString.replaceAll(
        "{passengername}",
      ...
      newString = newString.replaceAll(
        "{time}",
        DateFormat('hh:mm a').format(orderModel.createdAt!.toDate()),
      );
      newString = newString.replaceAll(
        "{pickuplocation}",
      ...
      newString = newString.replaceAll(
        "{drivername}",
        orderModel.driver?.fullName() ?? '',
      );
      newString = newString.replaceAll(
        "{vehicle}",
        "${vType.toString()} | ${brand.toString()} | ${carModel.toString()}",
      );
      newString = newString.replaceAll("{carnumber}", plate.toString());
      newString = newString.replaceAll(
        "{driverphone}",
        orderModel.driver?.phoneNumber ?? '',
      );
      String subjectNewString = emailTemplateModel.subject.toString();
      await Constant.sendMail(
        subject: subjectNewString,
  ...
  static Future<void> sendCarBookEmail({
    required RentalOrderModel orderModel,
  }) async {
    try {
      EmailTemplateModel? emailTemplateModel =
          await FireStoreUtils.getEmailTemplates(Constant.newCarRideBook);
      String newString = emailTemplateModel!.message.toString();
      newString = newString.replaceAll(
        "{username}",
        orderModel.author?.fullName() ?? '',
  ...
  static Future<ConversationModel> addChat(
    ...
    final docId =
        (conversationModel.receiverId?.contains('admin') == false)
  ...
  static Future<InboxModel> addInbox(InboxModel inboxModel) async {
    ...
    final docId =
        (inboxModel.senderReceiverId?.contains('admin') == false)
            ? inboxModel.orderId
            : inboxModel.senderId;
