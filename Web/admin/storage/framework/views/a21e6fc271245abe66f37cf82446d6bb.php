            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-6 mb-3">
                            <div class="card card-box-with-icon border cursor-pointer" onclick="location.href='<?php echo route('rides'); ?>'">
                                <div class="card-body p-3">
                                    <span class="box-icon ab"><img src="<?php echo e(asset('images/total_booking.png')); ?>"></span>
                                    <div class="card-box-with-content mt-3">
                                        <h4 class="card-left-title text-dark font-medium">
                                            <?php echo e(trans('lang.dashboard_total_rides')); ?>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card border">
                        <div class="card-header no-border d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(route('rides')); ?>"><?php echo e(trans('lang.view_all')); ?>
                            ...
                            <table class="table table-striped table-valign-middle" id="orderTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(trans('lang.dashboard_user')); ?></th>
                                        <th><?php echo e(trans('lang.dashboard_driver')); ?></th>
        ...
        async function setorderStatus() {
            ...
            Chart.plugins.register({
                ...
                beforeDraw: function (chart) {
                    if (chart.config.type === 'doughnut') {
                        ...
                        ctx.fillText("<?php echo e(trans('lang.dashboard_total_rides')); ?>", centerX, centerY - 20);
            ...
            if (window.orderStatusChart) {
                ...
                window.orderStatusChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: [
                            "<?php echo e(trans('lang.pending_rides')); ?>",
                            "<?php echo e(trans('lang.confirmed_rides')); ?>",
                            "<?php echo e(trans('lang.ongoing_ride')); ?>",
                            "<?php echo e(trans('lang.completed_ride')); ?>",
                            "<?php echo e(trans('lang.canceled_ride')); ?>",
       ...
       async function buildHTML(snapshots) {           
        ...
        function buildRidesHTML(snapshots) {
            ...
            snapshots.docs.forEach((listval) => {
                ...
                var customer_view = '<?php echo e(route("users.edit", ":id")); ?>';
                ...
                if (val.hasOwnProperty("driver")) {
                    ...
                    var diverRoute = '<?php echo e(route("drivers.edit", ":id")); ?>';
            ...
            return new Chart(document.getElementById("commissions"), {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: "<?php echo e(trans('lang.admin_commission')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/dashboard/cab.blade.php ENDPATH**/ ?>