...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.user_plural')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                <li class="breadcrumb-item active"><?php echo e(trans('lang.user_table')); ?></li>
            </ol>
        </div>
        <div>
        </div>
                ...
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            <span class="icon mr-3"><img src="<?php echo e(asset('images/users.png')); ?>"></span>
                            <h3 class="mb-0"><?php echo e(trans('lang.user_plural')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.user_table')); ?></h3>
                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.users_table_text')); ?></p>
                   </div>
                   <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3"> 
                        <a class="btn-primary btn rounded-full" href="<?php echo route('users.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.user_create')); ?></a>
                     </div>
                   </div>                
                 </div>
                 <div class="card-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var fieldConfig = {
            columns: [
                { key: 'name', header: "<?php echo e(trans('lang.user_info')); ?>" },
               { 
                    key: 'contactInfo', 
            ...
            fileName: "<?php echo e(trans('lang.user_table')); ?>",
        };
    ...
    async function buildHTML(val) {
        ...
        newdate = '';
        var id = val.id;
        var route1 = '<?php echo e(route("users.edit",":id")); ?>';
       ...
       html.push('<td>' + shortEmail(val.email) + '<br>' + (val.phoneNumber && val.phoneNumber.includes('+') ? '+' + EditPhoneNumber(val.phoneNumber.slice(1)) : EditPhoneNumber(val.phoneNumber)) + '</td>');
        ...
        var actionHtml = '';
        var chatViewRoute = "<?php echo e(route('users.chat', ':id')); ?>".replace(':id', val.id);
        let unreadHtml = '';
        actionHtml = actionHtml + '<span class="action-btn">';
        actionHtml = actionHtml+'<a href="' + trroute1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.wallet_transaction')); ?>"><i class="mdi mdi-wallet" ></i></a>';
        actionHtml = actionHtml + '<a href="' + user_view + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.view')); ?>"><i class="mdi mdi-eye"></i></a><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a>';
        if (checkDeletePermission) {
            actionHtml = actionHtml+'<a id="' + val.id + '" class="delete-btn" name="user-delete" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a>';
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/users/index.blade.php ENDPATH**/ ?>