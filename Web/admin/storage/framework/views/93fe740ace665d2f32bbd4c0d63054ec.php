    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><?php echo e(trans('lang.store_plural')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.vendor_table')); ?></li>
                </ol>
            </div>
            <div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                <span class="icon mr-3"><img src="<?php echo e(asset('images/store_list.png')); ?>"></span>
                                <h3 class="mb-0"><?php echo e(trans('lang.store_plural')); ?></h3>
                                <span class="counter ml-3 total_count"></span>
                            </div>
                            <div class="d-flex top-title-right align-self-center">
                                <div class="select-box pl-3">
                                    <select class="form-control cuisine_selector filteredRecords">
                                        <option value="" disabled selected><?php echo e(trans('lang.select_categoty')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card card-box-with-icon bg--1">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div class="card-box-with-content">
                                                    ...
                                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_stores')); ?></p>
                                                </div>
                                                <span class="box-icon ab"><img src="<?php echo e(asset('images/restaurant_icon.png')); ?>"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card card-box-with-icon bg--5">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div class="card-box-with-content">
                                                    ...
                                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.active_restaurants')); ?></p>
                                                </div>
                                        ...
                                        <div class="card card-box-with-icon bg--8">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div class="card-box-with-content">
                                                    ...
                                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.inactive_restaurants')); ?></p>
                                                </div>
                                                <span class="box-icon ab"><img src="<?php echo e(asset('images/inactive_restaurant.png')); ?>"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card card-box-with-icon bg--6">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div class="card-box-with-content">
                                                    ...
                                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.new_joined_restaurants')); ?></p>
                                                </div>
                                                <span class="box-icon ab"><img src="<?php echo e(asset('images/new_restaurant.png')); ?>"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.vendor_table')); ?></h3>
                                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.store_table_text')); ?></p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">
                                        <a class="btn-primary btn rounded-full" href="<?php echo route('stores.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.create_vendor')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="storeTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(trans('lang.store_info')); ?></th>
                                                <th><?php echo e(trans('lang.vendor_phone')); ?></th>
                                                <th><?php echo e(trans('lang.date')); ?></th>
                                                <th><?php echo e(trans('lang.item')); ?></th>
                                                <th><?php echo e(trans('lang.order_plural')); ?></th>
                                            </tr>
                                        </thead>
        ...
        <div class="modal-dialog modal-dialog-centered notification-main" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(trans('lang.copy_vendor')); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 form-group">
                            <label class="form-label"><?php echo e(trans('lang.first_name')); ?></label>
                        ...
                        <div class="col-md-12 form-group">
                            <label class="form-label"><?php echo e(trans('lang.last_name')); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-12 form-group">
                            <label class="form-label"><?php echo e(trans('lang.vendor_title')); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-12 form-group"><label
                                class="form-label"><?php echo e(trans('lang.email')); ?></label><input
                                placeholder="Email" value="" id="user_email" type="text"
                                class="form-control"></div>
                        <div class="col-md-12 form-group"><label
                                class="form-label"><?php echo e(trans('lang.password')); ?></label><input
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                            id="create_vendor_submit"><?php echo e(trans('lang.create')); ?>
    ...
    <script type="text/javascript">
        ...
        var fieldConfig = {
            columns: [
                {
                    key: 'title',
                    header: "<?php echo e(trans('lang.store_info')); ?>"
                },
                {
                    key: 'exportPhone',
                    header: "<?php echo e(trans('lang.phone')); ?>",
                ...
                {
                    key: 'items',
                    header: "<?php echo e(trans('lang.item')); ?>"
                },
                {
                    key: 'orders',
                    header: "<?php echo e(trans('lang.order_plural')); ?>"
                },
            ],
            fileName: "<?php echo e(trans('lang.vendor_table')); ?>",
        };
        $(document).ready(function() {
            $('.cuisine_selector').select2({
                placeholder: "<?php echo e(trans('lang.select_categoty')); ?>",
        ...
        async function buildHTML(val) {
            ...
            newdate = '';
            var id = val.id;
            var route1 = '<?php echo e(route('stores.edit', ':id')); ?>';
            ...
            actionHtml = actionHtml+'<a href="' + payoutRequests + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.wallet_history')); ?>"><i class="mdi mdi-wallet" ></i></a>';
          
            if (checkCopyPermission) {
                actionHtml = actionHtml + '<a href="javascript:void(0)" vendor_id="' + val.id + '" author="' + val.author + '" name="vendor-clone" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.copy')); ?>"><i class="mdi mdi-content-copy"></i></a>';
            }
            actionHtml = actionHtml + '<a href="' + route_view + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.view')); ?>"><i class="mdi mdi-eye"></i></a><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a>';
            if (checkDeletePermission) {
                actionHtml = actionHtml + '<a id="' + val.id + '" author="' + val.author + '" name="delete-btn" class="do_not_delete" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a>';
            }
            ...
            var vendorId = val.id;
            var url = '<?php echo e(route('vendors.items', ':id')); ?>';
            url1 = url.replace(":id", vendorId);
            html.push((val.items > 0 ? '<a  href="' + url1 + '">' + val.items + '</a>' : val.items));
            
            var url = '<?php echo e(route('vendors.orders', ':id')); ?>';
        ...
        $(document).on("click", "#create_vendor_submit", async function(e) {
            ...
            if (userData && vendorData) {
                ...
                if (userFirstName == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.user_name_required')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (userLastName == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.user_last_name_required')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (vendor_title == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.vendor_title_required')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (email == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.user_email_required')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (password == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                                    ...
                                    await vendorProducts.forEach(async (product) => {
                                        ...
                                        await database.collection('vendor_products').doc(product_id).set(product).then(function(result) {
                                            ...
                                            if (count == vendorProducts.length) {
                                                ...
                                                Swal.fire({
                                                    title: "<?php echo e(trans('lang.vendor_created')); ?>",
                                                    text: "<?php echo e(trans('lang.vendor_data_copied_successfully')); ?>",
                                                    icon: 'success',
                                                    confirmButtonText: "<?php echo e(trans('lang.ok')); ?>"
                                                }).then((result) => {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/stores/index.blade.php ENDPATH**/ ?>