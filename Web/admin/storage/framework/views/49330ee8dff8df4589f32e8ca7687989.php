...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.edit_vendor')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                <li class="breadcrumb-item"><a href="<?php echo route('vendors'); ?>"><?php echo e(trans('lang.vendors')); ?></a>
                </li>
                <li class="breadcrumb-item active"><?php echo e(trans('lang.edit_vendor')); ?></li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="menu-tab">
                        <ul>
                            <li class="active vendorRouteLi" style="display:none;">
                                <a href="<?php echo e(route('vendors.edit', $id)); ?>"> <i class="ti-user"></i> <?php echo e(trans('lang.profile')); ?></a>
                            </li>
                            <li class="vendorRouteLi" style="display:none;">
                                <a class="vendorRoute"> <i class="ri-shopping-bag-2-fill"></i> <?php echo e(trans('lang.vendor')); ?></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row vendor_payout_create">
                        <div class="vendor_payout_create-inner">
                            ...
                            <fieldset class="change_expiry_date_div" style="display:none;">
                                    <legend><?php echo e(trans('lang.store_subscription_model')); ?></legend>
                                   
                                    <div class="form-group row width-100">
                                        <label class="col-4 control-label"><?php echo e(trans('lang.change_expiry_date')); ?></label>
                                        <div class="col-7">
                            ...
                            <fieldset>
                                <legend><?php echo e(trans('lang.vendor')); ?> <?php echo e(trans('lang.active_deactive')); ?></legend>

                                <div class="form-group row width-100">
                                    <div class="form-check">
                                        <input type="checkbox" id="is_active">
                                        <label class="col-3 control-label"
                                            for="is_active"><?php echo e(trans('lang.active')); ?></label>
                                    </div>

                                    <div class="form-check">
                                        <input type="checkbox" id="reset_password">
                                        <label
                                            class="col-3 control-label"><?php echo e(trans('lang.reset_store_password')); ?></label>

                                            <div class="form-text text-muted w-100 col-12">
                                            <?php echo e(trans("lang.note_reset_store_password_email")); ?>
    ...
    $("#send_mail").click(function () {
        if ($("#reset_password").is(":checked")) {
            ...
            firebase.auth().sendPasswordResetEmail(email)
                .then((res) => {
                    alert('<?php echo e(trans("lang.store_mail_sent")); ?>');
                })
                .catch((error) => {
                    console.log('Error password reset: ', error);
                });
        } else {
            alert('<?php echo e(trans("lang.error_reset_store_password")); ?>');
        }
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/vendors/edit.blade.php ENDPATH**/ ?>