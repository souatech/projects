...
<div class="page-wrapper">
  ...
  <div>
    <div class="card-body">
      ...
      <div class="row vendor_payout_create">
        <div class="vendor_payout_create-inner">
          <fieldset>
            <legend><?php echo e(trans('lang.parcel_category')); ?></legend>
            <div class="form-group row width-50">
              <label class="col-3 control-label"><?php echo e(trans('lang.title')); ?></label>
              <div class="col-7">
                <input type="text" class="form-control title" id="title">
              </div>
            </div>
            <div class="form-group row width-50">
              <label class="col-3 control-label"><?php echo e(trans('lang.set_order')); ?></label>
              <div class="col-7">
            ...
            <div class="form-group row width-50">
              <label class="col-3 control-label"><?php echo e(trans('lang.photo')); ?></label>
            ...
            <div class="form-check width-100">
              ...
              <label class="col-4 control-label" for="publish"><?php echo e(trans('lang.is_publish')); ?></label><br>
            </div>
          </fieldset>
        </div>
      </div>
    ...
    <div class="form-group col-12 text-center btm-btn">
      ...
      <a href="<?php echo route('parcelCategory'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
    </div>
  </div>
</div>
  ...
  $(document).ready(function () {
    ...
    $(".edit-setting-btn").click(function () {
      ...
      if (title == '') {
        $(".error_top").show();
        $(".error_top").html("");
        $(".error_top").append("<p><?php echo e(trans('lang.enter_parcel_title_error')); ?></p>");
        window.scrollTo(0, 0);
      } else if (isNaN(set_order)) {
        $(".error_top").show();
        $(".error_top").html("");
        $(".error_top").append("<p><?php echo e(trans('lang.enter_parcel_set_order')); ?></p>");
        window.scrollTo(0, 0);
      } else if(section == '') {
        $(".error_top").show();
        $(".error_top").html("");
        $(".error_top").append("<p><?php echo e(trans('lang.sectionid_error')); ?></p>");
        window.scrollTo(0, 0);
      } else {
        jQuery("#data-table_processing").show();
        storeImageData().then(IMG => {
          database.collection('parcel_categories').doc(id).update({
            ...
            window.location.href = '<?php echo e(route("parcelCategory")); ?>';
          });
        }).catch(err => {
          jQuery("#data-table_processing").hide();
          $(".error_top").show();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/parcel_category/edit.blade.php ENDPATH**/ ?>