            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        ...
                        <h3 class="mb-0"><?php echo e(trans('lang.car_model')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.car_model')); ?></h3>
                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.carmodel_table_text')); ?></p>
                   </div>
                   <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3"> 
                        <a class="btn-primary btn rounded-full" href="<?php echo route('carModel.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.add_car_model')); ?></a>
                     </div>
                   </div>                
                 </div>
                 <div class="card-body">
                         ...
                         <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <th><?php echo e(trans('lang.car_make')); ?></th>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        var route1 = '<?php echo e(route("carModel.edit",":id")); ?>';

        route1 = route1.replace(':id', id);



        var route2 = '<?php echo e(route("carMake.edit",":id")); ?>';
        ...
        html = html + '<td><span class="action-btn"><a href="' + route1 + '" data-toggle="tooltip" title="<?php echo e(trans("lang.edit")); ?>"><i class="mdi mdi-lead-pencil"></i></a>';
        ...
        html = html + '<a id="' + val.id + '" name="carModel-delete" class="delete-btn" href="javascript:void(0)" data-toggle="tooltip" title="<?php echo e(trans("lang.delete")); ?>"><i class="mdi mdi-delete"></i></a></span>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/carModel/index.blade.php ENDPATH**/ ?>