    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                ...
                <h3 class="text-themecolor"><?php echo e(trans('lang.business_model_settings')); ?></h3>
            ...
            <div class="col-md-7 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.business_model_settings')); ?></li>
            ...
            <div class="row vendor_payout_create">
                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <legend><i class="mr-3 mdi mdi-shopping"></i><?php echo e(trans('lang.subscription_based_model_settings')); ?>
                            ...
                            <div class="form-group row mt-1 ">
                                ...
                                <div class="col-12 switch-box">
                                    ...
                                    <div class="switch-box-inner">
                                        ...
                                        <label class=" control-label"><?php echo e(trans('lang.subscription_based_model')); ?></label>
                                        ...
                                        <i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip"
                                            ...
                                            title="<?php echo e(trans('lang.subscription_tooltip')); ?>" aria-describedby="tippy-3"></i>
                    ...
                    <fieldset>
                        ...
                        <legend><i class="mr-3 mdi mdi-shopping"></i><?php echo e(trans('lang.bulk_update')); ?></legend>

                        <div class="form-group row width-100">

                            <label class="col-3 control-label"><?php echo e(trans('lang.select_section')); ?> <i

                                    class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip"

                                    title="<?php echo e(trans('lang.bulk_update_commission_tooltip')); ?>"
                            ...
                            <div class="col-7">
                                ...
                                <select class="form-control section" id="section">
                                    ...
                                    <option value=""><?php echo e(trans('lang.select_section')); ?></option>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <label class="col-3 control-label"><?php echo e(trans('lang.select_user')); ?></label>

                            <div class="col-7 selected-user">

                                <select id="food_restaurant_type" class="form-control" required>

                                    <option value="all"><?php echo e(trans('lang.all_user')); ?></option>

                                    <option value="custom"><?php echo e(trans('lang.custom')); ?></option>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <label class="col-4 control-label"><?php echo e(trans('lang.admin_commission')); ?></label>
                        ...
                        <div class="form-group col-12 text-center">
                            ...
                            <div class="col-12">
                                ...
                                <button type="button" id="bulk_update_btn" class="btn btn-primary edit-setting-btn"><i
                                        ...
                                        class="fa fa-save"></i> <?php echo e(trans('lang.bulk_update')); ?></button>
            ...
            $(document).ready(function() {
                ...
                $('#food_restaurant_type').on('change', function() {
                    ...
                    if ($('#food_restaurant_type').val() === 'custom') {
                        ...
                        $('#food_restaurant').select2({
                            ...
                            placeholder: "<?php echo e(trans('lang.select_user')); ?>",
                ...
                $(document).on("click", "input[name='subscription_model']", function(e) {
                    ...
                    var userConfirmed = confirm(subscription_model ?
                        ...
                        "<?php echo e(trans('lang.enable_subscription_plan_confirm_alert')); ?>" :

                        "<?php echo e(trans('lang.disable_subscription_plan_confirm_alert')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/businessModel.blade.php ENDPATH**/ ?>