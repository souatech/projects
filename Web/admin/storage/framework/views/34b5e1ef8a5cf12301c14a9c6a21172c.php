...
<body>
    ...
    <script src="<?php echo e(asset('js/jquery.resizeImg.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/jquery.masking.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        async function buildServiceSectionsHTML(snapshot) {
            let html = '';
            var addSectionRoute = "<?php echo e(route('section.create')); ?>";
            ...
            snapshot.docs.forEach(doc => {
                ...
                var sectionRoute = `<?php echo e(route('dashboard')); ?>/${sectionId}/${data.serviceTypeFlag}`;
            ...
            html += `
                <div class="col-md-12">
                    <div class="service-list-box" data-section-url="${addSectionRoute}" data-section-id="" data-section-type="">
                        <img src="<?php echo e(asset('images/add_more.png')); ?>">
                        <h3><?php echo e(trans('lang.add_more')); ?></h3>
                        <p><?php echo e(trans('lang.expand_by_adding_new_modules_as_your_business_grows')); ?></p>
                    </div>
                </div>
                `;
        ...
        database.collection('settings').doc("notification_setting").get().then(async function (snapshots) {
            ...
            if (serviceJson != '' && serviceJson != null) {
                $.ajax({
                    ...
                    url: "<?php echo e(route('store-firebase-service')); ?>",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    success: function (data) {
        ...
        window.translations = {
            showProcessingTitle:"<?php echo e(trans('lang.please_wait')); ?>",
            showProcessingText:"<?php echo e(trans('lang.processing_your_request')); ?>",
            errorMessageTitle:"<?php echo e(trans('lang.error')); ?>",
            warningMessageTitle:"<?php echo e(trans('lang.warning')); ?>",
            successMessageTitle:"<?php echo e(trans('lang.success')); ?>",
        };
        ...
        async function sendNotification(fcmToken = '', title, body, payload = null) {            
            var checkFlag = false;
            var sendNotificationUrl = "<?php echo e(route('send-notification')); ?>";
            if (fcmToken !== '') {
                await $.ajax({
                    type: 'POST',
...
</html><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/layouts/app.blade.php ENDPATH**/ ?>