    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <div class="d-flex top-title-section justify-content-between">
                <div class="d-flex top-title-left align-self-center">
                    <span class="icon mr-3"><img src="<?php echo e(asset('images/rides.png')); ?>"></span>
                    <h3 class="mb-0 page-title"><?php echo e(trans('lang.rides')); ?></h3>
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.rides')); ?></li>
            </ol>
        </div>
        <div>
        </div>
                    ...
                    <div class="d-flex top-title-right align-self-center">
                        ...
                        <div class="select-box pl-3">
                                    <select class="form-control rides_selector filteredRecords">
                                        <option value=""><?php echo e(trans("lang.rides")); ?></option>
                                        <option value="ride"><?php echo e(trans("lang.ride")); ?></option>
                                        <option value="intercity"><?php echo e(trans("lang.intercity")); ?></option>
                                    </select>
                                </div>
                        <div class="select-box pl-3">
                                ...
                                <div class="card card-box-with-icon bg--1">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                       <div class="card-box-with-content">
                                        ...
                                        <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_rides')); ?></p>
                                       </div>
           ...
           <?php if ($id != '') { ?>
                    <div class="menu-tab vendorMenuTab">
                        <ul>
                            ...
                            <li class="active">
                                <a href="<?php echo e(route('drivers.ride',$id)); ?>"><i class="ri-shopping-bag-line"></i><?php echo e(trans('lang.order_plural')); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('driver.payouts',$id)); ?>"><i class="ri-bank-card-line"></i><?php echo e(trans('lang.tab_payouts')); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('payoutRequests.drivers.view',$id)); ?>" ><i class="ri-refund-line"></i><?php echo e(trans('lang.tab_payout_request')); ?></a>
                            </li>
                            <li>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.rides')); ?></h3>
                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.rides_table_text')); ?></p>
                   </div>             
                 </div>
                 <div class="card-body">
                         ...
                         <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <?php if(in_array('rides.delete', json_decode(@session('user_permissions'),true))){?>
                                        <th class="delete-all">
                                            ...
                                            <label class="col-3 control-label" for="is_active">
                                                <a id="deleteAll" class="do_not_delete" href="javascript:void(0)"><i
                                                            class="fa fa-trash"></i> <?php echo e(trans('lang.all')); ?></a>
                                            </label>
                                        </th>
                                        <?php }?>
                                        ...
                                        <?php if ($id == '') { ?>
                                        <th class="driverClass"><?php echo e(trans('lang.driver_plural')); ?></th>
                                        <?php } ?>
                                        <th><?php echo e(trans('lang.ridetype')); ?></th>
...
<script type="text/javascript"> 
    ...
    $('.rides_selector').select2({
        placeholder: '<?php echo e(trans("lang.rides")); ?>',  
        minimumResultsForSearch: Infinity,
        allowClear: true 
    });
    ...
    $(document).ready(function () {
        ...
        var fieldConfig = {
            columns: [
                { key: 'userName', header: "<?php echo e(trans('lang.order_user_id')); ?>" },
                <?php if ($id == '') { ?>
                    { key: 'driverName', header: "<?php echo e(trans('lang.driver')); ?>" },
                <?php } ?>
                
                { key: 'rideType', header: "<?php echo e(trans('lang.ridetype')); ?>" },
                { key: 'destinationLocationName', header: "<?php echo e(trans('lang.address')); ?>" },
                { key: 'total_price', header: "<?php echo e(trans('lang.amount')); ?>" },
                { key: 'createdAt', header: "<?php echo e(trans('lang.date')); ?>" },
                { key: 'status', header: "<?php echo e(trans('lang.status')); ?>" },
                
            ],
            fileName: "<?php echo e(trans('lang.ride_list')); ?>",
        };
    ...
    async function buildHTML(val) {
        ...
        var route1 = '<?php echo e(route("rides.edit",":id")); ?>';
        ...
        var action = '';
        action = action + '<span class="action-btn"><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a>';
        <?php if(in_array('rides.delete', json_decode(@session('user_permissions'),true))){?>

        action = action + '<a id="' + val.id + '" name="driver-delete" class="delete-btn" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a>';
        <?php }?>
        action = action + '</span>';
    ...
    async function getDriverInfo(driverId){
        ...
        if (snapshotss.docs[0]) {
            ...
            $('.page-title').html("<?php echo e(trans('lang.rides')); ?>  - "+driverName);
        }
    });
}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/rides/index.blade.php ENDPATH**/ ?>