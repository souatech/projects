...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.notifications')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                <li class="breadcrumb-item active"><?php echo e(trans('lang.send_notification')); ?></li>
            </ol>
        </div>
        <div>
        </div>
            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        <span class="icon mr-3"><img src="<?php echo e(asset('images/notification.png')); ?>"></span>
                        <h3 class="mb-0"><?php echo e(trans('lang.notifications')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.send_notification')); ?></h3>
                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.notifications_table_text')); ?></p>
                   </div>
                   <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3"> 
                        <a class="btn-primary btn rounded-full" href="<?php echo url('notification/send'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.create_notificaion')); ?></a>
                     </div>
                   </div>                
                 </div>
                 <div class="card-body">
                                            ...
                                            <th class="delete-all"><input type="checkbox" id="is_active">
                                                <label class="col-3 control-label" for="is_active">
                                                    <a id="deleteAll" class="do_not_delete" href="javascript:void(0)">
                                                        <i class="mdi mdi-delete"></i> <?php echo e(trans('lang.all')); ?></a>
                                                    </label>
                                            </th>
                                        <?php } ?>
                                        <th><?php echo e(trans('lang.notification_subject')); ?></th>

                                        <th><?php echo e(trans('lang.notification_message')); ?></th>
    ...
    <script type="text/javascript">
        ...
        async function buildHTML(val) {
            ...
            html.push('<span class="action-btn"><a id="' + val.id + '" name="notifications-delete" class="delete-btn" href="javascript:void(0)" data-toggle="tooltip" title="<?php echo e(trans("lang.delete")); ?>"><i class="mdi mdi-delete"></i></a></span>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/notification/index.blade.php ENDPATH**/ ?>