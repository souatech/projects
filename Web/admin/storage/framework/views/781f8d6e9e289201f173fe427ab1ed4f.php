        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">
                    ...
                    <?php echo e(trans('lang.fleet_drivers')); ?>
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.fleet_driver_table')); ?></li>
                </ol>
            </div>
            <div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0"><?php echo e(trans('lang.fleet_drivers')); ?></h3>
                            ...
                            <div class="card border">
                                <div class="card-header d-flex justify-content-between align-items-center border-0">
                                    <div class="card-header-title">
                                        <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.fleet_driver_table')); ?></h3>
                                        <p class="mb-0 text-dark-2"><?php echo e(trans('lang.fleet_driver_table_text')); ?></p>
                                    </div>
                                    <div class="card-header-right d-flex align-items-center">
                                        <div class="card-header-btn mr-3">
                                            <a class="btn-primary btn rounded-full" href="<?php echo route('fleet.drivers.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.fleet_driver_create')); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var fieldConfig = {
                    ...
                    fileName: "<?php echo e(trans('lang.fleet_driver_table')); ?>",
                };
            ...
            async function buildHTML(val) {
                var html = [];
                var id = val.id;
                var route1 = '<?php echo e(route('fleet.drivers.edit', ':id')); ?>';
                route1 = route1.replace(':id', id);

                var driverView = '<?php echo e(route('fleet.drivers.view', ':id')); ?>';
                ...
                var actionHtml = '';
                actionHtml += '<span class="action-btn"><a href="' + driverView + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.view')); ?>"><i class="mdi mdi-eye"></i></a><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a>';
                    if (checkDeletePermission) {
                    actionHtml += '<a id="' + val.id + '" name="driver-delete" class="delete-btn" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a>';
                }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/fleet_drivers/index.blade.php ENDPATH**/ ?>