        ...
        <div class="payment-top-tab mt-3 mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active cod_active_label" href="<?php echo url('settings/payment/cod'); ?>"><i
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link payfast_active_label" href="<?php echo url('settings/payment/payfast'); ?>"><i
                                    ...
                                    class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.payfast')); ?><span
                ...
                <li class="nav-item">
                        ...
                        <a class="nav-link flutterWave_active_label"
                           ...
                           href="<?php echo url('settings/payment/flutterwave'); ?>"><i
            ...
            <div class="row vendor_payout_create">
                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <legend><i class="mr-3 fa fa-money"></i><?php echo e(trans('lang.app_setting_cod_short')); ?></legend>
                        ...
                        <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                for="enable_cod"><?php echo e(trans('lang.app_setting_enable_cod')); ?></label>

                            <div class="form-text text-muted">

                                <?php echo trans('lang.app_settings_enable_cod_help'); ?>
...
$(document).ready(function () {
    ...
    $(".edit-setting-btn").click(function () {
        ...
        database.collection('settings').doc("CODSettings").update({'isEnabled': isCODEnabled}).then(function (result) {
            ...
            window.location.href = '<?php echo e(url("settings/payment/cod")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/cod.blade.php ENDPATH**/ ?>