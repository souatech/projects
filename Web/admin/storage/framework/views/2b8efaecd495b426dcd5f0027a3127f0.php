...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor"><?php echo e(trans('lang.parcel_weight')); ?></h3>
        ...
        <div class="col-md-7 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.parcel_weight')); ?></li>
                        ...
                        <div class="resttab-sec">
                            ...
                            <div class="row vendor_payout_create">
                                <div class="vendor_payout_create-inner">
                                    <fieldset>
                                        <legend><?php echo e(trans('lang.parcel_weight')); ?></legend>
                                            ...
                                            <div class="special_offer_div">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-12 control-label"
                                                           style="color:red;font-size:15px;"><?php echo e(trans('lang.edit_button_save_note')); ?> </label>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12">
                                                            <button type="button"
                                                                    ...
                                                                    onclick="addMoreButton()"><?php echo e(trans('lang.add_more')); ?>
                                                ...
                                                <div class="parcel_weight" style="display:none">
                                                    <table class="booking-table" id="parcel_weight_table">
                                                        <tr>
                                                            <th style="width:50%"><label class="col-3 control-label"><?php echo e(trans('lang.title')); ?></label>
                                                            </th>
                                                            <th style="width:40%"><label class="col-3 control-label"><?php echo e(trans('lang.delivery_charge')); ?></label>
                                                            </th>
                                                            ...
                                                            <?php if (in_array('parcel.weight.edit', json_decode(@session('user_permissions'),true)) || in_array('parcel.weight.delete', json_decode(@session('user_permissions'),true))) { ?>
                                                                ...
                                                                <th style="width:20%"><label
                                                                            class="col-3 control-label"><?php echo e(trans('lang.actions')); ?></label>
                                                                </th>
                                                            <?php } ?>
                                                        </tr>
                                                    </table>
                                    ...
                                    <div class="form-group col-12 text-center btm-btn">
                                        ...
                                        <a href="<?php echo route('parcel_weight'); ?>" class="btn btn-default"><i
    ...
    <script type="text/javascript">
        ...
        function saveData(count) {
            ...
            if (title == "") {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.parcel_title_error')); ?></p>");
                window.scrollTo(0, 0);
            } else if (price == "") {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.parcel_price_error')); ?></p>");
                window.scrollTo(0, 0);
            } else {
                $(".error_top").hide();
                $(".error_top").html("");
        ...
        $(document).on('click', '.save-form-btn', function () {
            for (var i = 0; i < arrayParcelWeight.length; i++) {
                database.collection('parcel_weight').doc(arrayParcelWeight[i]['id']).set({
                    ...
                    window.location.href = '<?php echo e(route("parcel_weight")); ?>';
                });
            }
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/parcel_weight/index.blade.php ENDPATH**/ ?>