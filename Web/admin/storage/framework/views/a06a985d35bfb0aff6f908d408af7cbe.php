...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.parcel_plural')); ?> <?php echo e(trans('lang.order_plural')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('parcel_orders')); ?>"><?php echo e(trans('lang.parcel_plural')); ?>

                        <?php echo e(trans('lang.order_plural')); ?></a></li>
            ...
            <div class="order_detail-top">
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="order_detail-top-box">
                                    ...
                                    <div class="form-group row widt-100 gendetail-col " id="div_parcel_category">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.parcel_category')); ?>:
                                    ...
                                    <div class="form-group row width-100 non-printable">
                                        <label class="col-3 control-label"><strong></strong><?php echo e(trans('lang.status')); ?>
                                    ...
                                    <div class="form-group row width-100 non-printable">
                                        ...
                                        <div class="col-7 text-right">
                                            <button type="button" class="btn btn-primary edit-form-btn"><i class="fa fa-save"></i> <?php echo e(trans('lang.update')); ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table cellpadding="0" cellspacing="0" class="table table-striped table-valign-middle">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(trans('lang.parcel_weight')); ?></th>
                                                <th><?php echo e(trans('lang.item_review_rate')); ?></th>
                                                <th><?php echo e(trans('lang.parcel_distance')); ?></th>
                                    ...
                                    <div class="form-group row width-50">
                                       ...
                                       <label class="col-12 control-label"><strong><?php echo e(trans('lang.parcel_image')); ?></strong></label>

                                        <div class="placeholder_img_thumb user_image">
                                            <img class="rounded" style="width:50px" src="" alt="Parcel_image" id="parcel_image">
                                            <span id="no-image-text" style="display:none; color:gray;"><?php echo e(trans('lang.parcel_images_not_found')); ?></span>
                                        </div>
                    ...
                    <div class="order_edit-genrl col-md-5">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-header-title"><?php echo e(trans('lang.sender_details')); ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="address order_detail-top-box">

                                    <div class="form-group row widt-100 gendetail-col ">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.sender_name')); ?>:</strong>
                                            <span id="sender_name"></span></label>

                                    </div>
                                    <div class="form-group row widt-100 gendetail-col ">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.sender_address')); ?>
                                    ...
                                    <div class="form-group row widt-100 gendetail-col ">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.date')); ?>:</strong>
                                    ...
                                    <p><strong><?php echo e(trans('lang.note')); ?>:</strong>
                        ...
                        <div class="card mt-4">
                            <div class="card-header">
                                <h4 class="card-header-title"><?php echo e(trans('lang.receiver_details')); ?></h4>
                            </div>
                            <div class="card-body">
                                <div class="address order_detail-top-box">
                                    <div class="form-group row widt-100 gendetail-col ">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.receiver_name')); ?>
                                    ...
                                    <div class="form-group row widt-100 gendetail-col ">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.receiver_address')); ?>
                        ...
                        <div class="order-deta-btm-right driver_details_hide mt-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="address order_detail-top-box">
                                        <p><strong><?php echo e(trans('lang.driver_name')); ?>:</strong>
...
<script type="text/javascript">
          ...
          if (Array.isArray(order.parcelImages) && order.parcelImages.length > 0 && order.parcelImages[0].trim() !== '') {
            ...
            if (order.payment_method) {
                ...
                if (order.payment_method == "stripe") {
                    ...
                    image = '<?php echo e(asset("images/payment/foodie_wallet.png")); ?>';
                    payment_method = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" width="30%" height="30%" >';
                            ...
                            success: function(data) {
                                ...
                                if (orderPreviousStatus != 'Order Rejected' && orderPreviousStatus != 'Driver Rejected' && orderPaymentMethod != 'cod' && orderTakeAwayOption == false) {
                                    if (orderStatus == 'Order Rejected' || orderStatus == 'Driver Rejected') {
                                        ...
                                        window.location.href = '<?php echo e(route("parcel_orders")); ?>';
                                    }
                                } else {
                                    window.location.href = '<?php echo e(route("parcel_orders")); ?>';
                                }
    ...
    function buildRatingsAndReviewsHTML(Order, userreviewsnapshot) {
        ...
        allreviewdata.forEach((listval) => {
            var val = listval;
            var review_user_view = '<?php echo e(route("users.view",":id")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/parcel_orders/edit.blade.php ENDPATH**/ ?>