        ...
        <div class="col-md-5 align-self-center">
            <div class="d-flex top-title-section justify-content-between">
                <div class="d-flex top-title-left align-self-center">
                    ...
                    <h3 class="mb-0 page-title"><?php echo e(trans('lang.driver_payout_request')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.driver_payout_request')); ?></h3>
...
<script type="text/javascript">
    ...
    if (id != "") {
        ...
        database.collection('users').where("id", "==", id).get().then(async function (snapshotss) {
            ...
            if (snapshotss.docs[0]) {
                ...
                $('.page-title').html("<?php echo e(trans('lang.driver_payout_request')); ?>"+" - "+driver_data.firstName + " " + driver_data.lastName);
    ...
    $(document).ready(function () {
        ...
        var fieldConfig = {
            columns: [
                ...
                { key: 'note', header: "<?php echo e(trans('lang.note')); ?>" },
                { key: 'paidDate', header: "<?php echo e(trans('lang.date')); ?>" },
                { key: 'paymentStatus', header: "<?php echo e(trans('lang.payment_status')); ?>" },
                { key: 'withdrawMethod', header: "<?php echo e(trans('lang.withdraw_method')); ?>" },
                
                
            ],
            fileName: "<?php echo e(trans('lang.driver')); ?>  <?php echo e(trans('lang.payment_plural')); ?>",
        };
    ...
    async function getDriverName(driverId) {
        ...
        if(snapshots.exists){
            ...
            $('.driverTitle').html('<?php echo e(trans("lang.payout_request")); ?> - ' + driverName);
    ...
    function buildHTML(val) {
        ...
        if (id == "") {
            ...
            var route_url = '<?php echo e(route("drivers.view",":id")); ?>';
        ...
        actionHtml = actionHtml + '<span class="action-btn"><a id="' + val.recid + '" class="delete-btn" name="driver_payouts-delete" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a></span>';
    ...
    $(document).on("click", "#submit_cancel", async function (e) {
        ...
        database.collection('users').where("id", "==", auth).get().then(function (resultdriver) {
            ...
            if (resultdriver.docs.length) {
                ...
                alert('<?php echo e(trans("lang.driver_not_found")); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/payoutRequests/drivers/index.blade.php ENDPATH**/ ?>