...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		...
		<div class="col-md-5 align-self-center">
			...
			<h3 class="text-themecolor"><?php echo e(trans('lang.edit_vehicle_type')); ?></h3>
		...
		<div class="col-md-7 align-self-center">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?php echo route('vehicleType'); ?>"><?php echo e(trans('lang.vehicle_type')); ?></a>

				</li>

				<li class="breadcrumb-item active"><?php echo e(trans('lang.edit_vehicle_type')); ?></li>
			...
			<div class="row vendor_payout_create">
				...
				<div class="vendor_payout_create-inner">
					...
					<fieldset>
						...
						<legend><?php echo e(trans('lang.vehicle_type')); ?></legend>
						...
						<div class="form-group row width-50">
							...
							<div class="col-7">
								...
								<div class="form-text text-muted"><?php echo e(trans('lang.user_name_help')); ?></div>
						...
						<div class="form-group row width-50">
							...
							<label class="col-3 control-label"><?php echo e(trans('lang.capacity')); ?></label>

							<div class="col-7">

								<input type="text" class="form-control capacity" id="capacity">

								<div class="form-text text-muted"><?php echo e(trans('lang.capacity_help')); ?></div>
						...
						<div class="form-group row width-50">
							...
							<label class="col-3 control-label"><?php echo e(trans('lang.short_description')); ?></label>

							<div class="col-7">

								<input type="text" class="form-control short_description" id="short_description">

								<div class="form-text text-muted"><?php echo e(trans('lang.short_description_help')); ?></div>
						...
						<div class="form-group row width-50">
							...
							<label class="col-3 control-label"><?php echo e(trans('lang.description')); ?></label>

							<div class="col-7">

								<textarea class="form-control description" id="description" rows="2"></textarea>

								<div class="form-text text-muted"><?php echo e(trans('lang.description_help')); ?></div>
						...
						<div class="form-group row width-50">
							...
							<label class="col-3 control-label"><?php echo e(trans('lang.supported_vehicle')); ?></label>
							...
							<div class="col-7">
								...
								<div class="form-text text-muted"><?php echo e(trans('lang.supported_vehicle_help')); ?></div>
						...
						<div class="form-group row width-100">
							...
							<label class="col-3 control-label"><?php echo e(trans('lang.icon')); ?></label>
						...
						<div class="form-group row width-100">
							...
							<div class="form-check">
								...
								<label class="col-3 control-label"
									...
									for="vehicle_type_active"><?php echo e(trans('lang.active')); ?></label>
		...
		<div class="form-group col-12 text-center btm-btn">
			...
			<a href="<?php echo url('vehicleType'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
...
<script type="text/javascript">
	...
	$(".edit-setting-btn").click(function () {
		...
		if (name == '') {
			...
			$(".error_top").append("<p><?php echo e(trans('lang.capacity_error')); ?></p>");
			...
			$(".error_top").append("<p><?php echo e(trans('lang.short_description_error')); ?></p>");
			...
			$(".error_top").append("<p><?php echo e(trans('lang.description_error')); ?></p>");
			...
			$(".error_top").append("<p><?php echo e(trans('lang.supported_vehicle_error')); ?></p>");
        	...
        	$(".error_top").show();
			$(".error_top").html("");
			$(".error_top").append("<p><?php echo e(trans('lang.icon_error')); ?></p>");
			window.scrollTo(0, 0);
		} else {
			...
			storeImageData().then(IMG => {
				...
				database.collection('vehicle_type').doc(id).update({
					...
					window.location.href = '<?php echo e(route("vehicleType")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/vehicleType/edit.blade.php ENDPATH**/ ?>