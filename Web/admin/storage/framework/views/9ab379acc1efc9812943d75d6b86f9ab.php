<?php $__env->startSection('content'); ?>
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <div class="d-flex top-title-section justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        <span class="icon mr-3"><img src="<?php echo e(asset('images/building-four.png')); ?>"></span>
                        <h3 class="mb-0"><?php echo e(trans('lang.vendor_details')); ?> <span class="itemTitle"></span></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo route('stores'); ?>"><?php echo e(trans('lang.store_plural')); ?></a>
                    </li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.vendor_details')); ?></li>
                </ol>
            </div>
        </div>
        ...
        <div class="container-fluid">
                                ...
                                <div class="card-header-right">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#addWalletModal"
                                        class="btn-primary btn rounded-full add-wallate"><i
                                            class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.add_wallet_amount')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="resttab-sec mb-4">
                <div class="menu-tab">
                    <ul>
                        <li class="active">
                            <a href="<?php echo e(route('stores.view', $id)); ?>"><i
                                    class="ri-list-indefinite"></i><?php echo e(trans('lang.tab_basic')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('vendors.items', $id)); ?>"><i
                                    class="ri-shopping-basket-fill"></i><?php echo e(trans('lang.tab_items')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('vendors.orders', $id)); ?>"><i class="ri-shopping-bag-line"></i>
                                <?php echo e(trans('lang.tab_orders')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('vendors.reviews', $id)); ?>"><i
                                    class="ri-shield-star-fill"></i><?php echo e(trans('lang.tab_reviews')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('vendors.coupons', $id)); ?>"><i
                                    class="ri-discount-percent-fill"></i><?php echo e(trans('lang.tab_promos')); ?></a>
                        <li>
                            <a href="<?php echo e(route('vendors.payout', $id)); ?>"><i
                                    class="ri-bank-card-line"></i><?php echo e(trans('lang.tab_payouts')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('payoutRequests.vendor.view', $id)); ?>"><i
                                    class="ri-refund-line"></i><?php echo e(trans('lang.tab_payout_request')); ?></a>
                        </li>
                        <li class="dine_in_future" style="display:none;">
                            <a href="<?php echo e(route('vendors.booktable', $id)); ?>"><i
                                    class="ri-restaurant-line"></i><?php echo e(trans('lang.dine_in_booking_history')); ?></a>
                        </li>
                        <?php if (in_array('wallet-transaction', json_decode(@session('user_permissions'),true))) { ?>
                        <li>
                            <a class="wallet_transaction"><i
                                    class="ri-wallet-line"></i><?php echo e(trans('lang.wallet_transaction')); ?></a>
                        </li>
                        <?php }?>
                        <?php
                        ...
                        ?>
                        <li>
                            <a href="<?php echo e($subscription); ?>"><i
                                    class="ri-chat-history-fill"></i><?php echo e(trans('lang.subscription_history')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('restaurants.advertisements', $id)); ?>"><i
                                    class="mdi mdi-newspaper"></i><?php echo e(trans('lang.advertisement_plural')); ?></a>
                        </li>
                        <?php
                                ...
                                <?php }else{ ?>
                                <li class="">
                                    <a href="<?php echo e(route('restaurants.deliveryman', $id)); ?>" value="<?php echo $sectionType;?>"><i class="ri-riding-fill"></i><?php echo e(trans('lang.deliveryman')); ?></a>
                                </li>
                                    <?php }?>
                    ...
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--1">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/total_order.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_items')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/active_restaurant.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_earnings')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/total_earning.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--5">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_payment')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/total_payment.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--5">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.remaining_payment')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/remaining_payment.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.subscription_details')); ?></h3>
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#changeSubscriptionModal"
                                class="btn-primary btn rounded-full change-plan"><i
                                    class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.change_subscription_plan')); ?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="card card-box-with-icon bg--9">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.plan_name')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/basic.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--5">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.number_of_days')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/countdown.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--14">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.expiry_date')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/calendar.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-box-with-icon bg--6">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div class="card-box-with-content">
                                    ...
                                    <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.total_price')); ?></p>
                                </div>
                                <span class="box-icon ab"><img src="<?php echo e(asset('images/price.png')); ?>"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                        <div class="card-header-title">
                            <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.vendor_details')); ?></h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="restaurant_info_left">
                                        ...
                                        <div class="sis-content pl-4">
                                            ...
                                            <ul class="p-0 info-list mb-0">
                                                <li class="d-flex align-items-center mb-2">
                                                    <label
                                                        class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_phone')); ?></label>
                                                    <span class="vendor_phone"></span>
                                                </li>
                                                <li class="d-flex align-items-center mb-2">
                                                    <label
                                                        class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_address')); ?></label>
                                                    <span class="vendor_address"></span>
                                                </li>
                                                <li class="d-flex align-items-center mb-2">
                                                    <label
                                                        class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_cuisines')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label
                                                class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_description')); ?></label>
                                            <p><span class="vendor_description"></span></p>
                                        </div>
                                        <div class="col-md-3">
                                            <label
                                                class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.zone_plural')); ?></label>
                                            <p><span class="zone_name"></span></p>
                                        </div>
                                        <div class="col-md-3">
                                            <label
                                                class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.section')); ?></label>
                                            <p><span class="vendor_section"></span></p>
                                        </div>
                                        <div class="col-md-3">
                                            <label
                                                class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.wallet_Balance')); ?></label>
                                    ...
                                    <div class="row store-status" style="display:none">
                                        <div class="col-md-9">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_status')); ?></label>
                ...
                <div class="row">
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label
                                            class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.name')); ?></label>
                                        <p><span class="vendor_name"></span></p>
                                    </div>
                                    <div class="col-md-3">
                                        <label
                                            class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_phone')); ?></label>
                                        <p><span class="vendor_phoneNumber"></span></p>
                                    </div>
                                    <div class="col-md-6">
                                        <label
                                            class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.email')); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label
                                            class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.vendor_image')); ?></label>
                    ...
                    <div class="col-md-6">
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.gallery')); ?></h3>
                                </div>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6" id="services_feature">
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.services')); ?></h3>
                                </div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.active_subscription_plan')); ?></h3>
                                </div>
                                <div class="update-limit-div" style="display:none">
                                    <div class="active-sub-plan" style="margin-bottom:0px;">
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#updateLimitModal"
                                            class="btn-primary btn rounded-full update-limit"><?php echo e(trans('lang.update_plan_limit')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.plan_name')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.plan_type')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.plan_expires_at')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.order_limit')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.item_limit')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.available_order_limit')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.available_item_limit')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="active-sub-plan">
                                            <label
                                                class="mb-1 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.available_features')); ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row width-100">
                                    <label class="col-12 control-label"><?php echo e(trans('lang.note')); ?></label>
                                    <div class="col-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="add-wallet-btn"><?php echo e(trans('submit')); ?>
    ...
    <div class="modal fade" id="changeSubscriptionModal" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1200px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="text-dark-2 h5 mb-0"><?php echo e(trans('lang.business_plans')); ?></h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex top-title-section pb-4 mb-2 justify-content-between">
                                        <div class="d-flex top-title-left align-start-center">
                                            <div class="top-title">
                                                <h3 class="mb-0"><?php echo e(trans('lang.choose_your_business_plan')); ?></h3>
                                                <p class="mb-0 text-dark-2">
                                                    <?php echo e(trans('lang.choose_your_business_plan_description')); ?>
    ...
    <div class="modal fade" id="checkoutSubscriptionModal" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1200px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="text-dark-2 h5 mb-0"><?php echo e(trans('lang.shift_to_plan')); ?></h6>
                            ...
                            <div class="subscription-section-inner">
                                <div class="card-body">
                                    ...
                                    <div class="pay-method-section pt-4 manual_pay_div">
                                        <h6 class="text-dark-2 h6 mb-3 pb-3"><?php echo e(trans('lang.pay_via_online')); ?></h6>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="pay-method-box d-flex align-items-center">
                                                    <div class="pay-method-icon">
                                                        <img src="<?php echo e(asset('images/wallet_icon_ic.png')); ?>">
                                                    </div>
                                                    <div class="form-check">
                                                        <h6 class="text-dark-2 h6 mb-0"><?php echo e(trans('lang.manual_pay')); ?>
                                        ...
                                        <div class="edit-form-group btm-btn text-right">
                                            <div class="card-block-active-plan">
                                                <a href="" class="btn btn-default rounded-full mr-2"
                                                    data-dismiss="modal"><?php echo e(trans('lang.cancel_plan')); ?></a>
                                                <input type="hidden" id="plan_id" name="plan_id" value="">
                                                <button type="button" class="btn-primary btn rounded-full"
                                                    onclick="finalCheckout()"><?php echo e(trans('lang.change_plan')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="updateLimitModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title locationModalTitle"><?php echo e(trans('lang.update_plan_limit')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="">
                        <div class="form-row">
                            <div class="form-group row">
                                <div class="form-group row width-100">
                                    <label class="control-label"><?php echo e(trans('lang.maximum_order_limit')); ?></label>
                                    <div class="form-check width-100">
                                        <input type="radio" id="unlimited_order" name="set_order_limit"
                                            value="unlimited" checked>
                                        <label class="control-label"
                                            for="unlimited_order"><?php echo e(trans('lang.unlimited')); ?></label>
                                    </div>
                                    <div class="d-flex">
                                        <div class="form-check width-50 limited_order_div">
                                            <input type="radio" id="limited_order" name="set_order_limit"
                                                value="limited">
                                            <label class="control-label"
                                                for="limited_order"><?php echo e(trans('lang.limited')); ?></label>
                                        </div>
                                        <div class="form-check width-50 d-none order-limit-div">
                                            <input type="number" id="order_limit" class="form-control"
                                                placeholder="<?php echo e(trans('lang.ex_1000')); ?>">
                                        </div>
                                    </div>
                                    <span class="order_limit_err"></span>
                                </div>
                                <div class="form-group row width-100">
                                    <label class="control-label"><?php echo e(trans('lang.maximum_item_limit')); ?></label>
                                    <div class="form-check width-100">
                                        <input type="radio" id="unlimited_item" name="set_item_limit"
                                            value="unlimited" checked>
                                        <label class="control-label"
                                            for="unlimited_item"><?php echo e(trans('lang.unlimited')); ?></label>
                                    </div>
                                    <div class="d-flex ">
                                        <div class="form-check width-50 limited_item_div  ">
                                            <input type="radio" id="limited_item" name="set_item_limit"
                                                value="limited">
                                            <label class="control-label"
                                                for="limited_item"><?php echo e(trans('lang.limited')); ?></label>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button"
                            class="btn btn-primary update-plan-limit"><?php echo e(trans('submit')); ?></a></button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal" aria-label="Close">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(async function() {
            ...
            ref.get().then(async function(snapshots) {
                if (snapshots.docs.length > 0) {
                    ...
                    $(".vendor_avtive").html("<?php echo e(trans('lang.closed')); ?>");
                    ...
                    if (vendor.hasOwnProperty('subscriptionExpiryDate') && vendor.hasOwnProperty(
                        ...
                        if (vendor.subscriptionExpiryDate != null && vendor
                            ...
                            $(".plan_expire_at").html("<?php echo e(trans('lang.unlimited')); ?>");
                            $(".plan_expire_date").html("<?php echo e(trans('lang.unlimited')); ?>");
                        }
                        ...
                        $('.order_limit').html((vendor.subscription_plan.orderLimit == '-1') ?
                            "<?php echo e(trans('lang.unlimited')); ?>" : vendor.subscription_plan
                            .orderLimit);
                        ...
                        $('.available_order_limit').html((vendor.subscriptionTotalOrders == '-1') ?
                            "<?php echo e(trans('lang.unlimited')); ?>" : vendor.subscriptionTotalOrders);
                        ...
                        if (vendor.subscription_plan.hasOwnProperty('features')) {
                            const translations = {
                                chatingOption: "<?php echo e(trans('lang.chat')); ?>",
                                generateQrCode: "<?php echo e(trans('lang.generate_qr_code')); ?>",
                                mobileAppAccess: "<?php echo e(trans('lang.mobile_app')); ?>"
                            };
                                ...
                                if (vendor.workingHours[i]['timeslot'].length != 0) {
                                    for (j = 0; j < vendor.workingHours[i]['timeslot']
                                        ...
                                        if (currentHours >= timeslot[`from`] && currentHours <=
                                            timeslot[`to`]) {
                                            $(".vendor_avtive").html("<?php echo e(trans('lang.open')); ?>");
                    ...
                    if (filtershtml != '') {
                        ...
                        $("#filtershtml").html('<?php echo e(trans('lang.service_not_available')); ?>')
                    }
                    ...
                    $('.vendor_detail_div').html(
                        '<h5 class="text-danger text-center font-weight-bold"><?php echo e(trans('lang.vendor_unknown_deleted')); ?></h5>'
                        )
                }
            ...
            $(".save_vendor_btn").click(function() {
                ...
                database.collection('vendors').doc(id).update({
                    ...
                    window.location.href = '<?php echo e(route('stores')); ?>';
                });
            })
            ...
            database.collection('users').where('id', '==', vendorOwnerId).get().then(async function(snapshot) {
                ...
                if (snapshot.docs.length > 0) {
                    ...
                    $('#user_account_not_found_error').text(
                        '<?php echo e(trans('lang.user_detail_not_found')); ?>');
                }
            });
                ...
                .get().then(async function(snapshots) {
                    ...
                    plans.map(async (data) => {
                        ...
                        var activeClass = (data.id == activeSubscriptionId) ?
                            '<span class="badge badge-success"><?php echo e(trans('lang.active')); ?></span>' :
                            '';
                        ...
                        if (data.isCommissionPlan == true) {
                            if (commisionModel) {
                                ...
                                html += `<span class="price-day">${data.expiryDay==-1? "<?php echo e(trans('lang.unlimited')); ?>":data.expiryDay} Days</span></div>
                                            
                                        </div>
                                        <div class="pricing-card-content pt-3 mt-3 border-top">
                                            <ul class="pricing-card-list text-dark-2">`;
                                html +=
                                    `<li><span class="mdi mdi-check"></span><?php echo e(trans('lang.pay_commission_of')); ?> ${AdminCommission} <?php echo e(trans('lang.on_each_order')); ?> </li>`
                                data.plan_points.map(async (list) => {
                                    html +=
                                        `<li><span class="mdi mdi-check"></span>${list}</li>`
                                });
                                html +=
                                    `<li><span class="mdi mdi-check"></span><?php echo e(trans('lang.unlimited')); ?> <?php echo e(trans('lang.orders')); ?></li>`
                                html +=
                                    `<li><span class="mdi mdi-check"></span><?php echo e(trans('lang.unlimited')); ?> <?php echo e(trans('lang.products')); ?></li>`
                                html += `</ul>
                                        </div>`;
                                var buttonText = (activeClass == '') ?
                                    "<?php echo e(trans('lang.select_plan')); ?>" :
                                    "<?php echo e(trans('lang.renew_plan')); ?>";
                            ...
                            if (subscriptionModel) {
                                const translations = {
                                    chatingOption: "<?php echo e(trans('lang.chating_option')); ?>",
                                    generateQrCode: "<?php echo e(trans('lang.generate_qr_code')); ?>",
                                    mobileAppAccess: "<?php echo e(trans('lang.mobile_app_access')); ?>"
                                };
                            ...
                            <div class="pricing-card-inner">
                                ...
                                if (data.type == "paid")
                                    ...
                                    html += `<h3 class="text-dark-2" style="color:red;">Free</h3>`
                                html += `<span class="price-day">${data.expiryDay==-1? "<?php echo e(trans('lang.unlimited')); ?>":data.expiryDay} Days</span>
                                </div>
                                </div>
                                <div class="pricing-card-content pt-3 mt-3 border-top">
                                <ul class="pricing-card-list text-dark-2">
                                    ...
                                    <li><span class="mdi mdi-check"></span>${data.orderLimit==-1? "<?php echo e(trans('lang.unlimited')); ?>":data.orderLimit} <?php echo e(trans('lang.orders')); ?></li>
                                    <li><span class="mdi mdi-check"></span>${data.itemLimit==-1? "<?php echo e(trans('lang.unlimited')); ?>":data.itemLimit} <?php echo e(trans('lang.products')); ?></li>
                                </ul>
                                </div>`;
                        ...
                        <div class="col-md-5">
                            <div class="subscription-card text-center">
                                <div class="d-flex align-items-center pb-3 justify-content-center">
                                    ...
                                    <h2 class="text-dark-2 mb-0 font-weight-semibold">${activePlan.isCommissionPlan==true? "<?php echo e(trans('lang.commission')); ?>":activePlan.name}</h2>
                                </div>
                                <h3 class="text-dark-2">${activePlan.isCommissionPlan==true ? AdminCommission+" <?php echo e(trans('lang.base_plan')); ?>":activePlan_price}</h3>
                                <p class="text-center">${activePlan.isCommissionPlan==true ? "Free":activePlan.expiryDay==-1? "<?php echo e(trans('lang.unlimited')); ?>":activePlan.expiryDay+" Days"}</p>
                            </div>
                        </div>
                        <div class="col-md-2 text-center">
                            <img src="<?php echo e(asset('images/left-right-arrow.png')); ?>">
                        </div>
                        <div class="col-md-5">
                            <div class="subscription-card text-center">
                                <div class="d-flex align-items-center pb-3 justify-content-center">
                                ...
                                <p class="text-center">${choosedPlan.expiryDay=="-1"? "<?php echo e(trans('lang.unlimited')); ?>":choosedPlan.expiryDay+" <?php echo e(trans('lang.days')); ?>"}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="subscription-card-right">
                    <div
                        ...
                        <span class="font-weight-medium"><?php echo e(trans('lang.validity')); ?></span>
                        <span class="font-weight-semibold">${choosedPlan.expiryDay=="-1"? "<?php echo e(trans('lang.unlimited')); ?>":choosedPlan.expiryDay+" <?php echo e(trans('lang.days')); ?>"}</span>
                    </div>
                    <div
                        class="d-flex justify-content-between align-items-center py-3 px-3 text-dark-2">
                        <span class="font-weight-medium"><?php echo e(trans('lang.price')); ?></span>
                        <span class="font-weight-semibold">${choosedPlan_price} </span>
                    </div>
                    <div
                        class="d-flex justify-content-between align-items-center py-3 px-3 text-dark-2">
                        <span class="font-weight-medium"><?php echo e(trans('lang.bill_status')); ?></span>
                        <span class="font-weight-semibold"><?php echo e(trans('lang.migrate_to_new_plan')); ?></span>
                    </div>
                </div>
            </div>`;
            } else {
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="subscription-card text-center">
                                <div class="d-flex align-items-center pb-3 justify-content-center">
                                    <span class="pricing-card-icon mr-4"><img src="${choosedPlan.image}"></span>
                                    <h2 class="text-dark-2 mb-0 font-weight-semibold">${choosedPlan.isCommissionPlan==true? "<?php echo e(trans('lang.commission')); ?>":choosedPlan.name}</h2>
                                </div>
                                <h3 class="text-dark-2">${activePlan.isCommissionPlan==true ? AdminCommission+" <?php echo e(trans('lang.base_plan')); ?>":choosedPlan_price}</h3>
                                <p class="text-center">${choosedPlan.expiryDay=="-1"? "<?php echo e(trans('lang.unlimited')); ?>":choosedPlan.expiryDay+" <?php echo e(trans('lang.days')); ?>"}</p>
                            </div>
                        </div>
                    </div>
        ...
        $('.update-plan-limit').click(async function() {
            ...
            if (set_item_limit == 'limited' && ($('#item_limit').val() == '' || $('#item_limit').val() == 0)) {
                $(".item_limit_err").html(
                "<p><?php echo e(trans('lang.enter_item_limit_can_not_empty_or_zero')); ?></p>");
                return false;
            } else if (set_order_limit == 'limited' && ($('#order_limit').val() == '' || $('#order_limit')
                .val() == 0)) {
                $(".order_limit_err").html(
                    "<p><?php echo e(trans('lang.enter_order_limit_can_not_empty_or_zero')); ?></p>");
                return false;
            } else {
                ...
                await database.collection('users').doc(vendorOwnerId).update({
                    ...
                    await database.collection('vendors').doc("<?php echo e($id); ?>").update({
                        'subscription_plan.orderLimit': order_limit,
                        'subscription_plan.itemLimit': item_limit,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/stores/view.blade.php ENDPATH**/ ?>