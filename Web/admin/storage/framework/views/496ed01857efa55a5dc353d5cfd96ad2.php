    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.vehicle_type')); ?></li>
            </ol>
        </div>
        <div>
        </div>
            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        ...
                        <h3 class="mb-0"><?php echo e(trans('lang.vehicle_type')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.vehicle_type')); ?></h3>
                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.vehicle_type_table_text')); ?></p>
                   </div>
                   <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3"> 
                        <a class="btn-primary btn rounded-full" href="<?php echo route('vehicleType.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.add_vehicle_type')); ?></a>
                     </div>
                   </div>            
                 </div>
                 <div class="card-body">
                         ...
                         <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                    <th><?php echo e(trans('lang.vehicle_info')); ?></th>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        newdate = '';
        var id = val.id;
        var route1 = '<?php echo e(route("vehicleType.edit",":id")); ?>';
        ...
        <?php if(in_array('cab-vehicle-type.delete', json_decode(@session('user_permissions'),true))){?>
        html = html + '<a id="' + val.id + '" name="vehicleType-delete" class="delete-btn" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a></span>';
        <?php }?>
        html = html + '</td>';
        html = html + '</tr>';
        count = count + 1;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/vehicleType/index.blade.php ENDPATH**/ ?>