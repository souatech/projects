    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <div class="d-flex top-title-section justify-content-between">
                <div class="d-flex top-title-left align-self-center">
                    ...
                    <h3 class="mb-0 page-title"><?php echo e(trans('lang.driver_plural')); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.driver_details')); ?></li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="d-flex top-title-section justify-content-between">
                        ...
                        <div class="d-flex top-title-right align-self-center">
                            <div class="card-header-right"> 
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#addWalletModal"class="btn-primary btn rounded-full add-wallate"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.add_wallet_amount')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="resttab-sec mb-4">  
            <div class="menu-tab">
                <ul>
                    <li class="active">
                        <a href="<?php echo e(route('drivers.view',$id)); ?>" class="basic"><i class="ri-list-indefinite"></i> <?php echo e(trans('lang.tab_basic')); ?></a>
                    </li>
                    <li class="vehicle_tab" style="display:none">
                        <a href="<?php echo e(route('drivers.vehicle',$id)); ?>" class="vehicle"><i class="ri-car-line"></i> <?php echo e(trans('lang.vehicle')); ?></a>
                    </li>
                    <li class="service_type_orders">
                    </li>
                    <li>
                        <a href="<?php echo e(route('driver.payouts',$id)); ?>" class="payout"><i class="ri-bank-card-line"></i> <?php echo e(trans('lang.tab_payouts')); ?></a>
                    </li>
                    <li>
                ...
                <div class="col-md-3">
                    <div class="card card-box-with-icon bg--1">
                        ...
                        <div class="card-box-with-content">
                            ...
                            <span class="box-icon ab"><img src="<?php echo e(asset('images/total_rides.png')); ?>"></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-box-with-icon bg--3">
                        ...
                        <div class="card-box-with-content">
                            ...
                            <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.wallet_Balance')); ?></p>
                        </div>
                ...
                <div class="card border h-100">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                        <div class="card-header-title">
                            <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.driver_details')); ?>
       ...
       style="display:none;color: green;"></i>
                                ...
                                <div class="sis-content pl-4">
                                    <ul class="p-0 info-list mb-0">                                    
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.first_name')); ?></label>
                                            <span class="driver_name" id="driver_name"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.email')); ?></label>
                                            <span class="email"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.user_phone')); ?></label>
                                            <span class="phone"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2 mr-1">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.wallet_Balance')); ?></label>
                                            <span class="wallet_balance"> </span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2 mr-1">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.service_type')); ?></label>
                                            <span class="service_type"> </span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2 mr-1">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.zone_name')); ?></label>
           ...
           <div class="col-md-6">
                <div class="card border h-100">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                        <div class="card-header-title">
                            <h3 class="text-dark-2 mb-0 h4"><?php echo e(trans('lang.bankdetails')); ?></h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="noBankData" class="text-muted font-weight-bold py-3" style="display:none;">
                            <?php echo e(trans("lang.bank_details_not_found")); ?>
                        ...
                        <div class="restaurant_info_left" id="bankDetailsBox" style="display:none;">
                            <div class="d-flex mb-1">                              
                                <div class="sis-content">
                                    <ul class="p-0 info-list mb-0">
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.bank_name')); ?></label>
                                            <span class="bank_name" id="bank_name"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.branch_name')); ?></label>
                                            <span class="branch_name" id="branch_name"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.holer_name')); ?></label>
                                            <span class="holer_name" id="holer_name"></span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2 mr-1">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.account_number')); ?></label>
                                            <span class="account_number" id="account_number"> </span>
                                        </li>
                                        <li class="d-flex align-items-center mb-2 mr-1">
                                            <label class="mb-0 font-wi font-semibold text-dark-2"><?php echo e(trans('lang.other_information')); ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary save-form-btn" id="add-wallet-btn"><?php echo e(trans('submit')); ?></a>
                    </button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                            aria-label="Close"><?php echo e(trans('close')); ?></a>
                    </button>
                </div>
            </div>
        </div>
        ...
        $(document).ready(async function () {
            ...
            ref.get().then(async function (snapshots) {
                if(snapshots.docs.length>0){
                    ...
                    $('.driver_detail_div').html('<h5 class="font-weight-bold align text-danger text-center"><?php echo e(trans('lang.driver_unknown_deleted')); ?></h5>')
                }
        ...
        $("#add-wallet-btn").click(function () {
            ...
            database.collection('users').where('id', '==', id).get().then(async function (snapshot) {
                if (snapshot.docs.length > 0) {
                    ...
                    $('#user_account_not_found_error').text('<?php echo e(trans("lang.user_detail_not_found")); ?>');
                }
            });
        });
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/drivers/view.blade.php ENDPATH**/ ?>