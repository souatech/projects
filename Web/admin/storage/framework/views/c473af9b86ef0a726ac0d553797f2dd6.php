    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><?php echo e(trans('lang.app_setting_global')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(url('/dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.app_setting_global')); ?></li>
                </ol>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row vendor_payout_create">
                <div class="vendor_payout_create-inner">
                    <fieldset>
                        <legend><i class="mr-3 fa fa-cog"></i>  <?php echo e(trans('lang.app_setting_global')); ?></legend>
                        <div class="form-group row width-100">
                            <label class="col-5 control-label"><?php echo e(trans('lang.app_setting_app_name')); ?></label>
                            <div class="col-7">
                        ...
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.upload_app_logo')); ?></label>
                            <input type="file" class="col-7" onChange="handleFileSelect(event)">
                            <div id="uploding_image"></div>
                            <div class="logo_img_thumb"></div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.menu_placeholder_image')); ?></label>
                        ...
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.upload_provider_logo')); ?></label>
                        ...
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.upload_worker_logo')); ?></label>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 fa fa-dashboard text-white"></i> <?php echo e(trans('lang.panel_color_settings')); ?></legend>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.admin_panel_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="admin_color" id="admin_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.website_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="website_color" id="website_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.store_panel_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="store_color" id="store_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.provider_panel_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="provider_panel_color" id="provider_panel_color">
                        </div>
                    </fieldset>
                    <fieldset>
                        <legend><i class="mr-3 fa fa-paint-brush text-white"></i> <?php echo e(trans('lang.app_color_settings')); ?></legend>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.customer_app_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="customer_app_color" id="customer_app_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.driver_app_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="driver_app_color" id="driver_app_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.store_app_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="store_app_color" id="store_app_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.provider_app_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="provider_app_color" id="provider_app_color">
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.worker_app_color_settings')); ?></label>
                            <input type="color" class="ml-3" name="worker_app_color" id="worker_app_color">
                        </div>
                    </fieldset>
                    <fieldset>
                        <legend><i class="mr-3 fa fa-location-arrow text-white"></i> <?php echo e(trans('lang.google_map_api_key_title')); ?></legend>
                        <div class="form-group row width-100">
                            <label class="col-3 control-label"><?php echo e(trans('lang.google_map_api_key')); ?></label>
                            <div class="col-7">
                    ...
                    <fieldset>
                        <legend><i class="mr-3 fa fa-solid fa-address-book"></i> <?php echo e(trans('lang.contact_us')); ?></legend>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.contact_us_address')); ?></label>
                            <div class="col-7">
                                <textarea class="form-control contact_us_address" rows="3"></textarea>
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.contact_us_address_help')); ?>

                                </div>
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.contact_us_email')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control contact_us_email">
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.contact_us_email_help')); ?>

                                </div>
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.contact_us_phone')); ?></label>
                            <div class="col-7">
                                <input type="number" class="form-control contact_us_phone">
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.contact_us_phone_help')); ?>
                        ...
                        <!-- prachi upadhyay -->
                     <div class="form-group row width-50">
                                    <label class="col-3 control-label"><?php echo e(trans('lang.default_country')); ?><span
                                    ...
                                    <div id="phone-box" class="country-box position-relative">  
                                        ...
                                        <select name="country" id="country" class="form-control defaultCountryCode">
                                            <?php $__currentLoopData = $newcountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($country->countryName); ?>" data-code="<?php echo e($code); ?>" data-phonecode="+<?php echo e($country->phoneCode); ?>">
                                                    <?php echo e($country->countryName); ?> +(<?php echo e($country->phoneCode); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <div class="form-text text-muted">
                                            <?php echo e(trans("lang.default_country_help")); ?>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 fa fa-map-marker text-white"></i> <?php echo e(trans('lang.map_redirection')); ?></legend>
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.select_map_type_for_application')); ?></label>
                            <div class="col-7">
                                <select name="selectedMapType" id="selectedMapType" class="form-control selectedMapType">
                                    <option value="google"><?php echo e(trans('lang.google_maps')); ?></option>
                                    <option value="osm"><?php echo e(trans('lang.open_street_map')); ?></option>
                                </select>
                            </div>
                            <div class="form-text pl-3 text-muted">
                                <span><strong><?php echo e(trans('lang.note')); ?>:</strong>
                                    <?php echo e(trans('lang.google_map_note')); ?><br>
                                    <?php echo e(trans('lang.open_street_map_note')); ?><br>
                                    <strong><?php echo e(trans('lang.recommended_note')); ?></strong>
                                </span>
                            </div>
                        </div>
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <select name="map_type" id="map_type" class="form-control map_type">
                                    ...
                                    <option value="google"><?php echo e(trans('lang.google_map')); ?></option>
                                    <option value="googleGo"><?php echo e(trans('lang.google_go_map')); ?></option>
                                    <option value="waze"><?php echo e(trans('lang.waze_map')); ?></option>
                                    <option value="mapswithme"><?php echo e(trans('lang.mapswithme_map')); ?></option>
                                    <option value="yandexNavi"><?php echo e(trans('lang.vandexnavi_map')); ?></option>
                                    <option value="yandexMaps"><?php echo e(trans('lang.vandex_map')); ?></option>
                                    <option value="inappmap"><?php echo e(trans('lang.inapp_map')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.driver_location_update')); ?></label>
                            <div class="col-7">
                        ...
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                ...
                                <label class="col-5 control-label" for="single_order_receive"><?php echo e(trans('lang.single_order_receive')); ?></label>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-cash-100"></i><?php echo e(trans('lang.wallet_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.minimum_deposit_amount')); ?></label>
                            <div class="col-7">
                        ...
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.minimum_deposit_amount_owner')); ?></label>
                            <div class="col-7">
                                <div class="control-inner">
                        ...
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.minimum_withdrawal_amount')); ?></label>
                            <div class="col-7">
                                <div class="control-inner">
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-share"></i><?php echo e(trans('lang.digital_product_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.digital_product_max_fileSize')); ?></label>
                            <div class="col-7">
                                <div class="control-inner">
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-cash"></i><?php echo e(trans('lang.tax_settings')); ?></legend>
                         <div class="form-group row width-100">
                            <label class="col-4 control-label"><?php echo e(trans('lang.tax_scope')); ?></label>
                            <div class="col-7">
                                <select name="selectedMapType" id="tax_scope" class="form-control">
                                    <option value="order"><?php echo e(trans('lang.order_wise_tax')); ?></option>
                                    <option value="product"><?php echo e(trans('lang.product_wise_tax')); ?></option>
                                </select>
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.tax_scope_help')); ?>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-shopping"></i><?php echo e(trans('lang.store_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                <input type="checkbox" class="form-check-inline" id="store_can_upload_story">
                                <label class="col-5 control-label" for="store_can_upload_story"><?php echo e(trans('lang.store_can_upload_story')); ?></label>
                                <input type="checkbox" class="form-check-inline" id="auto_approve_vendor">
                                <label class="col-5 control-label" for="auto_approve_vendor"><?php echo e(trans('lang.auto_approve_vendor')); ?></label>
                                <input type="checkbox" class="form-check-inline" id="emaployee_detail_management">
                                <label class="col-5 control-label" for="emaployee_detail_management"><?php echo e(trans('lang.employee_management')); ?></label>

                            </div>
                        </div>
                        <div class="form-group row width-50" id="story_upload_time_div" style="display:none;">
                            <label class="col-5 control-label"><?php echo e(trans('lang.story_upload_time')); ?></label>
                            <div class="col-7">
                                <input type="number" class="form-control" id="story_upload_time" value="30" min="0">
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.story_upload_time_help')); ?>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-shopping"></i><?php echo e(trans('lang.provider_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                <input type="checkbox" class="form-check-inline" id="auto_approve_provider">
                                <label class="col-5 control-label" for="auto_approve_provider"><?php echo e(trans('lang.auto_approve_provider')); ?></label>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-newspaper"></i><?php echo e(trans('lang.advertisement_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                <input type="checkbox" class="form-check-inline" id="enable_adv_feature">
                                <label class="col-5 control-label" for="enable_adv_feature"><?php echo e(trans('lang.enable_adv_feature')); ?></label>
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.enable_adv_feature_help')); ?>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-truck-delivery"></i><?php echo e(trans('lang.self_delivery_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                <input type="checkbox" class="form-check-inline" id="enable_self_delivery">
                                <label class="col-5 control-label" for="enable_self_delivery"><?php echo e(trans('lang.enable_self_delivery')); ?></label>
                                <div class="form-text text-muted">
                                    <?php echo e(trans('lang.enable_self_delivery_help')); ?>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-music-box"></i><?php echo e(trans('lang.order_ringtone_settings')); ?></legend>
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                <input type="file" id="ringtone_file" onchange="handleRingtoneSelect(event)">
                                <div class="ringtone_file mt-2"></div>
                                <div class="form-text text-muted w-50"><?php echo nl2br(trans('lang.audio_information')); ?>

                                </div>
                            </div>
                    </fieldset>
                    <fieldset>
                        <legend><i class="mr-3 fa fa-envelope text-white"></i> <?php echo e(trans('lang.email_settings')); ?></legend>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.smtp')); ?> <?php echo e(trans('lang.from_name')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control from_name">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.smtp')); ?> <?php echo e(trans('lang.host')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control host">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.smtp')); ?> <?php echo e(trans('lang.port')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control port">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.smtp_user_name')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control user_name">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label"><?php echo e(trans('lang.smtp')); ?> <?php echo e(trans('lang.password')); ?></label>
                            <div class="col-7">
                    ...
                    <fieldset>
                        <legend><i class="mr-3 mdi mdi-comment-alert"></i><?php echo e(trans('lang.notification_settings')); ?></legend>
                        <div class="form-group row width-100">
                        ...
                        <div class="form-group row width-100">
                            <label class="col-3 control-label"><?php echo e(trans('lang.upload_json_file')); ?></label>
                    ...
                    <fieldset>
                        <legend><i class="mr-3 fa fa-solid fa fa-android"></i><?php echo e(trans('lang.version')); ?></legend>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.app_version')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control app_version">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.web_version')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control" id="web_version">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.setting_website_url')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control" id="website_url">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.setting_store_url')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control" id="store_url">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.setting_provider_url')); ?></label>
                            <div class="col-7">
                                <input type="text" class="form-control" id="provider_url">
                            </div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-5 control-label"><?php echo e(trans('lang.setting_api_secure_key')); ?></label>
                            <div class="col-7">
                                <input type="password" class="form-control" id="api_secure_key">
                                <div class="form-text text-muted"><?php echo e(trans("lang.setting_api_secure_key_help")); ?></div>
                            </div>
                        </div>
                    </fieldset>
                </div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            <button type="button" class="btn btn-primary edit-setting-btn"><i class="fa fa-save"></i> <?php echo e(trans('lang.save')); ?></button>
            <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".edit-setting-btn").click(async function() {
                ...
                var api_base_url = "<?php echo e(url('/')); ?>";
                ...
                if (applicationName == '') {
                    ...
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.enter_minimum_deposit_amount_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (minimumAmountToWithdrawal == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.enter_minimum_withdrawal_amount_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (fileSize == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.enter_digital_product_filesize_error')); ?></p>");
                    window.scrollTo(0, 0);
                    window.scrollTo(0, 0);
                } else if (host == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.host_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (port == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.port_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (userName == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.username_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (password == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.password_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (senderId == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.notification_sender_id_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (serviceJsonFile == '') {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.notification_service_json_error')); ?></p>");
                    window.scrollTo(0, 0);
                    ...
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.setting_api_secure_key_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else {
                    jQuery("#data-table_processing").show();
                    ...
                    database.collection('settings').doc("emailSetting").update({
                        ...
                        window.location.href = '<?php echo e(url('settings/app/globals')); ?>';
                    });
                }
            })
        })
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/global.blade.php ENDPATH**/ ?>