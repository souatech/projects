...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.rides')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <?php if (isset($_GET['eid']) && $_GET['eid'] != '') { ?>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('drivers.ride',$_GET['eid'])); ?>"><?php echo e(trans('lang.order_plural')); ?></a>
                    </li>
                <?php } else { ?>
                    <li class="breadcrumb-item"><a href="javascript:window.history.go(-1);"><?php echo e(trans('lang.rides')); ?></a>
                    </li>
                <?php } ?>

                <li class="breadcrumb-item"><?php echo e(trans('lang.ride_edit')); ?></li>
            </ol>
        </div>
    </div>
    ...
    <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="order_detail-top-box">
                                    ...
                                    <div class="form-group row widt-100 gendetail-col">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.payment_methods')); ?>: </strong><span
                                                    id="payment_method"></span></label>
                                    </div>


                                    <div class="form-group row widt-100 gendetail-col">
                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.ridetype')); ?>:</strong>
                                            <span
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="address order_detail-top-box">
                                    <div class="address order_detail-top-box">
                                        <div class="form-group row widt-100 gendetail-col">
                                            <label class="col-12 control-label"><strong><?php echo e(trans('lang.name')); ?>
                                        ...
                                        <div class="form-group row widt-100 gendetail-col">
                                            <label class="col-12 control-label"><strong><?php echo e(trans('lang.email_address')); ?>
                        ...
                        <div class="resturant-detail mt-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong id="vendor_phone1"><?php echo e(trans('lang.phone')); ?>:</strong>
                                        <span id="vendor_phone"></span>
                                    </p>
                                    <h5 class="contact-info"><?php echo e(trans('lang.car_info')); ?>:</h5>
                                    
                                    <br>
                                    <p><strong id="driver_carName1" style="width:auto !important;"><?php echo e(trans('lang.car_name')); ?>:</strong>
                                        <span id="driver_carName"></span>
                                    </p> <br>
                                    <p><strong id="driver_carNumber1" style="width:auto !important;"><?php echo e(trans('lang.car_number')); ?>:</strong>
                                        <span id="driver_carNumber"></span>
                                    </p> <br>
                                    <p><strong id="driver_car_make1" style="width:auto !important;"><?php echo e(trans('lang.car_make')); ?>:</strong>
                                        <span id="driver_car_make"></span>
                                    </p>
                                    <p><strong id="driver_car_type1" style="width:auto !important;"><?php echo e(trans('lang.vehicle_type')); ?>:</strong>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <?php if (isset($_GET['eid']) && $_GET['eid'] != '') { ?>
                <a href="<?php echo e(route('vendors.orders',$_GET['eid'])); ?>" class="btn btn-default"><i
...
<script type="text/javascript">
        ...
        ref.get().then(async function (snapshots) {
            ...
            if (ride.paymentMethod) {
                ...
                if (ride.paymentMethod == "stripe") {
                    ...
                    image = '<?php echo e(asset("images/payfast.png")); ?>';
                    paymentMethod = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" width="30%" height="30%">';
            ...
            if (driverId != '' && driverId != undefined) {
                ...
                $('.resturant-img').hide();
                $('.vendor-title').text("<?php echo e(trans('lang.no_driver_assigned')); ?>");
                $('#vendor_email').hide();
                $('#vendor_phone').hide();
                $('#resturant-car').hide();
                $('#driver_carName').hide();
            ...
            if (old_order_status != orderStatus) {
                database.collection('rides').doc(id).update({'status': orderStatus}).then(async function (result) {
                    ...
                    await $.ajax({
                        ...
                        success: function (data) {
                            <?php if (isset($_GET['eid']) && $_GET['eid'] != '') { ?>
                            window.location.href = "<?php echo e(route('driver.ride',$_GET['eid'])); ?>";
                            <?php } else { ?>
                            window.location.href = '<?php echo e(route("rides")); ?>';
                            <?php } ?>
                        }
                    });
    ...
    function buildHTMLProductsList(snapshots) {
        ...
        html = html + '<tr>';
        if (snapshots.size) {
            html = html + '<div class="type"><span><?php echo e(trans("lang.type")); ?> :</span><span class="ext-size">' + snapshots.size + '</span></div>';
        }
    ...
    function buildHTMLProductstotal(snapshotsProducts) {
        ...
        if (discount > 0) {
            ...
            couponCode_html = '</br><small><?php echo e(trans('lang.coupon_codes')); ?> :' + discountLabel + '</small>';
        }
        ...
        html = html +'<tr><td class="label"><?php echo e(trans('lang.tip_amount')); ?></td><td class="tip_amount_val">+' +
        ...
        if (notes) {
            html = html + '<tr><td class="label"><?php echo e(trans("lang.notes")); ?></td><td class="adminCommission_val">' + notes + '</td></tr>';
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/rides/edit.blade.php ENDPATH**/ ?>