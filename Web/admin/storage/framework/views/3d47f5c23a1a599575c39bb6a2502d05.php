        ...
        <div class="payment-top-tab mt-3 mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active stripe_active_label" href="<?php echo url('settings/payment/stripe'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_stripe')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link cod_active_label" href="<?php echo url('settings/payment/cod'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_cod_short')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link razorpay_active_label" href="<?php echo url('settings/payment/razorpay'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_razorpay')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link paypal_active_label" href="<?php echo url('settings/payment/paypal'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_paypal')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link wallet_active_label" href="<?php echo url('settings/payment/wallet'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_wallet')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link payfast_active_label" href="<?php echo url('settings/payment/payfast'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.payfast')); ?><span class="badge ml-2"></span>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link paystack_active_label" href="<?php echo url('settings/payment/paystack'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_paystack_lable')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link flutterWave_active_label" href="<?php echo url('settings/payment/flutterwave'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.flutterWave')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link mercadopago_active_label" href="<?php echo url('settings/payment/mercadopago'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.mercadopago')); ?><span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link xendit_active_label" href="<?php echo url('settings/payment/xendit'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.xendit')); ?><span class="badge ml-2"></span>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link midTrans_active_label" href="<?php echo url('settings/payment/midtrans'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.midtrans')); ?><span class="badge ml-2"></span>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link  orangePay_active_label" href="<?php echo url('settings/payment/orangepay'); ?>"><i

                            class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.orangePay')); ?><span
                 ...
                 <li class="nav-item">
                    ...
                    <a class="nav-link paydunya_active_label" href="<?php echo url('settings/payment/paydunya'); ?>">
            ...
            <div class="row vendor_payout_create">
                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <legend><i class="mr-3 fa fa-cc-stripe"></i><?php echo e(trans('lang.app_setting_stripe')); ?></legend>
                        ...
                        <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                for="enable_stripe"><?php echo e(trans('lang.app_setting_enable_stripe')); ?></label>

                            <div class="form-text text-muted">

                                <?php echo trans('lang.app_setting_enable_stripe_help'); ?>
                    ...
                    <fieldset>
                        ...
                        <legend><i class="mr-3 fa fa-cc-stripe"></i><?php echo e(trans('lang.withdraw_setting')); ?></legend>
                       ...
                       <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                for="withdraw_enable"><?php echo e(trans('lang.app_setting_enable_stripe')); ?></label>

                            <div class="form-text text-muted">

                                <?php echo trans('lang.withdraw_setting_enable_stripe_help'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/stripe.blade.php ENDPATH**/ ?>