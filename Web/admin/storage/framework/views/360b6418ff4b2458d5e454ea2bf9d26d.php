    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">
                <?php if(request()->is('owners/approved')): ?>
                    <?php $type = 'approved'; ?>
                    <?php echo e(trans('lang.approved_owners')); ?>

                <?php elseif(request()->is('owners/pending')): ?>
                    <?php $type = 'pending'; ?>
                    <?php echo e(trans('lang.approval_pending_owners')); ?>

                <?php else: ?>
                    <?php $type = 'all'; ?>
                    <?php echo e(trans('lang.all_owners')); ?>
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.owners_list')); ?></li>
            </ol>
        </div>
        <div>
        </div>
            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        ...
                        <h3 class="mb-0"><?php echo e(trans('lang.owners_list')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                        <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.owners_list')); ?></h3>
                        <p class="mb-0 text-dark-2"><?php echo e(trans('lang.owners_table_text')); ?></p>
                   </div>

                  <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3">
                        <a class="btn-primary btn rounded-full" href="<?php echo route('owners.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.create_owner')); ?></a>
                    </div>
                </div>
                         ...
                         <div class="table-responsive m-t-10">
                            <table id="userTable"
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <th><?php echo e(trans('lang.owner_info')); ?></th>
...
$(document).ready(function () {
    ...
    var fieldConfig = {
        columns: [
            { key: 'name', header: "<?php echo e(trans('lang.owner_info')); ?>" },
            { 
                    key: 'contact_info', 
                    header: "<?php echo e(trans('lang.contact_info')); ?>",
        ...
        fileName: "<?php echo e(trans('lang.owners_list')); ?>",
    };
...
async function buildHTML(val) {
    ...
    var route1 = '';
    var route1 =  '<?php echo e(route("owners.edit", ":id")); ?>';
    route1 = route1.replace(':id', val.id);
    var ownerView = '<?php echo e(route("owners.view", ':id')); ?>';
    ownerView = ownerView.replace(':id', id);
    
    var checkIsStore = getUserStoreInfo(id);

    var trroute1 = '<?php echo e(route("walletTransaction.owner", ":id")); ?>';
    ...
    if (val.hasOwnProperty("createdAt")) {
     ...
     var document_list_view = '<?php echo e(route("owners.document", ':id')); ?>';
    ...
    if(val.isAutoVerify !== true){
        action += '<a href="' + document_list_view + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.document_plural')); ?>"><i class="fa fa-file"></i></a>';
    }
    
    action = action + '<a href="' + ownerView + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.view')); ?>"><i class="mdi mdi-eye"></i></a>';
    ...
    if(val.hasOwnProperty('subscription_plan')) {
        action+='<a id="'+val.id+'"  href="'+planRoute+'" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.view')); ?>"><i class="mdi mdi-crown"></i></a>';
    }
...
async function getUserStoreInfo(userId) {
    ...
    await database.collection('vendors').where('author', '==', userId).get().then(async function (restaurantSnapshots) {
        ...
        if (restaurantSnapshots.docs.length > 0) {
            ...
            var restaurantView = '<?php echo e(route("owners.edit", ":id")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/owners/index.blade.php ENDPATH**/ ?>