    ...
    <div class="card">
        ...
        <div class="payment-top-tab mt-3 mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link  stripe_active_label" href="<?php echo url('settings/payment/stripe'); ?>"><i
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active wallet_active_label" href="<?php echo url('settings/payment/wallet'); ?>"><i
            ...
            <div class="row vendor_payout_create">
                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <legend><?php echo e(trans('lang.app_setting_wallet')); ?></legend>
                        ...
                        <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                for="enable_wallet"><?php echo e(trans('lang.app_setting_enable_wallet')); ?></label>
        ...
        <div class="form-group col-12 text-center btm-btn" style="margin-bottom: inherit;">
            ...
            <button type="button" class="btn btn-primary edit-setting-btn"><i class="fa fa-save"></i>
                ...
                <?php echo e(trans('lang.save')); ?></button>
...
$(document).ready(function() {
    ...
    $(".edit-setting-btn").click(function() {
        ...
        database.collection('settings').doc("walletSettings").update({
            ...
            window.location.href = '<?php echo e(url("settings/payment/wallet")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/wallet.blade.php ENDPATH**/ ?>