...
<div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor restaurantTitle"><?php echo e(trans('lang.driver_document_details')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.driver_document_details')); ?></li>
                </ol>
            </div>
        </div>
                            ...
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                <li class="nav-item">
                                    <a class="nav-link active vendor-name"
                                       href="<?php echo url()->current(); ?>"><?php echo e(trans('lang.driver_document_details')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
...
<?php $__env->startSection('scripts'); ?>z
<script>
    var id = "<?php echo $id;?>";
    ...
    $(document).ready(async function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            $(".vendor-name").text(vendor.firstName+' '+vendor.lastName+ "'s" + " <?php echo e(trans('lang.driver_document_details')); ?>")
        });
        var html = '';
        var count = 0;
        await docsRef.get().then(async function (docSnapshot) {
            ...
            html += "<thead>";
            html += '<tr>';
            html += '<th><?php echo e(trans('lang.name')); ?></th>';
            html += '<th><?php echo e(trans('lang.status')); ?></th>';
            html += '<th><?php echo e(trans('lang.action')); ?></th>';
            html += '</tr>';
            html += '</thead>';
            html += '<tbody>';
            html += '</tbody>';
                    ...
                    docRefs.get().then(async function (docrefSnapshot) {
                        ...
                        if (docRef && docRef.hasOwnProperty('backImage') && docRef.hasOwnProperty('frontImage') ) {
                            if (docRef.backImage != '' && docRef.frontImage != '' && docRef.backImage!=null && docRef.frontImage != null  && doc.backSide && doc.frontSide  ) {
                                                            trhtml += '<td>' + doc.title + '&nbsp;&nbsp;<a href="#" class="badge badge-info" data-toggle="modal" data-target="#exampleModal" data-image="' + docRef.frontImage + '" data-id="front" class="open-image"><?php echo e(trans('lang.view_front_image')); ?></a>&nbsp;<a href="#" class="badge badge-info" data-toggle="modal" data-target="#exampleModal"  data-image="' + docRef.backImage + '" data-id="back" class="open-image"><?php echo e(trans('lang.view_back_image')); ?></a></td>';
                            } else if (docRef.backImage != '' && docRef.backImage != null  && doc.backSide) {
                                trhtml += '<td>' + doc.title + '&nbsp;<a href="#" data-toggle="modal" class="badge badge-info" data-target="#exampleModal" data-id="back" data-image="' + docRef.backImage + '" class="open-image"><?php echo e(trans('lang.view_back_image')); ?></a></td>';
                            } else if (docRef.frontImage != '' && docRef.frontImage != null && doc.frontSide ) {
                                trhtml += '<td>' + doc.title + '&nbsp;<a href="#" data-toggle="modal" class="badge badge-info" data-target="#exampleModal" data-id="front" class="open-image" data-image="' + docRef.frontImage + '"><?php echo e(trans('lang.view_front_image')); ?></a></td>';
                            } else {
                        ...
                        var driverDocumentUploadUrl = "<?php echo e(route('drivers.document.upload', ['driverId' => ':driverId', 'id' => ':id'])); ?>";
                            driverDocumentUploadUrl = driverDocumentUploadUrl.replace(':driverId', id.trim()).replace(':id', doc.id.trim());

                        trhtml += '<a href="' + driverDocumentUploadUrl + '" data-id="' + doc.id + '"><i class="mdi mdi-lead-pencil" title="Edit"></i></a>&nbsp;';
                        if (status !== 'pending') {
                            if (status == "rejected") {
                                trhtml += '&nbsp;<a href="javascript:void(0);" class="btn btn-sm btn-success direct-click-btn verify-doc" id="approve-doc" data-title="' + doc.title + '"  data-id="' + doc.id + '"><?php echo e(trans('lang.approve')); ?></a>';
                            } else if (status == "approved") {
                                trhtml += '&nbsp;<a href="javascript:void(0);" class="btn btn-sm btn-danger direct-click-btn verify-doc" id="disapprove-doc" data-title="' + doc.title + '"  data-id="' + doc.id + '"><?php echo e(trans('lang.reject')); ?></a>';
                            } else {
                                trhtml += '&nbsp;<a href="javascript:void(0);" class="btn btn-sm btn-success direct-click-btn verify-doc" id="approve-doc" data-title="' + doc.title + '"  data-id="' + doc.id + '"><?php echo e(trans('lang.approve')); ?></a>&nbsp;<a href="javascript:void(0);" class="btn btn-sm btn-danger verify-doc" id="disapprove-doc" data-title="' + doc.title + '"  data-id="' + doc.id + '"><?php echo e(trans('lang.reject')); ?></a>';
                            }
                        }
                        trhtml += '</td>';
                        trhtml += '</tr>';
                            ...
                            if(verification){
                                if (status == "rejected") {
                                    ...
                                    if (fcmToken && fcmToken != '') {
                                        $.ajax({
                                            url: "<?php echo e(route('advertisement.sendnotification')); ?>",
                                            type: "POST",
                                            data: {
                                                _token: "<?php echo e(csrf_token()); ?>",
                                                fcm: fcmToken,
                                                title:  '<?php echo e(trans('lang.rejected_your_document')); ?>',
                                                message: '<?php echo e(trans('lang.admin_rejected_document')); ?>' + docTitle + ' . <?php echo e(trans('lang.please_submit_again')); ?>',
                                            },
                                    ...
                                    if (fcmToken && fcmToken != '') {
                                        $.ajax({
                                            ...
                                            data: {
                                                _token: "<?php echo e(csrf_token()); ?>",
                                                fcm: fcmToken,
                                                title:  '<?php echo e(trans('lang.approved_your_document')); ?>',
                                                message: '<?php echo e(trans('lang.admin_approved_document')); ?>' + docTitle,
                                            },
                                            success: function (response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/drivers/document_list.blade.php ENDPATH**/ ?>