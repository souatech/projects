            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-6 mb-3">
                            <div class="card card-box-with-icon border " onclick="javascript:void(0)">
                                <div class="card-body p-3">
                                    ...
                                    <div class="card-box-with-content mt-3">
                                        <h4 class="card-left-title text-dark font-medium">
                                            <?php echo e(trans('lang.admin_commission')); ?>
                        ...
                        <div class="col-sm-6 col-lg-6 mb-3">
                            <div class="card card-box-with-icon border cursor-pointer" onclick="location.href='<?php echo route('stores'); ?>'">
                                <div class="card-body p-3">
                                    <span class="box-icon ab"><img src="<?php echo e(asset('images/total_store.png')); ?>"></span>
                                    <div class="card-box-with-content mt-3">
                                        <h4 class="card-left-title text-dark font-medium">
                                            <?php echo e(trans('lang.dashboard_total_stores')); ?>
                        ...
                        <div class="col-sm-6 col-lg-6 mb-3">
                            <div class="card card-box-with-icon border cursor-pointer" onclick="location.href='<?php echo route('orders'); ?>'">
                                <div class="card-body p-3">
                                    <span class="box-icon ab"><img src="<?php echo e(asset('images/total_orders1.png')); ?>"></span>
                                    <div class="card-box-with-content mt-3">
                                        <h4 class="card-left-title text-dark font-medium">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="card border">
                        <div class="card-header no-border d-flex justify-content-between">
                            <h3 class="card-title"><?php echo e(trans('lang.top_stores')); ?></h3>
                            <a href="<?php echo e(route('stores')); ?>"><?php echo e(trans('lang.view_all')); ?></a>
                        </div>
                        <div class=" card-body">
                            <table class="table table-striped table-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(trans('lang.vendor_review_review')); ?></th>
                            ...
                            <table class="table table-striped table-valign-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(trans('lang.order_completed')); ?></th>
                                        <th><?php echo e(trans('lang.actions')); ?></th>
                                    </tr>
                                </thead>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card border">
                        <div class="card-header no-border d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(route('orders')); ?>"><?php echo e(trans('lang.view_all')); ?></a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped table-valign-middle">
                                <thead>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        // Fallback: if section cookie expired, auto-load first active delivery section
        if (!active_id || active_id === 'null') {
            db.collection('sections')
                .where('isActive', '==', true)
                .where('serviceTypeFlag', '==', 'delivery-service')
                .orderBy('order')
                .limit(1)
                .get()
                .then(function(snap) {
                    if (!snap.empty) {
                        ...
                        active_type = snap.docs[0].data().serviceTypeFlag || 'delivery-service';
                ...
                window.orderStatusChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: [
                            ...
                            "<?php echo e(trans('lang.dashboard_order_shipped')); ?>",
                            "<?php echo e(trans('lang.dashboard_order_completed')); ?>",
                            "<?php echo e(trans('lang.order_rejected')); ?>",
                            "<?php echo e(trans('lang.dashboard_order_failed')); ?>",
                            "<?php echo e(trans('lang.dashboard_order_pending')); ?>",
            ...
            return new Chart(document.getElementById("commissions"), {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: "<?php echo e(trans('lang.admin_commissions')); ?>s",
        ...
        async function loadDashboardLists(filterType = null, year = null, month = null, startDate = null, endDate = null, active_id, active_type) {
            ...
            if(html == ''){
                append_listvendors.innerHTML = '<tr><td colspan="3"><?php echo e(trans("lang.no_record_found")); ?></td></tr>';
            }else{
            ...
            if(html == ''){
                append_listrecent_order.innerHTML = '<tr><td colspan="3"><?php echo e(trans("lang.no_record_found")); ?></td></tr>';
            }else{
            ...
            ref = db.collection('users').where('role', '==', 'driver').where('sectionIds', 'array-contains', active_id);
        ...
        function loadVendorDashboardData(filterType = null, year = null, month = null, startDate = null, endDate = null, active_id, active_type) {
            ...
            Promise.all([
                ...
                db.collection('users').where("role", "==", "driver").where('isOwner','==',false).where('sectionIds', 'array-contains', active_id).orderBy('createdAt', 'desc').get(),
                ...
                db.collection('users').where("role", "==", "driver").where('isOwner','==',false).where('sectionIds', 'array-contains', active_id).where('createdAt', '>=', startThisTS).where('createdAt', '<=', endThisTS).orderBy('createdAt', 'desc').get(),
                ...
                startLastTS ? db.collection('users').where("role", "==", "driver").where('isOwner','==',false).where('sectionIds', 'array-contains', active_id).where('createdAt', '>=', startLastTS).where('createdAt', '<=', endLastTS).orderBy('createdAt', 'desc').get() : Promise.resolve({ docs: [] }),
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/dashboard/delivery.blade.php ENDPATH**/ ?>