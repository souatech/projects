...
<div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor restaurantTitle"><?php echo e(trans('lang.vendor_document_details')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                    <li class="breadcrumb-item"><a href="<?php echo route('vendors'); ?>"><?php echo e(trans('lang.vendor_list')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.vendor_document_details')); ?></li>
                </ol>
            </div>
        </div>
                            ...
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                <li class="nav-item">
                                    <a class="nav-link active vendor-name"
                                       href="<?php echo url()->current(); ?>"><?php echo e(trans('lang.vendor_document_details')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    $(document).ready(async function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            $(".vendor-name").text(vendor.firstName+' '+vendor.lastName+ "'s" + " <?php echo e(trans('lang.vendor_document_details')); ?>")
        });
        var html = '';
        var count = 0;
        await docsRef.get().then(async function (docSnapshot) {
            ...
            html += '<th><?php echo e(trans("lang.actions")); ?></th>';
            html += '</tr>';
            html += '</thead>';
            html += '<tbody>';
            html += '</tbody>';
            ...
            if (docSnapshot.docs.length) {
                ...
                documents.forEach((ele) => {
                    ...
                    docRefs.get().then(async function (docrefSnapshot) {
                        ...
                        var ownerDocumentUploadUrl = "<?php echo e(route('vendors.document.upload', ['ownerId' => ':ownerId', 'id' => ':id'])); ?>";
                         ownerDocumentUploadUrl = ownerDocumentUploadUrl.replace(':ownerId', id.trim()).replace(':id', doc.id.trim());

                        trhtml += '<a href="' + ownerDocumentUploadUrl + '" data-id="' + doc.id + '"><i class="mdi mdi-lead-pencil" title="<?php echo e(trans('lang.edit')); ?>"></i></a>&nbsp;';
                        if (status !== 'pending') {
                            if (status == "rejected") {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/vendors/document_list.blade.php ENDPATH**/ ?>