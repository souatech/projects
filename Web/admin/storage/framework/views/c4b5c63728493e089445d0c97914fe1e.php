        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <div class="d-flex top-title-section justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        <span class="icon mr-3"><img src="<?php echo e(asset('images/category.png')); ?>"></span>
                        <h3 class="mb-0"><?php echo e(trans('lang.deliveryman_table')); ?> <span class="page-title"></span></h3>
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.deliveryman')); ?></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="menu-tab">
                            ...
                            <a href="<?php echo e(route('vendors.booktable',$id)); ?>"><i class="ri-restaurant-line"></i><?php echo e(trans('lang.dine_in_booking_history')); ?></a>
                                ...
                                <li>
                                    <a class="wallet_transaction" href=""><i class="ri-wallet-line"></i><?php echo e(trans('lang.wallet_transaction')); ?></a>
                                </li>
                                <?php }?>
                                <?php
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.deliveryman_table')); ?></h3>
                                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.deliveryman_table_text')); ?></p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">
                                        <?php if ($id != '' && $id != null) { ?>
                                        <a class="btn-primary btn rounded-full" href="<?php echo route('deliveryman.create'); ?>/<?php echo e($id); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.create_deliveryman')); ?></a>
                                             <?php  } else { ?>
                                        <a class="btn-primary btn rounded-full" href="<?php echo route('deliveryman.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.create_deliveryman')); ?></a>
                                     <?php } ?>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="deliverymanTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            <th class="delete-all"><input type="checkbox" id="is_active"><label class="col-3 control-label" for="is_active">
                                                    <a id="deleteAll" class="do_not_delete" href="javascript:void(0)"><i class="mdi mdi-delete"></i> <?php echo e(trans('lang.all')); ?></a></label></th>
                                            <?php }
                                            ?>
                                            <th><?php echo e(trans('lang.user_info')); ?></th>
                                            <th><?php echo e(trans('lang.email')); ?></th>
                                            <?php if ($id == '') { ?>
                                            <th><?php echo e(trans('lang.res_info')); ?></th>
                                            <?php } ?>
                                            <th><?php echo e(trans('lang.active')); ?></th>
                                            <th><?php echo e(trans('lang.date')); ?></th>
                                            <th><?php echo e(trans('lang.dashboard_total_orders')); ?></th>
...
<script type="text/javascript">
        ...
        if (id != '') {
            database.collection('vendors').where("id", "==", '<?php echo e($id); ?>').get().then(async function(snapshots) {
        ...
        $('.status_selector').select2({
            placeholder: "<?php echo e(trans('lang.select_status')); ?>",
        ...
        $(document).ready(function() {
            ...
            <?php if($id != ''): ?>
                var fieldConfig = {
                    columns: [{
                            key: 'driverName',
                            header: "<?php echo e(trans('lang.user_name')); ?>"
                        },
                        {
                            key: 'email',
                            header: "<?php echo e(trans('lang.email')); ?>"
                        },

                        {
                            key: 'active',
                            header: "<?php echo e(trans('lang.driver_active')); ?>"
                        },
                        {
                            key: 'createdAt',
                            header: "<?php echo e(trans('lang.created_at')); ?>"
                        },
                    ],
                    fileName: "<?php echo e(trans('lang.deliveryman_table')); ?>",
                };
            <?php else: ?>
                var fieldConfig = {
                    columns: [{
                        ...
                        {
                            key: 'vendorTitle',
                            header: "<?php echo e(trans('lang.restaurant')); ?>"
                        },
                        {
                            key: 'active',
                            header: "<?php echo e(trans('lang.driver_active')); ?>"
        ...
        async function buildHTML(val) {
            var html = [];
            var id = val.id;
            var route1 = '<?php echo e(route('deliveryman.edit', ':id')); ?>';
            ...
            var action = '';
            action = action + '<?php if(in_array('deliveryman.edit', json_decode(@session('user_permissions'),true))){ ?><span class="action-btn"><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a><?php } ?>';
            action = action + '<?php if(in_array('deliveryman.delete', json_decode(@session('user_permissions'),true))){ ?><a id="' + val.id + '" class="do_not_delete" name="deliveryman-delete" href="javascript:void(0)" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>"><i class="mdi mdi-delete"></i></a><?php } ?>';
            action = action + '</span>';
            html.push(action);
            return html;
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/deliveryman/index.blade.php ENDPATH**/ ?>