<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles non-printable">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('vendors.orders', $_GET['eid'])); ?>"><?php echo e(trans('lang.order_plural')); ?></a>
                    </li>
                    <?php } else { ?>
                    <li class="breadcrumb-item"><a href="<?php echo route('orders'); ?>"><?php echo e(trans('lang.order_plural')); ?></a>
                    </li>
                    <?php } ?>

                    <li class="breadcrumb-item"><?php echo e(trans('lang.order_edit')); ?></li>
                </ol>
            </div>
        </div>
        ...
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                <li role="presentation" class="nav-item">
                    <a href="#category_information" aria-controls="category_information" role="tab" data-toggle="tab" class="nav-link active"><?php echo e(trans('lang.order_information')); ?></a>
                </li>
                <li role="presentation" class="nav-item">
                    <a href="#review_attributes" aria-controls="review_attributes" role="tab" data-toggle="tab" class="nav-link"><?php echo e(trans('lang.reviewattribute_plural')); ?></a>
                </li>
            </ul>
        </div>
        <?php } ?>
        <div class="card-body">
            ...
            <div class="text-right print-btn"><a href="<?php echo e(route('vendors.orderprint', $id)); ?>">
                            ...
                            <div class="order_detail-top">
                                <div class="row">
                                    ...
                                    <div class="order_edit-genrl col-lg-7 col-md-12 col-md-7">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-header-title"><?php echo e(trans('lang.general_details')); ?></h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="order_detail-top-box">
                                                    ...
                                                    <div class="form-group row widt-100 gendetail-col">
                                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.order_type')); ?>
                                                    ...
                                                    <div class="form-group row widt-100 gendetail-col" id="ccname_div" style="display:none">
                                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.courier_company_name')); ?>
                                                    ...
                                                    <div class="form-group row widt-100 gendetail-col" id="ccid_div" style="display:none">
                                                        <label class="col-12 control-label"><strong><?php echo e(trans('lang.courier_tracking_id')); ?>
                                                    ...
                                                    <div class="form-group row width-100 ">
                                                        <label class="col-3 control-label"><?php echo e(trans('lang.status')); ?>

                                                            :</label>
                                                        <div class="col-7">
                                                            <select id="order_status" class="form-control">
                                                                <option value="Order Placed" id="order_placed"><?php echo e(trans('lang.order_placed')); ?>

                                                                </option>
                                                                <option value="Order Accepted" id="order_accepted"><?php echo e(trans('lang.order_accepted')); ?>

                                                                </option>
                                                                <option value="Order Rejected" id="order_rejected"><?php echo e(trans('lang.order_rejected')); ?>

                                                                </option>
                                                                <option value="Driver Pending" id="driver_pending"><?php echo e(trans('lang.driver_pending')); ?>

                                                                </option>
                                                                <option value="Driver Rejected" id="driver_rejected"><?php echo e(trans('lang.driver_rejected')); ?>

                                                                </option>
                                                                <option value="Order Shipped" id="order_shipped"><?php echo e(trans('lang.order_shipped')); ?>

                                                                </option>
                                                                <option value="In Transit" id="in_transit"><?php echo e(trans('lang.in_transit')); ?>

                                                                </option>
                                                                <option value="Order Completed" id="order_completed"><?php echo e(trans('lang.order_completed')); ?>
                                                    ...
                                                    <div class="form-group row width-100 non-printable">
                                                        ...
                                                        <div class="col-7 text-right">
                                                            <button type="button" class="btn btn-primary save_order_btn show_popup edit-form-btn"><i class="fa fa-save "></i> <?php echo e(trans('lang.update')); ?>
                                    ...
                                    <div class="order_addre-edit col-lg-5 col-md-12 col-md-5">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-header-title"><?php echo e(trans('lang.billing_details')); ?></h4>
                                            </div>
                                            <div class="card-body">

                                                <div class="address order_detail-top-box">
                                                    <p><strong><?php echo e(trans('lang.name')); ?>

                                                            : </strong><span id="billing_name"></span></p>

                                                    <p id="billing_adrs"><strong><?php echo e(trans('lang.address')); ?>

                                                            : </strong><span id="billing_line1"></span> <span id="billing_line2"></span><span id="billing_country"></span></p>

                                                    <p><strong><?php echo e(trans('lang.email_address')); ?>:</strong>
                                        ...
                                        <div class="order_addre-edit mt-2 driver_details_hide">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-header-title"><?php echo e(trans('lang.driver_detail')); ?></h4>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <div class="address order_detail-top-box">
                                                        ...
                                                        <p><strong><?php echo e(trans('lang.car_name')); ?>:</strong>
                                                            <span id="driver_carName"></span>
                                                        </p>
                                                        <p><strong><?php echo e(trans('lang.car_number')); ?>:</strong>
                                        ...
                                        <div class="resturant-detail mt-4">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-header-title"><?php echo e(trans('lang.vendor')); ?></h4>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="contact-info"><?php echo e(trans('lang.contact_info')); ?>:</h5>

                                                    <p><strong><?php echo e(trans('lang.phone')); ?>:</strong>
                                                        <span id="vendor_phone"></span>
                                                    </p>
                                                    <p><strong><?php echo e(trans('lang.address')); ?>:</strong>
                                        ...
                                        <div class="order_detail-review mt-4">
                                            <div class="row">
                                                <div class="rental-review col-md-12">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h4 class="card-header-title"><?php echo e(trans('lang.customer_reviews')); ?></h4>
                                                        </div>
                                                        <div class="card-body">
        ...
        <div class="form-group col-12 text-center btm-btn non-printable">
            <button type="button" class="btn btn-primary save_order_btn d-none"><i class="fa fa-save"></i> <?php echo e(trans('lang.save')); ?>

            </button>

            <?php if (isset($_GET['eid']) && $_GET['eid'] != '') { ?>
            <a href="<?php echo e(route('vendors.orders', $_GET['eid'])); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
            <?php } elseif ($oid != '') { ?>
            <a href="<?php echo route('orderReview'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
            <?php } else { ?>
            <a href="<?php echo route('orders'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="orderTrakingModalLabel"><?php echo e(trans('lang.please_provide_details')); ?></h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="courierCompanyName" class="col-form-label"><?php echo e(trans('lang.courier_company_name')); ?></label>
                            <input type="text" class="form-control" id="courierCompanyName">
                        </div>
                        <div class="form-group">
                            <label for="courierTrackingId" class="col-form-label"><?php echo e(trans('lang.courier_tracking_id')); ?></label>
                            <input type="text" class="form-control" id="courierTrackingId">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="save_btn"><?php echo e(trans('lang.save')); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered location_modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title locationModalTitle"><?php echo e(trans('lang.add_preparation_time')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    ...
                    <form class="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row width-100">
                                    <label class="col-12 control-label"><?php echo e(trans('lang.time')); ?></label>
                                    <div class="col-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="add-prepare-time-btn"><?php echo e(trans('submit')); ?></a>
                        </button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal" aria-label="Close"><?php echo e(trans('close')); ?></a>
                        </button>
    ...
    <div class="modal fade" id="assignDriverModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title locationModalTitle"><?php echo e(trans('lang.assign_order')); ?></h5>
                ...
                <div class="modal-body">
                    <form class="">
                        <div class="form-row">
                            <div class="form-group row">
                                <div class="form-group row width-100">
                                    <div class="col-12">
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#addDeliverymanModal" class="add-deliveryman btn btn-success"><i class="fa fa-plus"></i><?php echo e(trans('lang.add_delivery_man')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="form-group row width-100" id="driver_list_div">
                                    <div class="col-12">
                                        <div class="select2-container-full">
                                            <label><?php echo e(trans('lang.select_deliveryman')); ?></label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="order-assign-btn"><?php echo e(trans('lang.assign')); ?></button>
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"><?php echo e(trans('lang.close')); ?></button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="addDeliverymanModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title locationModalTitle"><?php echo e(trans('lang.deliveryman_details')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                            ...
                            <div class="form-group form-material">
                                ...
                                <div class="col-12">
                                    <div class="phone-box position-relative" id="phone-box">
                                        ...
                                        <input class="form-control user_phone" placeholder="Phone" id="phone" type="phone" name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone" autofocus>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="add-deliveryman-btn"><?php echo e(trans('submit')); ?></a>
                        </button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal" aria-label="Close"><?php echo e(trans('close')); ?></a>
                        </button>
                    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document.body).on('click', '#save_btn', function() {
                ...
                if (courierCompanyName == '') {
                    alert('<?php echo e(trans('lang.courier_company_name_error')); ?>');
                    return false;
                }
                if (courierTrackingId == '') {
                    alert('<?php echo e(trans('lang.courier_tracking_id_error')); ?>');
                    return false;
                }
            ...
            ref.get().then(async function(snapshots) {
                ...
                if (order.author && order.author.hasOwnProperty('countryCode')) {

                    $("#billing_country").text(order.author.countryCode);
                ...
                if (order.payment_method) {
                    ...
                    if (order.payment_method == "stripe") {
                        ...
                        image = '<?php echo e(asset('images/payment/xendit.png')); ?>';
                        payment_method = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" width="30%" height="30%">';

                    } else if (order.payment_method == "midtrans") {
                        image = '<?php echo e(asset('images/payment/midtrans.png')); ?>';
                        payment_method = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'"  width="30%" height="30%">';

                    } else if (order.payment_method == "orangepay") {
                        image = '<?php echo e(asset('images/payment/orangepay.png')); ?>';
                        payment_method = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'"  width="30%" height="30%">';

                    } else if (order.payment_method == "cod") {
                        image = '<?php echo e(asset('images/payment/cashondelivery.png')); ?>';
                        payment_method = '<img alt="image" src="' + image + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" width="30%" height="30%">';
                ...
                if (order.hasOwnProperty('takeAway') && order.takeAway) {
                    ...
                    $('#order_shipped').hide();
                    $('#in_transit').hide();
                    $('#order_type').text('<?php echo e(trans('lang.order_takeaway')); ?>');
                    $('.payment_method').hide();
                    orderTakeAwayOption = true;
                } else {
                    $('#order_type').text('<?php echo e(trans('lang.order_delivery')); ?>');
                    $('.payment_method').show();
                }
                ...
                if ((order.driver != '' && order.driver != undefined) && (order.takeAway == false)) {
                    var route_view = '<?php echo e(route('drivers.view', ':id')); ?>';
                ...
                deliveryChargeVal = parseFloat(order.deliveryCharge || 0);
                ...
                if (order.vendorID) {
                    ...
                    await vendor.get().then(async function(snapshotsnew) {
                        if (snapshotsnew.docs.length > 0) {
                            ...
                            if (vendordata.id) {
                                var route_view = '<?php echo e(route('stores.view', ':id')); ?>';
                            ...
                            $('.vendor-title').html("<?php echo e(trans('lang.unknown')); ?>");
                        }
                    });
                ...
                if (order.hasOwnProperty('scheduleTime') && order.scheduleTime != null && order.scheduleTime != '') {
                    ...
                    $('.schedule_date').append('<label class="col-12 control-label"><strong><?php echo e(trans('lang.schedule_date_time')); ?>:</strong><span id=""> ' + scheduleDateTime + '</span></label>')
                ...
                if (order.hasOwnProperty('estimatedTimeToPrepare') && order.estimatedTimeToPrepare != null && order.estimatedTimeToPrepare != '') {
                    ...
                    $('.prepare_time').append('<label class="col-12 control-label "><strong><?php echo e(trans('lang.prepare_time')); ?>:</strong><span id=""> ' + time + '</span></label>')
                ...
                if (isSelfDeliveryByVendor && isSelfDeliveryGlobally && order.status == 'Order Placed' && !order.takeAway) {
                    ...
                    var newOption = $('<option>', {
                        ...
                        text: "<?php echo e(trans('lang.assign_delivery_man')); ?>"
                    });
            ...
            $('#order-assign-btn').click(function() {
                ...
                if (deliveryman == '' || deliveryman == null) {
                    $('#select_deliveryman').html('<?php echo e(trans('lang.select_deliveryman')); ?>');
                    return false;
                }
            ...
            $('#add-prepare-time-btn').click(async function() {
                ...
                if (preparationTime == '') {
                    $('#add_prepare_time_error').text('<?php echo e(trans('lang.add_prepare_time_error')); ?>');
                    return false;
                }
                ...
                if (old_order_status != orderStatus) {
                    ...
                    if (orderStatus == "Order Accepted" || orderStatus == "In Transit") {
                        if (parseInt(subscriptionTotalOrders) == 0) {
                            alert('<?php echo e(trans('lang.can_not_accept_more_orders_for_store')); ?>');
                            return false;
                        }
                        ref.get().then(async function(snapshot) {
                            ...
                            if (order.hasOwnProperty('scheduleTime') && order.scheduleTime != null && order.scheduleTime != '') {
                                ...
                                if (now >= windowStart && now <= windowEnd) {
                                    ...
                                    alert("<?php echo e(trans('lang.you_can_accept_order_between')); ?>" + startDate + ' - ' + endDate); // too early
                                    return false;
                                } else {
                                    alert("<?php echo e(trans('lang.you_can_accept_order_between')); ?>" + startDate + ' - ' + endDate); // too late
                                    return false;
                                }
                                        ...
                                        await driver.get().then(async function(snapshotsdriver) {
                                            ...
                                            if (driverdata) {
                                                ...
                                                if (!isNaN(driverWallet)) {
                                                    ...
                                                    var driverTxId = database.collection('temp').doc().id;
                                                    database.collection('wallet').doc(driverTxId).set({
                                                        'amount':          parseFloat(driverAmount),
                                                        'date':            firebase.firestore.FieldValue.serverTimestamp(),
                                                        'id':              driverTxId,
                                                        'isTopUp':         true,
                                                        'note':            'Delivery amount credited',
                                                        'order_id':        oid,
                                                        'payment_method':  'Wallet',
                                                        'payment_status':  'success',
                                                    ...
                                                    database.collection('users').where("id", "==", orderCustomerId).get().then(async function(userSnapshots) {
                                                        if (userSnapshots.docs.length > 0) {
                                                            ...
                                                            database.collection('users').doc(orderCustomerId).update({
                                                                ...
                                                                <?php if (isset($_GET['eid']) && $_GET['eid'] != '') { ?>
                                                                window.location.href = "<?php echo e(route('vendors.orders', $_GET['eid'])); ?>";
                                                                <?php } else { ?>
                                                                window.location.href = '<?php echo e(route('orders')); ?>';
                                                                <?php } ?>
        ...
        function buildHTMLProductsList(snapshotsProducts) {
            ...
            if (!snapshotsProducts || !snapshotsProducts.length) return html;
            ...
            snapshotsProducts.forEach((product) => {
                ...
                if (extra_count > 1 || product.size) {
                    html = html + '<strong><?php echo e(trans('lang.extras')); ?> :</strong>';
                }
                if (extra_count > 1) {
                    html = html + '<div class="extra"><span><?php echo e(trans('lang.extras')); ?> :</span><span class="ext-item">' + extra_html + '</span></div>';
                }
                if (product.size) {
                    html = html + '<div class="type"><span><?php echo e(trans('lang.type')); ?> :</span><span class="ext-size">' + product.size + '</span></div>';
                }
        ...
        function buildHTMLProductstotal(snapshotsProducts) {
            ...
            html = html + '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.sub_total')); ?></span></td></tr>';
            html = html +
                '<tr class="final-rate"><td class="label"><?php echo e(trans('lang.sub_total')); ?></td><td class="sub_total" style="color:green">(' +
                formatCurrency(order_subtotal, currencyData) + ')</td></tr>';

            html = html +
                '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.discount')); ?></span></td></tr>';
            couponCode_html = '';
            if (couponCode) {
                couponCode_html = '</br><small><?php echo e(trans('lang.coupon_codes')); ?> :' + couponCode + '</small>';
            }
            html = html + '<tr><td class="label"><?php echo e(trans('lang.discount')); ?>' + couponCode_html +
            ...
            if (specialDiscount != undefined) {
                ...
                html = html + '<tr><td class="label"><?php echo e(trans('lang.special_offer')); ?> <?php echo e(trans('lang.discount')); ?>' +
            ...
            if (takeAway == '' || takeAway == false) {
                html = html +
                    '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.delivery_charge')); ?></span></td></tr>';
                 html = html +
                        '<tr><td class="label"><?php echo e(trans('lang.delivery_charge')); ?></td><td class="deliveryCharge " id="greenColor">+' +
                        formatCurrency(deliveryCharge, currencyData) + '</td></tr>';
                        
                html = html + '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.tip')); ?></span></td></tr>';
                html = html +'<tr><td class="label"><?php echo e(trans('lang.tip_amount')); ?></td><td class="tip_amount_val " id="greenColor">+' +
                        formatCurrency(tip_amount, currencyData) + '</td></tr>';
            }
            if(packagingChargeEnable) {
                html = html + '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.packaging_charge')); ?></span></td></tr>';
                html = html +'<tr><td class="label"><?php echo e(trans('lang.packaging_charge')); ?></td><td class="packaging_charge " id="greenColor">+' +
                        formatCurrency(packagingCharge, currencyData) + '</td></tr>';
            }

            html = html + '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.platform_charge')); ?></span></td></tr>';
            html = html +'<tr><td class="label"><?php echo e(trans('lang.platform_charge')); ?></td><td class="platform_charge " id="greenColor">+' +
                    formatCurrency(platformFee, currencyData) + '</td></tr>';

            html = html + '<tr><td class="seprater" colspan="2"><hr><span><?php echo e(trans('lang.tax_calculation')); ?></span></td></tr>';
            ...
            html = html +'<tr><td class="label"><strong><?php echo e(trans('lang.total_tax')); ?></strong></td><td class="total_tax " id="greenColor"><strong>+' +
            formatCurrency(total_tax_amount, currencyData) + '</strong></td></tr>';
            
            html += '<tr><td class="seprater" colspan="2"><hr></td></tr>';
            
            html = html +
                '<tr class="grand-total"><td class="label"><?php echo e(trans('lang.total_amount')); ?></td><td class="total_price_val " id="greenColor">' +
            ...
            html = html + '<tr><td class="label"><small><?php echo e(trans('lang.admin_commission')); ?> ' + adminCommHtml +
                '</small> </td><td style="color:red"><small>( ' + adminCommission_val + ' )</small></td></tr>';
            if (notes) {
                html = html + '<tr><td class="label"><?php echo e(trans('lang.notes')); ?></td><td class="adminCommission_val">' +
                    notes + '</td></tr>';
            }
        ...
        function getUserReview(vendorOrder, reviewAttr) {
            ...
            refUserReview.limit(page_size).get().then(async function(userreviewsnapshot) {
                ...
                if (userreviewsnapshot.docs.length > 0) {
                    ...
                    jQuery("#customers_rating_and_review").html('<h4><?php echo e(trans('lang.no_reviews_found')); ?></h4>');
                }
            });
        }
                ...
                vendorOrder.products.forEach((productval) => {
                    if (productval.id == val.productId) {
                        ...
                        if (val.hasOwnProperty('reviewAttributes') && val.reviewAttributes != null) {
                            ...
                            var label_feature = "<?php echo e(trans('lang.byfeature')); ?>";
        ...
        $('#add-deliveryman-btn').on('click', function() {
            ...
            if (userFirstName == '') {
                $("#firstname_err").append("<?php echo e(trans('lang.user_first_name_help')); ?>");
            } else if (email == '') {
                $("#email_err").append("<?php echo e(trans('lang.user_email_help')); ?>");
            } else if (password == '') {
                $("#password_err").append("<?php echo e(trans('lang.user_password_help')); ?>");
            } else if (userPhone == '') {
                $("#mobilenumber_err").append("<?php echo e(trans('lang.user_phone_help')); ?>");
            } else if (zoneId == '') {
                $("#zone_err").append("<?php echo e(trans('lang.select_zone_help')); ?>");
            } else {
        ...
        async function getRefund(orderStatus) {
            ...
            ref.get().then(async function(snapshot) {
                ...
                try {
                    ...
                    if (vendorBaseAmount && (orderStatus == "Order Cancelled" || orderStatus == "Order Rejected")) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/orders/edit.blade.php ENDPATH**/ ?>