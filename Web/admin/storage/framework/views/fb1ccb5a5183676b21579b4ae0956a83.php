    ...
    <div class="card">
        ...
        <div class="payment-top-tab mt-3 mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    <a class="nav-link stripe_active_label" href="<?php echo url('settings/payment/stripe'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_stripe')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link cod_active_label" href="<?php echo url('settings/payment/cod'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_cod_short')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link razorpay_active_label" href="<?php echo url('settings/payment/razorpay'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_razorpay')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link paypal_active_label" href="<?php echo url('settings/payment/paypal'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_paypal')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link wallet_active_label" href="<?php echo url('settings/payment/wallet'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_wallet')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link payfast_active_label" href="<?php echo url('settings/payment/payfast'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.payfast')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link paystack_active_label" href="<?php echo url('settings/payment/paystack'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.app_setting_paystack_lable')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link mercadopago_active_label" href="<?php echo url('settings/payment/mercadopago'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link xendit_active_label" href="<?php echo url('settings/payment/xendit'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link midTrans_active_label" href="<?php echo url('settings/payment/midtrans'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link flutterWave_active_label"
                       href="<?php echo url('settings/payment/flutterwave'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                        <?php echo e(trans('lang.flutterWave')); ?>
                ...
                <li class="nav-item">
                    <a class="nav-link orangePay_active_label"
                       href="<?php echo url('settings/payment/orangepay'); ?>">
                        <i class="fa fa-envelope-o mr-2"></i>
                ...
                <li class="nav-item">
                   <a class="nav-link active paydunya_active_label"
                       href="<?php echo url('settings/payment/paydunya'); ?>">
                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                <?php echo e(trans('lang.app_setting_enable_payment')); ?>
                        ...
                        <div class="form-check width-100">
                            ...
                            <label class="col-3 control-label"
                                ...
                                <?php echo e(trans('lang.app_setting_enable_sandbox_mode')); ?>
                    ...
                    <fieldset>
                        ...
                        <legend>
                            ...
                            <?php echo e(trans('lang.withdraw_setting')); ?>
        ...
        database.collection('settings')
            ...
            .then(function () {
                ...
                window.location.href =
                    '<?php echo e(url("settings/payment/paydunya")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/settings/app/paydunya.blade.php ENDPATH**/ ?>