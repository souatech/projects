...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.create_deliveryman')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo route('deliveryman'); ?>"><?php echo e(trans('lang.deliveryman')); ?></a>
                </li>
                <li class="breadcrumb-item active"><?php echo e(trans('lang.create_deliveryman')); ?></li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
                ...
                <div class="resttab-sec">
                    ...
                    <div class="row vendor_payout_create">
                        <div class="vendor_payout_create-inner">
                            <fieldset>
                                <legend><?php echo e(trans('lang.basic_details')); ?></legend>
                                ...
                                if ($id == '') { ?>
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label"><?php echo e(trans('lang.store')); ?></label>
                                        <div class="col-7">
                                            <select class="form-control store" id="store">
                                                <option value="" disabled selected><?php echo e(trans('lang.select_vendor')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="form-group row">
                                    <label class="col-3 control-label"><?php echo e(trans('lang.profile_pic')); ?></label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row">
                                    <div class="form-group row width-50">
                                        <div class="form-check width-100">
                                            ...
                                            <label class="col-3 control-label" for="is_active"><?php echo e(trans('lang.active')); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
        ...
        <div class="form-group col-12 text-center btm-btn">
            <button type="button" class="btn btn-primary  save_from_btn"><i class="fa fa-save"></i> <?php echo e(trans('lang.save')); ?></button>
            <?php if ($id != '') { ?>
                <a href="<?php echo route('deliveryman',$id); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>

            <?php } else { ?>
                <a href="<?php echo route('deliveryman'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
            <?php } ?>
...
<script>
    ...
    $(".save_from_btn").click(async function() {
        ...
        if (userFirstName == '') {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.user_first_name_help')); ?></p>");
            window.scrollTo(0, 0);
        } else if (email == '') {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.user_email_help')); ?></p>");
            window.scrollTo(0, 0);
        } else if (password == '') {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.user_password_help')); ?></p>");
            window.scrollTo(0, 0);
        } else if (userPhone == '') {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.user_phone_help')); ?></p>");
            window.scrollTo(0, 0);
        } else if (jQuery("#country_selector").val() == '' || jQuery("#country_selector").val() == null) {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.select_country_code')); ?></p>");
            window.scrollTo(0, 0);
        } else {
                ...
                firebase.auth().createUserWithEmailAndPassword(email, password)
                    .then(async function(firebaseUser) {
                        ...
                        database.collection('users').doc(user_id).set({
                            ...
                            if (vendorId) {
                                window.location.href = "<?php echo e(route('restaurants.deliveryman', '')); ?>/" + "<?php echo e($id); ?>";
                            } else {
                                window.location.href = '<?php echo e(route('deliveryman')); ?>';
                            }
                        });
                    }).catch(err => {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/deliveryman/create.blade.php ENDPATH**/ ?>