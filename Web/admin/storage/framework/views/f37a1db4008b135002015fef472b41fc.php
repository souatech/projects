            ...
            <div class="col-md-5 align-self-center">
                <div class="d-flex top-title-section justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        <span class="icon mr-3"><img src="<?php echo e(asset('images/order.png')); ?>"></span>
                        <h3 class="mb-0"><?php echo e(trans('lang.order_plural')); ?> <span class="orderTitle"></span></h3>
                            ...
                            <div class="d-flex top-title-right align-self-center">
                                ...
                                <div class="select-box pl-3">
                                    <select class="form-control order_type_selector">
                                        <option value="" selected><?php echo e(trans('lang.order_type')); ?></option>
                                        <option value="takeaway"><?php echo e(trans('lang.order_takeaway')); ?></option>
                                        <option value="delivery"><?php echo e(trans('lang.delivery')); ?></option>
                                    </select>
                                </div>
                                <div class="select-box pl-3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="menu-tab">
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('drivers.view', $_GET['driverId'])); ?>"><i class="ri-list-indefinite"></i><?php echo e(trans('lang.tab_basic')); ?></a>
                                </li>
                                <li class="vehicle_tab" style="display:none">
                                    <a href="<?php echo e(route('drivers.vehicle', $_GET['driverId'])); ?>"><i class="ri-car-line"></i><?php echo e(trans('lang.vehicle')); ?></a>
                                </li>
                                <li class="active">
                                    <a href="<?php echo e(route('orders', 'driverId=' . $_GET['driverId'])); ?>"><i class="ri-shopping-bag-line"></i> <?php echo e(trans('lang.order_plural')); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('driver.payouts', $_GET['driverId'])); ?>"><i class="ri-bank-card-line"></i><?php echo e(trans('lang.tab_payouts')); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('payoutRequests.drivers.view', $_GET['driverId'])); ?>" class="vendor_payout"><i class="ri-refund-line"></i><?php echo e(trans('lang.tab_payout_request')); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('users.walletstransaction', $_GET['driverId'])); ?>" class="wallet_transaction"><i class="ri-wallet-line"></i><?php echo e(trans('lang.wallet_transaction')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <?php } ?>
                        ...
                        <div class="menu-tab">
                            <ul>
                                <li><a href="<?php echo e(route('users.view', $_GET['userId'])); ?>"><i class="ri-list-indefinite"></i><?php echo e(trans('lang.tab_basic')); ?></a>
                                </li>
                                <li class="active"><a href="<?php echo e(route('orders', 'userId=' . $_GET['userId'])); ?>"><i class="ri-shopping-bag-line"></i><?php echo e(trans('lang.tab_orders')); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('users.walletstransaction', $_GET['userId'])); ?>"><i class="ri-wallet-line"></i><?php echo e(trans('lang.wallet_transaction')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <?php } ?>
                        <div class="menu-tab vendorMenuTab d-none">
                            <ul>
                                ...
                                <li>
                                    <a class="wallet_transaction_vendor"><i class="ri-wallet-line"></i><?php echo e(trans('lang.wallet_transaction')); ?></a>
                                </li>
                                            ...
                                            <div class="col-md-3">
                                                <div class="card card-box-with-icon bg--1">
                                                    <div class="card-body d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span class="box-icon ab"><img src="<?php echo e(asset('images/total_orders.png')); ?>"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.order_table')); ?></h3>
                                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.order_table_text')); ?></p>
                                </div>
                                    ...
                                    <table id="orderTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if($service_type == 'ecommerce-service'): ?>        
                                                    <?php if(isset($_GET['userId'])): ?>
                                                    <?php elseif(isset($_GET['driverId'])): ?>
                                                        <th><?php echo e(trans('lang.order_user_id')); ?></th>
                                                    <?php else: ?>
                                                        <th><?php echo e(trans('lang.order_user_id')); ?></th>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                ...
                                                <th><?php echo e(trans('lang.vendors_payout_amount')); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(trans('lang.assign_driver')); ?></h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="currentOrderId">
                    <div class="mb-3">
                        <label for="driver-select" class="form-label"><?php echo e(trans('lang.select_driver')); ?></label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="assign-driver-btn"><?php echo e(trans('lang.assign')); ?></button>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(trans('lang.canceled')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        var userID = "<?php echo e(request()->get('userId', '')); ?>";
        var driverID = "<?php echo e(request()->get('driverId', '')); ?>";
        ...
        $('.order_type_selector').select2({
            placeholder: '<?php echo e(trans('lang.order_type')); ?>',
            minimumResultsForSearch: Infinity,
            allowClear: true
        });
        $('.allModules').select2({
            placeholder: "<?php echo e(trans('lang.select')); ?> <?php echo e(trans('lang.section_plural')); ?>",
            minimumResultsForSearch: Infinity,
            allowClear: true
        });
            ...
            ref.get().then(async function(snapshots) {
                ...
                if (vendorID != '') {
                    columns = [
                        {
                            key: 'id',
                            header: "<?php echo e(trans('lang.order_id')); ?>"
                        },
                        {
                            key: 'driverName',
                            header: "<?php echo e(trans('lang.driver_plural')); ?>"
                        },
                        {
                            key: 'clientName',
                            header: "<?php echo e(trans('lang.order_user_id')); ?>"
                        },
                        {
                            key: 'createdAt',
                        ...
                        {
                            key: 'amount',
                            header: "<?php echo e(trans('lang.vendors_payout_amount')); ?>"
                        },
                        {
                            key: 'orderType',
                            header: "<?php echo e(trans('lang.order_type')); ?>"
                        },
                        {
                            key: 'status',
                            header: "<?php echo e(trans('lang.order_order_status_id')); ?>"
                        },
                    ];
                } else if (driverID) {
                    columns = [
                ...
                var fieldConfig = {
                    ...
                    fileName: "<?php echo e(trans('lang.order_table')); ?>",
                };
                        ...
                        ref.get().then(async function(querySnapshot) {
                            ...
                            querySnapshot.docs.map(async doc => {
                                ...
                                if (childData.hasOwnProperty('takeAway') && childData.takeAway) {
                                    childData.orderType = "<?php echo e(trans('lang.order_takeaway')); ?>"
                                } else {
                                    childData.orderType = "<?php echo e(trans('lang.order_delivery')); ?>";
                                }
                                var price = 0;
        ...
        async function buildHTML(val) {
            ...
            var route1 = '<?php echo e(route('orders.edit', ':id')); ?>';
            route1 = route1.replace(':id', id);
            var printRoute = '<?php echo e(route('vendors.orderprint', ':id')); ?>';
            printRoute = printRoute.replace(':id', id);
            
            if (val.vendorID != '') {
                route1 = route1 + '?eid=<?php echo e($id); ?>';
                printRoute = printRoute + '?eid=<?php echo e($id); ?>';
            }

            var route_view = '<?php echo e(route('stores.view', ':id')); ?>';
            route_view = route_view.replace(':id', val.vendorID);
            var customer_view = '<?php echo e(route('users.view', ':id')); ?>';
            ...
            if(service_type == "ecommerce-service"){
                ...
                if (userID) {
                    ...
                    if (val.hasOwnProperty("driver") && val.driver != null) {
                        ...
                        var diverRoute = '<?php echo e(route('drivers.view', ':id')); ?>';
            ...
            if (val.hasOwnProperty('takeAway') && val.takeAway) {
                html.push('<td><?php echo e(trans('lang.order_takeaway')); ?></td>');
            } else {
                html.push('<td><?php echo e(trans('lang.order_delivery')); ?></td>');
            }
            ...
            var actionHtml = '';
            actionHtml = actionHtml + '<span class="action-btn"><?php if (in_array('orders.print', json_decode(@session('user_permissions'),true))) { ?><a href="' + printRoute + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.print')); ?>"><i class="mdi mdi-printer" style="font-size:20px;"></i></a><?php } ?><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.edit')); ?>"><i class="mdi mdi-lead-pencil"></i></a> ';
            if (val.status === "Order Accepted" || val.status === "Driver Rejected") {
                actionHtml += '<a id="' + val.id + '" class="order-assign-btn" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.assign_driver')); ?>" name="order-assign" href="javascript:void(0)"><i class="mdi mdi-truck-delivery"></i></a>';
            }
            if (checkDeletePermission) {
                actionHtml = actionHtml + '<a id="' + val.id + '" class="delete-btn" data-toggle="tooltip" data-bs-original-title="<?php echo e(trans('lang.delete')); ?>" name="order-delete" href="javascript:void(0)" ><i class="mdi mdi-delete"></i></a>';
            }
        ...
        $("#deleteAll").click(function() {
            ...
            if (!confirm("<?php echo e(trans('lang.selected_delete_alert')); ?>")) return;
            const orderIds = [];
        ...
        $(document).on("click", ".order-assign-btn", async function(e) {
            ...
            if(eligibleDrivers.length > 0){
                ...
                dropdown.append(`<option value=""><?php echo e(trans('lang.select_driver')); ?></option>`);
        ...
        $(document).on("click", "#assign-driver-btn", async function() {
            ...
            if(!driverId){
                Swal.fire({
                    icon: 'error',
                    title: '<?php echo e(trans('lang.select_driver')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/orders/index.blade.php ENDPATH**/ ?>