...
<div class="page-wrapper">
        ...
        <div class="card  pb-4">
            <div class="card-body">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    <button type="button" class="btn btn-primary save-form-btn"><i class="fa fa-save"></i> <?php echo e(trans('lang.save')); ?></button>
                    <a href="<?php echo e(route('drivers.document', $driverId)); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var requestUrl = "<?php echo e(request()->is('drivers/document-list/*')); ?>";
        var back_photo = '';
        var front_photo = '';
        var backFileName = '';
        var frontFileName = '';
    ...
    var placeholderImage = '';
        ...
        function handleFrontFileSelect(evt) {
            ...
            if (validExtensions.indexOf(fileExtension) === -1) {
                alert("<?php echo e(trans('lang.invalid_file_extension')); ?>");
                return;
            }
                        ...
                        database.collection('documents_verify').doc(id).set({
                            ...
                            await driverRef.get().then(async function (snapshotsvendor) {
                                if (snapshotsvendor.docs.length > 0) {
                                    ...
                                    if (verification) {
                                        jQuery("#data-table_processing").hide();
                                        window.location.href = document_list_view;
                                    }
                                } else {
                                    jQuery("#data-table_processing").hide();
                                    window.location.href = document_list_view;
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/admin/resources/views/drivers/document_upload.blade.php ENDPATH**/ ?>