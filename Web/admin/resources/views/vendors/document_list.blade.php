        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('vendors') !!}">{{trans('lang.vendor_list')}}</a></li>
            ...
            if (docSnapshot.docs.length) {
                ...
                documents.forEach((ele) => {
                    ...
                    docRefs.get().then(async function (docrefSnapshot) {
                        ...
                        var ownerDocumentUploadUrl = "{{ route('vendors.document.upload', ['ownerId' => ':ownerId', 'id' => ':id']) }}";
                         ownerDocumentUploadUrl = ownerDocumentUploadUrl.replace(':ownerId', id.trim()).replace(':id', doc.id.trim());

                        trhtml += '<a href="' + ownerDocumentUploadUrl + '" data-id="' + doc.id + '"><i class="mdi mdi-lead-pencil" title="{{trans('lang.edit')}}"></i></a>&nbsp;';
                        if (status !== 'pending') {
                            if (status == "rejected") {
