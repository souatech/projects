...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('vendors') !!}">{{trans('lang.vendor_list')}}</a>
                </li>
        ...
        <div class="card  pb-4">
            <div class="card-body">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{{ route('vendors.document', $ownerId) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a> </div>
            </div>
        </div>
    </div>
    @endsection
    ...
    <script>
        ...
        async function getDocId() {
            var enableDocIds = [];
            await database.collection('documents').where('type', '==', 'vendor').where('enable', "==", true).get().then(async function (snapshots) {
