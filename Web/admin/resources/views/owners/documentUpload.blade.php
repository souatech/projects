...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('owners') !!}">{{trans('lang.owners_list')}}</a>
                </li>
        ...
        <div class="card  pb-4">
            <div class="card-body">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{{ route('owners.document', $ownerId) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var requestUrl = "{{request()->is('owners/document-list/*')}}";
        var back_photo = '';
        var front_photo = '';
        var backFileName = '';
        var frontFileName = '';
