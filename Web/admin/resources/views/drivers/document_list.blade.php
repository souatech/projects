            ...
            if (docSnapshot.docs.length) {
                ...
                documents.forEach((ele) => {
                    ...
                    docRefs.get().then(async function (docrefSnapshot) {
                        ...
                        var driverDocumentUploadUrl = "{{ route('drivers.document.upload', ['driverId' => ':driverId', 'id' => ':id']) }}";
                                    ...
                                    if (fcmToken && fcmToken != '') {
                                        $.ajax({
                                            ...
                                            data: {
                                                _token: "{{ csrf_token() }}",
                                                fcm: fcmToken,
                                                title:  '{{trans('lang.rejected_your_document')}}',
                                                message: '{{trans('lang.admin_rejected_document')}}' + docTitle + ' . {{trans('lang.please_submit_again')}}',
                                            },
                                    ...
                                    if (fcmToken && fcmToken != '') {
                                        $.ajax({
                                            ...
                                            data: {
                                                _token: "{{ csrf_token() }}",
                                                fcm: fcmToken,
                                                title:  '{{trans('lang.approved_your_document')}}',
                                                message: '{{trans('lang.admin_approved_document')}}' + docTitle,
                                            },
                                            success: function (response) {
