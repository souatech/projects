...
<div class="page-wrapper">
	<div class="row page-titles">
		...
		<div class="form-group col-12 text-center btm-btn">
			...
			<a href="{!! route('rentalvehicleType') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{
				trans('lang.cancel')}}</a>
		</div>
</div>
@endsection
		...
		if (name == '') {
			...
			storeImageData().then(IMG => {
				database.collection('rental_vehicle_type').doc(id).set({
					...
					'description': description, 'supported_vehicle': supported_vehicle, 'rental_vehicle_icon': IMG, 'isActive': active,
