...
@section('scripts')
    ...
    <script>
        ...
        $(".edit-form-btn").click(function() {
            ...
            database.collection('parcel_coupons').where('id', '!=', id).where('code', '==', code).get().then(
            async function(snapshot) {
                    ...
                    if (code == '') {
                        ...
                        storeImageData().then(IMG => {
                            database.collection('parcel_coupons').doc(id).update({
                                'code': code,
        ...
        function handleFileSelect(evt) {
            ...
            reader.onload = (function(theFile) {
                ...
                return function(e) {
                    ...
                    $(".coupon_image").empty();
                    $(".coupon_image").append('<img class="rounded" style="width:50px" src="' + photo +
                        '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" alt="image">');
                };
            })(f);
