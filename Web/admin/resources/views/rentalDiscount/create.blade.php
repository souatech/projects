    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".save-form-btn").click(function() {
                ...
                database.collection('rental_coupons').where('code', '==', code).get().then(async function(
                    snapshot) {
                    ...
                    if (code == '') {
                        ...
                        storeImageData().then(IMG => {
                            ...
                            database.collection('rental_coupons').doc(id).set({
                                'code': code,
        ...
        function handleFileSelect(evt) {
            ...
            reader.onload = (function(theFile) {
                ...
                return function(e) {
                    ...
                    $(".rentaldiscount_image").html('<img class="rounded" style="50px" src="' + photo +
                        '" alt="image">');
                };
            })(f);
