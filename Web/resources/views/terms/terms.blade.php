                                        ...
                                        <a href="#" class="dropdown-toggle text-dark py-3 d-block"
                                           ...
                                           aria-expanded="false">
                                            <img alt="#" src="img/user/1.jpg"
                                                 class="img-fluid rounded-circle header-user mr-2 header-user"> {{trans('lang.hi_osahan')}}
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right"
                                             aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                               href="profile.html">{{trans('lang.my_account')}} </a>
                                            <a class="dropdown-item"
                ...
                <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                    ...
                    <div class="bg-white profile-details">
                        ...
                        <a href="{{url('contact_us')}}" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
                            <div class="left mr-3">
                                <h6 class="font-weight-bold m-0 text-dark"><i
                                            class="feather-phone bg-primary text-white p-2 rounded-circle mr-2"></i> {{trans('lang.contact')}}
                                </h6>
                            </div>
                            <div class="right ml-auto">
                                <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                        ...
                        <a href="{{ route('terms') }}" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
                            <div class="left mr-3">
                                <h6 class="font-weight-bold m-0 text-dark"><i
                                            class="feather-info bg-success text-white p-2 rounded-circle mr-2"></i> {{trans('lang.terms_use')}}
                                </h6>
                            </div>
                            <div class="right ml-auto">
                                <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                        ...
                        <a href="{{ route('privacy') }}" class="d-flex w-100 align-items-center px-3 py-4">
                            <div class="left mr-3">
                                <h6 class="font-weight-bold m-0 text-dark"><i
                                            class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i> {{trans('lang.privacy_policy')}}
                                </h6>
                            </div>
                            <div class="right ml-auto">
                                <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
            ...
            <div class="row pt-3">
                ...
                <aside class="col-sm-3 col-md-2 text-white">
                    ...
                    <ul class="list-unstyled hov_footer">
                        ...
                        <li><a href="{{ route('privacy') }}" class="text-muted">{{trans('lang.privacy_policy')}} </a>
                        </li>
                    </ul>
                </aside>
                <aside class="col-sm-3  col-md-2 text-white">
                    ...
                    <ul class="list-unstyled hov_footer">
                        ...
                        <li><a href="forgot_password.html" class="text-muted">{{trans('lang.forgot_password')}} </a>
                        </li>
