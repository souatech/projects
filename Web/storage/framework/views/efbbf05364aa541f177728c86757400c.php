                        ...
                        <div class="review-inner">
                            ...
                            <div class="see_all_review_div" style="display:none">
                                <button class="btn btn-primary btn-block btn-sm see_all_reviews">
                                    <?php echo e(trans('lang.see_all_reviews')); ?>

                                </button>
                            </div>
                            <p class="no_review_fount font-weight-bold"
                               style="display:none"><?php echo e(trans('lang.no_review_found')); ?></p>
                        </div>
                    </div>
                    <div class="col-md-4 store-info">
                        <div class="shipping-detail card p-4 mb-4">
                            <div class="shipping-details-bottom-border pb-3">
                                <img class="mr-2" src="<?php echo e(url('img/Payment.png')); ?>" alt="">
                                <span><?php echo e(trans('lang.safe_payment')); ?></span>
                            </div>
                            <div class="shipping-details-bottom-border pb-3">
                                <img class="mr-2" src="<?php echo e(url('img/money.png')); ?>" alt="">
                                <span><?php echo e(trans('lang.return_policy')); ?></span>
                            </div>
                            <div class="shipping-details-bottom-border">
                                <img class="mr-2" src="<?php echo e(url('img/Genuine.png')); ?>" alt="">
                                <span><?php echo e(trans('lang.authentic_products')); ?></span>
                            </div>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <br>
                                                <span><?php echo e(trans('lang.seller_info')); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-6 ">
                                                <div class="d-flex justify-content-center align-items-center review-box">
                                                    <div class="text-center">
                                                        ...
                                                        <br>
                                                        <span> <?php echo e(trans('lang.reviews')); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="d-flex justify-content-center align-items-center review-box">
                                                    <div class="text-center">
                                                        ...
                                                        <br>
                                                        <span> <?php echo e(trans('lang.products')); ?> </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="visit-store">
                                            <a class="store_url btn btn-primary" href="#">
                                                ...
                                                <span> <?php echo e(trans('lang.visit_store')); ?></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="more-from-store">
                            <div class="card p-4 mb-4">
                                <div class="more-fromd-flex justify-content-center">
                                    <h3> <?php echo e(trans('lang.more_from_store')); ?></h3>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(async function () {
        ...
        $(document).on("click", '.add-to-cart', async function (event) {
            ...
            if (quantity == 0) {
                Swal.fire({text: "<?php echo e(trans('lang.invalid_qty')); ?>", icon: "error"});
                return false;
            }
            ...
            if ($('#variation_info_' + id).length > 0) {
                ...
                if (quantity > variant_qty && variant_qty != -1) {
                    Swal.fire({text: "<?php echo e(trans('lang.invalid_stock_qty')); ?>", icon: "error"});
                    return false;
                }
                ...
                if (stock_quantity != undefined && stock_quantity != -1 && parseInt(quantity) > parseInt(
                        stock_quantity)) {
                    Swal.fire({
                        text: "<?php echo e(trans('lang.invalid_stock_qty')); ?>",
                        icon: "error"
                    });
                    return false;
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ($elem.hasClass('booknow')) {
                        ...
                        Swal.fire({text: "<?php echo e(trans('lang.added_tocart')); ?>", icon: "success"});
                    }
                }
            });
        });
                ...
                if (couponSnapshots.docs && couponSnapshots.docs.length) {
                    ...
                    if (coupondata.vendorID != undefined && coupondata.vendorID != '') {
                        if (coupondata.vendorID == vendor_id) {
                            ...
                            Swal.fire({text: "<?php echo e(trans('lang.coupon_not_valid')); ?>", icon: "error"});
                            $("#coupon_code").val('');
                        }
                    } else {
                        discount = coupondata.discount;
    ...
    async function buildVendorProductsHTML(snapshots) {
        ...
        if (snapshots.docs.length > 0) {
          ...
          await Promise.all(snapshots.docs.map(async (listval) => {
            ...
            html = html + "<p class='font-weight-bold'><?php echo e(trans('lang.no_items')); ?></p>";
        }
        return html;
    }
    ...
    function getUsersReviews(vendorProduct, limit) {
        ...
        if (vendorProduct.product_specification != null && vendorProduct.product_specification != "" && !$.isEmptyObject(vendorProduct.product_specification)) {
            ...
            var label_specification = "<?php echo e(trans('lang.specification')); ?>";
    ...
    function buildRatingsAndReviewsHTML(vendorProduct, reviewsSnapshots) {
        var reviewhtml = '<h3><?php echo e(trans("lang.customer_reviews")); ?></h3>';
        var rating = 0;
        var reviewsCount = 0;
        if (vendorProduct.hasOwnProperty('reviewsSum') && vendorProduct.reviewsSum != 0 && vendorProduct.hasOwnProperty('reviewsCount') && vendorProduct.reviewsCount != 0) {
            ...
            if (reviewsCount == 1) {
                reviewhtml = reviewhtml + '<span class="count">' + reviewsCount + ' <?php echo e(trans("lang.review")); ?></span>';
            } else {
                reviewhtml = reviewhtml + '<span class="count">' + reviewsCount + ' <?php echo e(trans("lang.reviews")); ?></span>';
            }
    ...
    $(document).on("click", "a[name='loginAlert']", function (e) {
        Swal.fire({text: "<?php echo e(trans('lang.login_to_add_favorite')); ?>", icon: "error"});
    });
    ...
    async function buildHTML(snapshots) {
        ...
        if (vendorProduct != undefined) {
            ...
            html = html + '<span class="badge badge-success">' + rating + ' <i class="feather-star"></i></span>';
            if (reviewsCount == 1) {
                html = html + '<span class="count">' + reviewsCount + ' <?php echo e(trans("lang.review")); ?></span>';
            } else {
                html = html + '<span class="count">' + reviewsCount + ' <?php echo e(trans("lang.reviews")); ?></span>';
            }
            <?php if (Auth::check()){ ?>
            ...
            if (vendorProduct.item_attribute != null && vendorProduct.item_attribute != "" && vendorProduct.item_attribute.attributes.length > 0 && vendorProduct.item_attribute.variants.length > 0) {
                ...
                if (vendorProduct.hasOwnProperty('quantity')) {
                    if (vendorProduct.quantity == -1) {
                        html = html + '<span id="variant_qty"><?php echo e(trans("lang.qty_left")); ?>: <?php echo e(trans("lang.unlimited")); ?></span>';
                    } else {
                        html = html + '<span id="variant_qty"><?php echo e(trans("lang.qty_left")); ?>: ' + vendorProduct.quantity + '</span>';
                    }
                }
            }
            html = html + '</div>';
            ...
            if (vendorProduct.brandID) {
                ...
                html = html + '<h3><?php echo e(trans("lang.brand")); ?> <span class="brand_name"></span></h3>';
                html = html + '</div>';
                database.collection('brands').doc(vendorProduct.brandID).get().then((result) => {
                    var brand_name = result.exists ? result.data().title : '';
                    if (brand_name) {
                        var view_brand_products = "<?php echo e(route('productlist',[':type',':id'])); ?>";
            ...
            html = html + '<h3><?php echo e(trans("lang.store")); ?> | <span class="vendor_name" id="vendor_name_loading">' + 
            ...
            if (isProductDetails) {
                ...
                html = html + '<h3><?php echo e(trans('lang.grams')); ?> : <span class="gram quantity-count">' + vendorProduct
                    .grams + '</span></h3>';
                html = html + '</div>';
                html = html + '<div class="col-6 calories mt-1 mb-1">';
                html = html + '<h3><?php echo e(trans('lang.calories')); ?> : <span class="calories quantity-count">' +
                    vendorProduct.calories + '</span></h3>';
                html = html + '</div></div>';
                html = html + '<div class="row quantity-row"><div class="col-6 proteins mt-1 mb-1">';
                html = html + '<h3><?php echo e(trans('lang.proteins')); ?> : <span class="proteins quantity-count">' +
                    vendorProduct.proteins + '</span></h3>';
                html = html + '</div>';
                html = html + '<div class="col-6 fats mt-1 mb-1">';
                html = html + '<h3><?php echo e(trans('lang.fats')); ?> : <span class="fats quantity-count">' + vendorProduct
                    .fats + '</span></h3>';
                html = html + '</div></div>';
            }
            if (vendorProduct.item_attribute != null && vendorProduct.item_attribute != "" && vendorProduct.item_attribute.attributes.length > 0 && vendorProduct.item_attribute.variants.length > 0) {
            ...
            if (vendorProduct.hasOwnProperty('addOnsPrice') && vendorProduct.addOnsPrice.length > 0) {
                ...
                html += '<h3 class="font-weight-bold"><?php echo e(trans('lang.addons')); ?></h3>';
            ...
            var label_qty = "<?php echo e(trans('lang.quantity')); ?>";
            ...
            html += "<button data-id='" + String(vendorProduct.id) + "' type='button' class='add-to-cart btn btn-primary btn-lg btn-block' ><?php echo e(trans('lang.add_to_cart')); ?></button>";
            ...
            html += "<button data-id='" + String(vendorProduct.id) + "' type='button' class='add-to-cart btn btn-primary btn-lg btn-block booknow' ><?php echo e(trans('lang.book_now')); ?></button>";
            html = html + '<div class="description mt-2 mb-3">';
            html = html + '</div>';
            html = html + '</div>';
            html = html + '<div class="not-available mt-5" style="display:none"><p class="text-center font-weight-bold h5"><?php echo e(trans("lang.currently_not_available")); ?></p></div>';
            return html;
        }
    }
    ...
    async function getRelatedProducts(vendorProduct) {
        try {
            ...
            if (vendorIds.length === 0) {
                ...
                $('#related_products').html('<h3><?php echo e(trans("lang.related_products")); ?></h3><div class="row"><p class="text-muted">' + message + '</p></div>');
                return;
            }
            ...
            $('#related_products').html('<h3><?php echo e(trans("lang.related_products")); ?></h3><div class="row"><p class="text-muted">Error loading related products.</p></div>');
        }
    }
    ...
    async function buildRelatedProductsHTML(products) {
        ...
        html += '<h3><?php echo e(trans("lang.related_products")); ?>';        
        html += '</h3>';
        html += '<div class="row">';
        ...
        if (variation_sku) {
            ...
            if (variant_info.length > 0) {
                ...
                if (variant_quantity == '-1') {
                    $('#variation_info_' + vendorProduct.id).find('#variant_qty').html('<?php echo e(trans("lang.qty_left")); ?>: <?php echo e(trans("lang.unlimited")); ?>');
                } else {
                    $('#variation_info_' + vendorProduct.id).find('#variant_qty').html('<?php echo e(trans("lang.qty_left")); ?>: ' + variant_quantity);
                }
            }
        }
    }
...
<?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/products/detail.blade.php ENDPATH**/ ?>