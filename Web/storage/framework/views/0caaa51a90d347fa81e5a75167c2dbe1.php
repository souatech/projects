                    ...
                    <div class="card">
                        <div class="parcel_payment-detail">
                            <div class="sender-det">
                                <h3><strong><?php echo e(trans('lang.sender')); ?></strong>
                            ...
                            <div class="receiver-det">
                                <h3>
                                    <strong><?php echo e(trans('lang.receiver')); ?></strong>
                        ...
                        <div class="parcel_payment_total">
                            <div class="row">
                                <div class="col-md-4 parcel_payment-box">
                                    <span class="label"><?php echo e(trans('lang.distance')); ?></span>
                                    <span class="total">
                                    ...
                                    <input type="hidden" id="parcelDistanceValue" value="<?php echo e(@$parcel_cart['parcelDeliveryKM']); ?>">
                                </div>
                                <div class="col-md-4 parcel_payment-box">
                                    <span class="label"><?php echo e(trans('lang.weight')); ?></span>
                                    <span class="total">
                                ...
                                <div class="col-md-4 parcel_payment-box">
                                    <span class="label"><?php echo e(trans('lang.rate')); ?></span>
                                    <span class="total price">
                                         <?php echo e(formatCurrency($parcel_cart['parcelDeliveryCharge'], $parcel_cart['currencyData'])); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="search-box">
                            <div class="search-box-inner">
                                ...
                                <a href="#" id="apply-coupon-code"><?php echo e(trans('lang.apply')); ?></a>
                            </div>
                        </div>
                        <div class="parcel_payment-way">
                            ...
                            <div class="payment-total d-flex">
                                <label><?php echo e(trans('lang.parcel_weight')); ?></label>
                                <span class="price ml-auto">
                                    <?php echo e(formatCurrency($parcel_cart['parcelDeliveryCharge'] - $gpFee, $parcel_cart['currencyData'])); ?>

                                </span>
                            </div>
                            <div class="payment-total d-flex">
                                <label><?php echo e(trans('lang.parcel_gp_collect_fee')); ?></label>
                                <span class="price ml-auto">
                                    <?php echo e(formatCurrency($gpFee, $parcel_cart['currencyData'])); ?>

                                </span>
                            </div>
                            <?php endif; ?>
                            <div class="payment-total d-flex">
                                <label><strong><?php echo e(trans('lang.sub_total')); ?></strong></label>
                                <span class="price ml-auto">
                                    <?php echo e(formatCurrency($parcel_cart['parcelDeliveryCharge'], $parcel_cart['currencyData'])); ?>
                            ...
                            <div class="payment-total d-flex">
                                ...
                                ?>
                                <label><?php echo e(trans('lang.discount')); ?>

                                    <?php echo $couponHtml; ?>
                                </label>
                                <span class="price ml-auto text-danger">
                                    <?php if(@$parcel_cart['coupon']['discount_amount'] && @$parcel_cart['coupon']['discountType']): ?>
                                        (-<?php echo e(formatCurrency($parcel_cart['coupon']['discount_amount'], $parcel_cart['currencyData'])); ?>)
                                    <?php else: ?>
                                        (-<?php echo e(formatCurrency(0, $parcel_cart['currencyData'])); ?>)
                                    <?php endif; ?>
                                </span>
                            </div>

                            <?php if(isset($parcel_cart['coupon']) && !empty($parcel_cart['coupon']['coupon_code'])): ?>
                                <div class="remove-coupon text-right">
                                    <small><a href="javascript:void(0)" class="text-primary"><?php echo e(trans('lang.remove_discount')); ?></a></small>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="payment-total d-flex">
                                ...
                                <span class="price ml-auto">
                                    <?php echo e(formatCurrency($parcel_cart['platformCharge'], $parcel_cart['currencyData'])); ?>                                                                        
                                </span>
                            </div>
                            ...
                            <?php if(!empty($parcel_cart['taxBreakdownGrouped'])): ?>
                                
                                <?php if($parcel_cart['taxScope'] === 'order'): ?>
                                    <div class="payment-total d-flex">
                                        <label><?php echo e(trans('lang.tax_on_order_total')); ?> </label>
                                        <span class="price ml-auto">
                                            <?php echo e(formatCurrency(array_sum($parcel_cart['taxBreakdownGrouped']['order']), $parcel_cart['currencyData'])); ?>                                                          
                                        </span>
                                    </div>
                                <?php endif; ?>

                                
                                <?php $__currentLoopData = $parcel_cart['taxBreakdownGrouped']['platform'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="payment-total d-flex">
                                        <label><?php echo e(trans('lang.tax_on_platform_fee')); ?> </label>
                                        <span class="price ml-auto">
                                            <?php echo e(formatCurrency($amount, $parcel_cart['currencyData'])); ?>
                                ...
                                <div class="payment-total d-flex">
                                    ...
                                    <span class="price ml-auto">
                                        <?php echo e(formatCurrency($parcel_cart['tax_total_amount'], $parcel_cart['currencyData'])); ?>
                            ...
                            <div class="payment-total d-flex">
                                ...
                                <span class="price ml-auto">
                                    <?php echo e(formatCurrency($parcel_cart['total_pay'], $parcel_cart['currencyData'])); ?>
                        ...
                        <div class="pay-btn">
                            <a href="Javascript:void(0)" id="pay_parcel" onclick="payCheckoutParcel()"><?php echo e(trans('lang.pay')); ?> 
                                <?php echo e(formatCurrency($parcel_cart['total_pay'], $parcel_cart['currencyData'])); ?>
...
<script type="text/javascript">
    ...
    var cart = <?php echo json_encode($parcel_cart, 15, 512) ?>;
    ...
    userDetailsRef.get().then(async function (userSnapshots) {
        ...
        $("#payment_method option[value='wallet']").text("<?php echo e(trans('lang.wallet')); ?> (" + WalletTxt + ")");
        loadcurrency();
    });
    ...
    async function getCouponDetails() {
        ...
        let menuHtmlx = couponRef.get().then(async function (couponRefSnapshots) {
            couponHtml += '<div class="coupon-code"><label><?php echo e(trans("lang.select_available_coupon")); ?></label><span></span></div>';
    ...
    $(document).on("click", '#apply-coupon-code', function (event) {
        ...
        couponCodeRef.get().then(async function (couponSnapshots) {
            if (couponSnapshots.docs && couponSnapshots.docs.length) {
                ...
                Swal.fire({text: "<?php echo e(trans('lang.coupon_code_not_valid')); ?>", icon: "error"});
    ...
    function payCheckoutParcel() {
        ...
        userDetailsRef.get().then(async function (userSnapshots) {
            ...
            if (payment_method == "" && payment_by == "sender") {
                Swal.fire({text: "<?php echo e(trans('lang.Select_Payment')); ?>", icon: "error"});
                return false;
            }
            ...
            $.ajax({
                ...
                if (!['IDR', 'PHP', 'USD', 'VND', 'THB', 'MYR', 'SGD'].includes(currencyData.code)) {
                    Swal.fire({text: "<?php echo e(trans('lang.currency_restriction')); ?>", icon: "error"});
                    return false;
                }
                ...
                if (payment_method == "wallet") {
                    ...
                    if (parseFloat(wallet_amount) < parseFloat(total_pay)) {
                        $("#overlay").hide();
                        Swal.fire({text: "<?php echo e(trans('lang.dont_have_sufficient_balance')); ?>", icon: "error"});
                        return false;
                    }
                } else {
                    payment_method = "cod";
                            ...
                            if (payment_method == "wallet") {
                                ...
                                database.collection('users').doc(authorID).update({'wallet_amount': wallet_amount}).then(function (result) {
                                    ...
                                    database.collection('wallet').doc(walletId).set({
                                        ...
                                        window.location.href = "<?php echo e(route('parcel_success')); ?>";
                                    })
                                });
                            } else {
                                try { await sendMailToParcel(id_order, authorID); } catch (e) {}
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/parcel/parcel_checkout.blade.php ENDPATH**/ ?>