...
<div class="siddhi-home-page">
        ...
        <div class="row align-items-center">
            ...
            <div class="text-white col-md-3 col-sm-3">
                <div class="title d-flex align-items-center">
                    <a class="text-white font-weight-bold ml-auto" data-toggle="modal" data-target="#exampleModal" href="#"><?php echo e(trans('lang.filter')); ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ecommerce-content multi-vendore-content section-content">
        ...
        <section class="top-categories">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.top_categories')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('categorylist')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
            ...
            <div class="container">
                <div class="highlights-section-inner">
                    <div class="title d-flex align-items-center border-0 mb-0">
                        <h5><?php echo e(trans('lang.highlights_for_you')); ?></h5>
                    </div>
                    <div class="row">
        ...
        <section class="most-popular-item-section">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.popular')); ?> <?php echo e(trans('lang.item')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('productlist.all')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
        ...
        <section class="most-popular-store-section">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.popular')); ?> <?php echo e(trans('lang.stores')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('vendors', 'popular=yes')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
        ...
        <section class="new-arrivals-section">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.new_arrivals')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('vendors')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
        ...
        <section class="vendor-offer-section">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.offers')); ?> <?php echo e(trans('lang.for_you')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('offers')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
                <div style="display:none" class="coupon_code_copied_div mt-4 bg-success text-white text-center">
                    <span><?php echo e(trans('lang.coupon_code_copied')); ?></span>
                </div>
        ...
        <section class="all-stores-section">
            <div class="container">
                <div class="title d-flex align-items-center">
                    <h5><?php echo e(trans('lang.all_stores')); ?></h5>
                    <span class="see-all ml-auto">
                        <a href="<?php echo e(route('vendors')); ?>"><?php echo e(trans('lang.see_all')); ?></a>
                    </span>
                </div>
                ...
                <div class="row fu-loadmore-btn">
                    <a class="page-link loadmore-btn" href="javascript:void(0);" onclick="moreload()" data-dt-idx="0" tabindex="0" id="loadmore"><?php echo e(trans('lang.see')); ?> <?php echo e(trans('lang.more')); ?></a>
    ...
    <div class="zone-error m-5 p-5" style="display: none;">
        <div class="zone-image text-center">
            <img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" src="<?php echo e(asset('img/zone_logo.png')); ?>" width="100">
        </div>
        <div class="zone-content text-center text-center font-weight-bold text-danger">
            <h3 class="title"><?php echo e(trans('lang.zone_error_title')); ?></h3>
            <h6 class="text"><?php echo e(trans('lang.zone_error_text')); ?></h6>
        </div>
    </div>
    <?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/dist/zuck.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/dist/skins/snapssenger.css')); ?>">
    <script src="<?php echo e(asset('js/dist/zuck.min.js')); ?>"></script>
    <script src="https://unpkg.com/geofirestore@5.2.0/dist/geofirestore.js"></script>
    <script src="https://cdn.firebase.com/libs/geofire/5.0.1/geofire.min.js"></script>
    <script type="text/javascript" src="<?php echo e(asset('vendor/swiper/swiper.min.js')); ?>"></script>
    <script type="text/javascript">
        ...
        home_cat_ref.get().then(async function(homeCategories) {
            ...
            for (listval of alldata) {
                ...
                let category_route = "<?php echo e(route('vendor', ':id')); ?>"
                ...
                if (haveStores == true) {
                    ...
                    if (productHtml != '') {
                        ...
                        homeCategorieshtml += '<span class="see-all ml-auto"><a href="' + category_route +
                            '"><?php echo trans('lang.see_all'); ?></a></span>';
        ...
        async function getAllStore() {     
            ...
            nearestRestauantRefnew.get().then(async function(snapshots) {
                if (snapshots.docs.length > 0) {
                    ...
                    jQuery(".zone-error").show();
                    jQuery(".zone-error").find('.title').text('<?php echo e(trans('lang.store_error_title')); ?>');
                    jQuery(".zone-error").find('.text').text('<?php echo e(trans('lang.store_error_text')); ?>');
                }
            });
        }
        ...
        async function buildHTMLItemCategory(foodCategories) {
            ...
            alldata.forEach((listval) => {
                var val = listval;
                var category_id = val.id;
                var trending_route = "<?php echo e(route('vendorsbycategory', [':id'])); ?>";
    ...
    async function buildHTMLHomeCategoryProducts(category_id) {
        ...
        if (alldata.length > 0) {
            ...
            alldata.forEach((listval) => {
                ...
                var status = val.isOpen ? "<?php echo e(trans('lang.open')); ?>" : "<?php echo e(trans('lang.closed')); ?>";
        ...
        function buildHTMLCouponList(couponListSnapshot) {
            ...
            if (alldata.length > 0) {
                ...
                alldata.forEach((listval) => {
                    ...
                    if (vendor_id_single) {
                        view_vendor_details = "<?php echo e(route('vendor', ':id')); ?>";
                        view_vendor_details = view_vendor_details.replace(':id', vendor_id_single);
                    }
                    html = html + '<div class="col-md-3 pro-list"><div class="list-card position-relative"><div class="list-card-image">';
                    if (val.image) {
        ...
        async function getStories() {
            ...
            for (data of alldata) {
                ...
                if (vendorData != undefined) {
                    ...
                    var vendorLink = "<?php echo e(route('vendor', ':id')); ?>";
            ...
            await database.collection('advertisements')
                ...
                .then(async function(snapshots) {
                    ...
                    for (const data of filteredAds) {
                        const view_vendor_details = `<?php echo e(route('vendor', ':id')); ?>`.replace(':id', data.vendorId);
                    ...
                    if (snapshots.exists) {
                        ...
                        if (data.hasOwnProperty('isSelfDelivery') && data.isSelfDelivery != null && data.isSelfDelivery != '') {
                            if (data.isSelfDelivery && isSelfDeliveryGlobally) {
                                $('.free-delivery-' + vendorId).html('<span><img src="<?php echo e(asset('img/free_delivery.png')); ?>" width="100px"> <?php echo e(trans('lang.free_delivery')); ?></span> ');
                            }
                        }
                    }
                })
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/home_page/multivendor_home.blade.php ENDPATH**/ ?>