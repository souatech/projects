                        ...
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                               ...
                               aria-selected="true"><img
                                        src="<?php echo e(asset('img/asap_unselected.png')); ?>"><?php echo e(trans('lang.as_soon_as_possible')); ?>
                            ...
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#schedule"
                               role="tab" aria-controls="schedule" aria-selected="false"><img
                                        src="<?php echo e(asset('img/schedule_unselected.png')); ?>"> <?php echo e(trans('lang.schedule')); ?></a>
                        </div>
                    </nav> 
                        ...
                        <div class="tab-pane fade show active" id="as-soon-as-possible" role="tabpanel"
                            ...
                            <div class="tab-inner">
                                <div class="tab-title sende-title">
                                    <h3><span>1</span><?php echo e(trans('lang.sender_info')); ?></h3>
                                </div>
                                <div class="row">
                                    <div class="inputField col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button type="button" class="btn btn-outline-secondary gps-btn" title="<?php echo e(trans('lang.use_my_location')); ?>">
                                    ...
                                    <div class="inputField col-md-6">
                                        ...
                                        <span for="exampleFormControlInput2"><?php echo e(trans('lang.sender_name')); ?></span>
                                    </div>
                                    ...
                                    <div class="inputField col-md-6 phone-box">
                                        <div class="col-xs-12">
                                            ...
                                            <span for="exampleFormControlInput3"><?php echo e(trans('lang.phone_number')); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inputField col-md-6">
                                        ...
                                        <select class="form-control senderParcelWeight"
                                            ...
                                            <option value=""><?php echo e(trans('lang.select')); ?> <?php echo e(trans('lang.parcel_weight')); ?></option>
                                        </select>
                                    </div>
                                    <div class="inputField col-md-6">
                                        <input type="text" class="form-control senderNote" 
                                               placeholder=" ">
                                        <span for="exampleFormControlTextarea1"><?php echo e(trans('lang.note')); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-inner">
                                <div class="tab-title sende-title">
                                    <h3><span>2</span> <?php echo e(trans('lang.receiver_info')); ?></h3>
                                </div>
                                <div class="row">
                                    <div class="inputField col-md-6">
                                        <input type="text" class="form-control receiverAddress" value=""
                                               id="receiver_address" name="address" required="" placeholder=" ">
                                        <span for="exampleFormControlInput1"><?php echo e(trans('lang.receiver_address')); ?></span>
                                    </div>
                                    <div class="inputField col-md-6">
                            ...
                            <div class="tab-inner">
                                <div class="tab-title sende-title">
                                    <h3><span>3</span> <?php echo e(trans('lang.upload_parcel_image')); ?></h3>
                                </div>
                                <div class="row">
                                    <div class="inputField col-md-6">
                            ...
                            <div class="tab-btn">
                                <button type="button"
                                        class="btn btn-primary parcel_btn"><?php echo e(trans('lang.continue')); ?></button>
                            </div>
                        </div>
                            ...
                            <div class="tab-inner">
                                ...
                                <div class="row">
                                    ...
                                    <div class="inputField col-md-6">
                                        ...
                                        <span for="exampleFormControlTextarea1"><?php echo e(trans('lang.when_pickup_address')); ?></span>
                                    </div>
                                    <div class="inputField col-md-6">
                                        <input type="text" class="form-control senderNote" 
                                               placeholder=" ">
...
<script type="text/javascript">
    ...
    parcelcatref.get().then(async function (snapshots) {
        ...
        if (rawType === 'parcel_delivery' || titleLower.includes('express')) {
            ...
            $('.receiverAddress').closest('.inputField').hide().after(
                ...
                '<p class="mb-1 font-weight-bold">📍 <?php echo e(trans("lang.destination")); ?></p>' +
                '<p class="mb-1 font-weight-bold">Paris 75018, France 🇫🇷</p>' +
                '<small class="text-muted"><?php echo e(trans("lang.parcel_gp_fixed_destination")); ?></small>' +
                '</div></div>'
            );
            // Info message under weight dropdown
            $('.senderParcelWeight').after(
                '<small class="text-muted d-block mt-1">' +
                "<?php echo trans('lang.parcel_gp_price_estimate'); ?>" +
                '</small>'
            );
        }
    });
    ...
    $(document).on('click', '.parcel_btn', async function () {
        ...
        getSenderAddress(async function (response) {
            getReceiverAddress(async function (response) {
                ...
                if (!sender_zone_id) {
                    $(".error_top").show().html("<p><?php echo e(trans('lang.sender_zone_error')); ?></p>");
                    window.scrollTo(0, 0);
                    return false;
                }
                ...
                if (!receiver_zone_id) {
                    if (parcelServiceType !== 'colis_gp') {
                        $(".error_top").show().html("<p><?php echo e(trans('lang.receiver_zone_error')); ?></p>");
                        window.scrollTo(0, 0);
                        return false;
                    }
                ...
                if (senderAddress.trim() === receiverAddress.trim()) {
                    $(".error_top").show().html("<p><?php echo e(trans('lang.parcel_same_address_error')); ?></p>");
                    window.scrollTo(0, 0);
                    return false;
                }
                ...
                if (senderAddress == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.sender_address_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (senderName == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.sender_name_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (senderPhone == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.sender_phone_error')); ?></p>");
                    window.scrollTo(0, 0);
                }else if (!/^\d+$/.test(senderPhone)) {
                    $(".error_top").show().html("<p><?php echo e(trans('lang.phone_contains_numbers_only')); ?></p>");
                    window.scrollTo(0, 0);
                }else if (parcelServiceType !== 'parcel_delivery' && senderParcelWeight == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.sender_parcel_weight_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (activeTabId == "#schedule" && senderPickupDateTime == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.when_pickup_address_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (receiverAddress == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.receiver_address_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (receiverName == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.receiver_name_error')); ?></p>");
                    window.scrollTo(0, 0);
                } else if (receiverPhone == "") {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.receiver_phone_error')); ?></p>");
                    window.scrollTo(0, 0);
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            var url = "<?php echo e(route('parcel_checkout')); ?>";
    ...
    $(document).on('click', '.gps-btn', function() {
        ...
        if (!navigator.geolocation) {
            Swal.fire({text: "<?php echo e(trans('lang.geolocation_is_not_supported_by_this_browser')); ?>", icon: 'warning'});
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            $btn.prop('disabled', false);
            var msg = "<?php echo e(trans('lang.an_unknown_error_occurred')); ?>";
            if (error.code === 1) { msg = "<?php echo e(trans('lang.user_denied_the_request_for_geolocation')); ?>"; }
            else if (error.code === 2) { msg = "<?php echo e(trans('lang.location_information_is_unavailable')); ?>"; }
            else if (error.code === 3) { msg = "<?php echo e(trans('lang.the_request_to_get_user_location_timed_out')); ?>"; }
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/parcel/parcel.blade.php ENDPATH**/ ?>