...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('img/fav.png')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/slick/slick-lightbox.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/select2/dist/css/select2.min.css')); ?>"/>
    ...
    <link href="<?php echo e(asset('vendor/bootstrap/css/bootstrap-rtl.min.css')); ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style type="text/css">
        ...
        .header-main .takeaway-div input[type="checkbox"]::before, .rest-basic-detail .feather_icon .fu-status a.rest-right-btn > span.open, .header-main .takeaway-div input[type="checkbox"]:checked::before {
            background-color: <?php echo $_COOKIE['section_color']; ?> ;
        }
        ...
        .checkout-left-box.siddhi-cart-item::after, .checkout-left-box.accordion::after, .dropdown-item.active, .dropdown-item:active {
            background: <?php echo $_COOKIE['section_color']; ?>;
        }
        ...
        .sidebar-item-list .product-item .media-body p span.sku, .car-det-head .car-det-price span.price, .rentalcar-list .car-price span {
            color: <?php echo $_COOKIE['section_color']; ?>;
        }

        .carrent-book a, .rental-left-box .nav-pills .nav-link.active {
            background: <?php echo $_COOKIE['section_color']; ?>;
        }
        ...
        .parcelImageUploadDiv:after, .parcel_payment-way ul li label::before {
            background: <?php echo $_COOKIE['section_color']; ?>;
        }

        .parcel_delivery_content #tabs .nav-tabs .nav-item.show .nav-link, .parcel_delivery_content #tabs .nav-tabs .nav-item.active, .tab-title h3 span, .tab-btn button.btn.btn-primary, .appendParcelImages #parcelPhotos .image-item span.remove-btn {
            background: <?php echo $_COOKIE['section_color']; ?>;
        }

        .tab-title h3, .parcel_payment-detail > div.sender-det > h3 strong, .parcel_payment_total .parcel_payment-box span.total.price {
            color: <?php echo $_COOKIE['section_color']; ?>;
        }
        ...
        .parcel_payment_right .search-box-inner a, .pay-btn a, .parcel_payment_left .coupon_detail .copupon-list ul li a.active, .parcel_payment_left .coupon_detail .copupon-list ul li a:hover {
            background: <?php echo $_COOKIE['section_color']; ?>;
            border-color: <?php echo $_COOKIE['section_color']; ?>;
        }

        .sction-title h2::before, .product-detail-page .addons-option .custom-control .custom-control-input:checked ~ .custom-control-label::before {
            background: <?php echo $_COOKIE['section_color']; ?>;
        }
        ...
        .order-summery .payment-total.total-price span.price, .brand span a:hover, .store span a:hover, .vandor-sidebar .vandorcat-list li a:hover, .vandor-sidebar .vandorcat-list li.active a {
            color: <?php echo $_COOKIE['section_color']; ?>;
        }
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>