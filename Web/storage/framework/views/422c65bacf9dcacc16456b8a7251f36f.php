                                        ...
                                        <div class="col-md-6">
                                            <div class="text-center pb-3">
                                                <h1 class="font-weight-bold"><?php if (@$authorName) {
                                                    ...
                                                    } ?> <?php echo e(trans('lang.your_parcel_place_successfully')); ?></h1>
                                                
                                            </div>
                                            <div class="bg-white rounded text-center p-4 shadow-sm">
                                                <h1 class="display-1 mb-4"><?php echo e(trans('lang.emoji')); ?></h1>
                                               
                                                <a href="<?php echo e(route('parcel_orders')); ?>?activeTab=progress"
...
<?php endif; ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/parcel/success.blade.php ENDPATH**/ ?>