                                        ...
                                        <div class="col-md-6">
                                            <div class="text-center pb-3">
                                                <h1 class="font-weight-bold"><?php if (@$authorName) {
                                                    ...
                                                    } ?> <?php echo e(trans('lang.your_order_has_been_successful')); ?></h1>
                                                <p>Check your order status in <a href="<?php echo e(route('my_order')); ?>"
                                                                                 class="font-weight-bold text-decoration-none text-primary"><?php echo e(trans('lang.my_orders')); ?></a>
                                                    <?php echo e(trans('lang.about_next_steps_information')); ?></p>
                                            </div>
                                            <div class="bg-white rounded text-center p-4 shadow-sm">
                                                <h1 class="display-1 mb-4"><?php echo e(trans('lang.emoji')); ?></h1>
                                                <h6 class="font-weight-bold mb-2">
                                                    <?php echo e(trans('lang.preparing_your_order')); ?></h6>
                                                <p class="small text-muted"><?php echo e(trans('lang.your_order_will_prepared')); ?></p>
                                                <a href="<?php echo e(route('my_order')); ?>?activeTab=progress"
                                                   class="btn rounded btn-primary btn-lg btn-block"><?php echo e(trans('lang.view_order')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<div id="data-table_processing_order" class="dataTables_processing panel panel-default" style="display: none;">
    <?php echo e(trans('lang.processing_success')); ?>
...
<?php endif; ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/checkout/success.blade.php ENDPATH**/ ?>