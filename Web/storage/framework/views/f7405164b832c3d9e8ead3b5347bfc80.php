...
<div class="d-none">
    <div class="bg-primary border-bottom p-3 d-flex align-items-center">
        ...
        <h4 class="font-weight-bold m-0 text-white"><?php echo e(trans('lang.my_orders')); ?></h4>
    </div>
</div>
                ...
                <ul class="nav nav-tabsa custom-tabsa border-0 bg-white rounded overflow-hidden shadow-sm p-2 c-t-order" id="myTab" role="tablist">
                    ...
                    <li class="nav-item border-top" role="presentation">
                        <a class="nav-link border-0 text-dark py-3" id="rejected-tab" data-toggle="tab" href="#rejected" role="tab" aria-controls="rejected" aria-selected="false">
                            <i class="feather-slash mr-2 text-danger mb-0"></i> <?php echo e(trans('lang.rejected')); ?></a>
                    </li>
                </ul>
            </div>
...
<script type="text/javascript">
    ...
    async function buildHTMLCompletedOrders(completedorderSnapshots) {
        ...
        if (html == '') {
            html = html + "<p class='text-center font-weight-bold h5 mt-3'><?php echo e(trans('lang.no_results')); ?></p>";
        }
        jQuery("#overlay").hide();
        return html;
    }
    ...
    async function buildHTMLRejectedOrders(completedorderSnapshots) {
        ...
        if (completedorderSnapshots.docs.length > 0) {
            ...
            for (const listval of alldata) {
                var val = listval;
                var order_id = val.id;
                var view_details = "<?php echo e(route('rejected_order', ':id')); ?>";
                view_details = view_details.replace(':id', 'id=' + order_id);
                var view_contact = "<?php echo e(route('contact_us')); ?>";
                var view_checkout = "<?php echo e(route('checkout')); ?>";
                vendorActiveCheck(val.vendorID);
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/my_order/my_order.blade.php ENDPATH**/ ?>