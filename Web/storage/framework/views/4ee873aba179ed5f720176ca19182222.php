...
<div class="siddhi-popular mt-5">
    <div class="container">
        ...
        <div class="col-md-12 float-right ml-auto mt-3"><a href="javascript:void(0)" data-toggle="modal"
                        ...
                        class="fa fa-plus"></i> <?php echo e(trans('lang.add_new_address')); ?></a>
        </div>
        <div class="text-center py-5 not_found_div" style="display:none">
            ...
            <p class="font-weight-bold text-dark h5"><?php echo e(trans('lang.no_results')); ?></p>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5><?php echo e(trans('lang.delivery_address')); ?></h5>
                </div>
                    ...
                    <div class="form-row p-2">
                        <form class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <input placeholder="<?php echo e(trans('lang.flat')); ?>" value="" id="address" type="text"
                                       class="form-control">
                            </div>
                            <div class="col-md-12 form-group">
                                <div class="input-group">
                                    <input placeholder="<?php echo e(trans('lang.area')); ?>" type="text" id="locality"
                                           class="form-control">
                            ...
                            <div class="col-md-12 form-group">
                                <input placeholder="<?php echo e(trans('lang.landmark')); ?>" value="" id="landmark" type="text"
                                       class="form-control">
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="control-label"><?php echo e(trans('lang.save_as')); ?></label>
                                <div class="custom-control custom-radio border-bottom py-2">
                                    <input type="radio" name="save_as" id="homee" value="Home"
                                           class="custom-control-input" checked>
                                    <label class="custom-control-label" for="homee"><?php echo e(trans('lang.home')); ?></label>
                                </div>
                                <div class="custom-control custom-radio border-bottom py-2">
                                    <input type="radio" name="save_as" id="work" value="Work"
                                           class="custom-control-input">
                                    <label class="custom-control-label" for="work"><?php echo e(trans('lang.work')); ?></label>
                                </div>
                                <div class="custom-control custom-radio border-bottom py-2">
                                    <input type="radio" name="save_as" id="hotel" value="Hotel"
                                           class="custom-control-input">
                                    <label class="custom-control-label" for="hotel"><?php echo e(trans('lang.hotel')); ?></label>
                                </div>
                                <div class="custom-control custom-radio border-bottom py-2">
                                    <input type="radio" name="save_as" id="other" value="Other"
                                           class="custom-control-input">
                                    <label class="custom-control-label" for="other"><?php echo e(trans('lang.other')); ?></label>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer p-0 border-0">
                        <div class="col-6 m-0 p-0">
                            <button type="button" class="btn border-top btn-lg btn-block"
                                    data-dismiss="modal"><?php echo e(trans('lang.close')); ?>

                            </button>
                        </div>
                        <div class="col-6 m-0 p-0">
                            <button type="button" class="btn btn-primary btn-lg btn-block"
                                    onclick="saveShippingAddress()"><?php echo e(trans('lang.save')); ?>
...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        if (val.hasOwnProperty('shippingAddress') && Array.isArray(val.shippingAddress)) {
            ...
            shippingAddress.forEach((listval, index) => {
                ...
                html = html +  '<div class="d-flex mt-2"><div class="col-md-9"><a href="javascript:void(0)" class="btn btn-danger change-address " data-locality="'+listval.locality+'" data-id="'+listval.id+'" data-lat="'+data_lat+'" data-lng="'+data_lng+ '"><?php echo e(trans("lang.make_as_delivery_address")); ?></a></div><div class="col-md-6">'+defaultBtnHtml + '</div></div></div></div>';
    ...
    function saveShippingAddress() {
        ...
        if (address == '') {
            $('#address_err').text('<?php echo e(trans("lang.please_add_flat_no")); ?>')
            return false;
        } else if (locality == '') {
            $('#address_err').text('<?php echo e(trans("lang.please_add_locality")); ?>')
            return false;
        } else if ((Lat == undefined && Lng == undefined) || (Lat == '' && Lng == '') || (Lat == null && Lng == null)) {
            $('#address_err').text('<?php echo e(trans("lang.select_location_from_map_result")); ?>')
            return false;
        } else {
    ...
    $(document).on("click", "a.change-address", async function () {
        ...
        if (getCookie('service_type') == "On Demand Service") {
            window.location.href = "<?php echo e(route('ondemand-checkout')); ?>";
        } else {
...
</script><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/delivery_address/index.blade.php ENDPATH**/ ?>