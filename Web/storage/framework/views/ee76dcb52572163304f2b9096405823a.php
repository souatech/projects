    ...
    <div class="modal-dialog modal-dialog-centered location_modal">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title locationModalTitle"><?php echo e(trans('lang.delivery_address')); ?></h5>
            </div>
            <div class="modal-body">
                <form class="">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 form-group"><label class="form-label"><?php echo e(trans('lang.landmark')); ?></label><input placeholder="<?php echo e(trans('lang.footer')); ?>" value="" id="address_line2" type="text" class="form-control"></div>
                        <div class="col-md-12 form-group"><label class="form-label"><?php echo e(trans('lang.zip_code')); ?></label><input placeholder="<?php echo e(trans('lang.postalcode')); ?>" id="address_zipcode" type="text" class="form-control"></div>
                        <div class="col-md-12 form-group"><label class="form-label"><?php echo e(trans('lang.city')); ?></label><input placeholder="<?php echo e(trans('lang.city')); ?>" id="address_city" type="text" class="form-control"></div>
                        <div class="col-md-12 form-group"><label class="form-label"><?php echo e(trans('lang.country')); ?></label><input placeholder="<?php echo e(trans('lang.country')); ?>" id="address_country" type="text" class="form-control">
                        </div>
            ...
            <div class="modal-footer p-0 border-0">
                <div class="col-12 m-0 p-0">
                    ...
                    <button type="button" class="btn btn-primary btn-lg btn-block" onclick="saveShippingAddress()"><?php echo e(trans('lang.save_changes')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="order_notification_modal" data-toggle="modal" data-target="#order_notification"><?php echo e(trans('lang.large_modal')); ?></button>
</span>
    ...
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"><a href="<?php echo e(route('parcel_orders')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>
                </button>
                <?php } else if (@$_COOKIE['service_type'] == "Rental Service") { ?>
                <button type="button" class="btn btn-primary"><a href="<?php echo e(route('rental_orders')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>
                </button>
                <?php } else { ?>
                <button type="button" class="btn btn-primary"><a href="<?php echo e(route('my_order')); ?>" id="order_notification_url"><?php echo e(trans('lang.Go')); ?></a>
                </button>
                <?php } ?>
            </div>
        </div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="dinein_order_notification_modal" data-toggle="modal" data-target="#dinein_order_notification"><?php echo e(trans('lang.large_modal')); ?></button>
</span>
<div class="modal fade" id="dinein_order_notification" tabindex="-1" role="dialog" aria-labelledby="notification_accepted_order_by_vendor" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><a href="<?php echo e(url('my_dinein')); ?>" id="dinein_order_notification_url"><?php echo e(trans('lang.go')); ?></a>
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="select_store_model" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5><?php echo e(trans('lang.select_sections')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<footer class="section-footer border-top bg-dark">
    ...
    <div class="select-sec-btn">
        <a href="#" data-toggle="modal" id="select_store_model_call" data-target="#select_store_model"><?php echo e(trans('lang.select_section')); ?></a>
    </div>
    <div class="jox-footer-legal text-center py-3" style="border-top:1px solid rgba(255,255,255,0.08);font-size:13px;">
        <a href="<?php echo e(route('privacy-policy')); ?>" style="color:#aaa;margin:0 12px;text-decoration:none;" onmouseover="this.style.color='#FF6839'" onmouseout="this.style.color='#aaa'">Privacy Policy</a>
        <span style="color:#555;">|</span>
        <a href="<?php echo e(route('terms-of-service')); ?>" style="color:#aaa;margin:0 12px;text-decoration:none;" onmouseover="this.style.color='#FF6839'" onmouseout="this.style.color='#aaa'">Terms of Service</a>
        <span style="color:#555;">|</span>
        <a href="<?php echo e(route('prohibited-items')); ?>" style="color:#aaa;margin:0 12px;text-decoration:none;" onmouseover="this.style.color='#FF6839'" onmouseout="this.style.color='#aaa'">Prohibited Items</a>
        <span style="color:#555;">|</span>
        <a href="<?php echo e(route('support')); ?>" style="color:#aaa;margin:0 12px;text-decoration:none;" onmouseover="this.style.color='#FF6839'" onmouseout="this.style.color='#aaa'">Support</a>
    </div>
</footer>
...
<script type="text/javascript" src="<?php echo e(asset('vendor/bootstrap/js/bootstrap-rtl.bundle.min.js')); ?>"></script>
<?php } ?>
...
<script type="text/javascript" src="<?php echo e(asset('vendor/slick/slick-lightbox.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    if (address_name == "" || address_name == null) {
        ...
        if (typeof is_layer == "undefined") {
            ...
            $('.locationModalTitle').html('<?php echo e(trans('lang.find_vendors_items_near_you')); ?>');
        }
        <?php } ?>
    } else {
    ...
    async function sendMailData(orderId, userId) {
        ...
        orderDetails.products.forEach((product) => {
            ...
            if (extra_count > 0) {
                productDetailsHtml += '<br> <?php echo e(trans('lang.extra_item')); ?> : ' + extra_html;
            }
        ...
        '    <thead>\n' +
        '        <tr>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.product_name')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.quantity_plural')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.price')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.extra_item')); ?> <?php echo e(trans('lang.price')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.total')); ?><br></th>\n' +
        '        </tr>\n' +
        '    </thead>\n' +
    ...
    async function sendOnDemandMailData(orderId, serviceId, userId) {
        ...
        if (orderDetails.extraCharges != "" && orderDetails.extraCharges != null) {
            extraChargesHtml += `<strong><?php echo e(trans('lang.extra_charges')); ?> : ${formatCurrency(parseFloat(orderDetails.extraCharges), currencyData)}</strong><br>`;
        }
        ...
        '    <thead>\n' +
        '        <tr>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.service')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.quantity_plural')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.price')); ?><br></th>\n' +
        '            <th style="text-align: left; border: 1px solid rgb(0, 0, 0);"><?php echo e(trans('lang.total')); ?><br></th>\n' +
        '        </tr>\n' +
        ...
        if (referral_ref) {
            referral_ref.get().then(async function(refSnapshot) {
                ...
                if (referral_data != undefined && referral_data.referralCode != null && referral_data.referralCode != undefined) {
                    $(".referral_code").html("<b><?php echo e(trans('lang.your_referral_code')); ?> : " + referral_data.referralCode + "</b>");
                }
            })
        }
    });
            ...
            if (getCookie('service_type') == "Parcel Delivery Service" || getCookie('service_type') == "Rental Service" || getCookie('service_type') == "Cab Service" || getCookie('service_type') == "On Demand Service") {
                ...
                await $.ajax({
                    ...
                    success: async function(result) {
                        if (result > 0) {
                            Swal.fire({
                                text: "<?php echo e(trans('lang.section_change_alert')); ?>",
                                icon: "warning",
...
<script type="text/javascript">
        ...
        if (data != undefined) {
            ...
            if (serviceJson != '' && serviceJson != null) {
                $.ajax({
                    ...
                    url: "<?php echo e(route('storeServiceFile')); ?>",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    success: function(data) {
    ...
    function getStoreNextOpeningTime(data) {
        ...
        if (!data.workingHours || data.workingHours.length === 0) {
            return "<?php echo e(trans('lang.closed')); ?>";
        }
        ...
        if (todayData && todayData.timeslot.length) {
            ...
            if (futureToday.length) {
                return `<?php echo e(trans('lang.next_available_today_at')); ?> ${getTimeFormat(futureToday[0].from)}`;
            }
        }
        ...
        for (let i = 1; i <= 7; i++) {
            ...
            if (dayData && dayData.timeslot.length) {
                ...
                if (i === 1) {
                    return `<?php echo e(trans('lang.next_available_tomorrow_at')); ?> ${getTimeFormat(nextSlot.from)}`;
                } else {
                    return `<?php echo e(trans('lang.next_available')); ?> ${nextDay} <?php echo e(trans('lang.at')); ?> ${getTimeFormat(nextSlot.from)}`;
                }
            }
        }
        return "<?php echo e(trans('lang.closed')); ?>";
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/layouts/footer.blade.php ENDPATH**/ ?>