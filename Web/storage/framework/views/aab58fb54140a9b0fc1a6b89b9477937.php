...
<div class="jox-legal-page">
    ...
    <div class="jox-lang-block">
        ...
        <ul>
            ...
            <li>Ne pas expédier d'articles interdits (voir la liste complète en Section 6 et dans notre <a href="<?php echo e(route('prohibited-items')); ?>" style="color:#FF6839;">Politique des Articles Interdits</a>) ;</li>
        ...
        <p>Toute violation de cette interdiction entraîne la suspension immédiate du compte et peut faire l'objet d'un signalement aux autorités compétentes. Consultez notre <a href="<?php echo e(route('prohibited-items')); ?>" style="color:#FF6839;">Politique des Articles Interdits</a> pour plus de détails.</p>
        ...
        <h2>11. Contact</h2>
        <p>Pour toute question relative aux présentes CGU, contactez-nous via la page <a href="<?php echo e(route('support')); ?>" style="color:#FF6839;">Support</a>.</p>
    </div>
    ...
    <div class="jox-lang-block">
        ...
        <ul>
            ...
            <li>Not ship prohibited items (see Section 6 and our <a href="<?php echo e(route('prohibited-items')); ?>" style="color:#FF6839;">Prohibited Items Policy</a>);</li>
        ...
        <p>Any violation results in immediate account suspension and may be reported to relevant authorities. See our full <a href="<?php echo e(route('prohibited-items')); ?>" style="color:#FF6839;">Prohibited Items Policy</a>.</p>
        ...
        <h2>11. Contact</h2>
        <p>For questions regarding these Terms, contact us via the <a href="<?php echo e(route('support')); ?>" style="color:#FF6839;">Support</a> page.</p>
    </div>
    ...
    <div class="jox-lang-block jox-rtl">
        ...
        <h2>٦. التواصل</h2>
        <p>لأي استفسار، يُرجى التواصل معنا عبر صفحة <a href="<?php echo e(route('support')); ?>" style="color:#FF6839;">الدعم</a>.</p>
    </div>

</div>

<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/resources/views/static/terms_of_service.blade.php ENDPATH**/ ?>