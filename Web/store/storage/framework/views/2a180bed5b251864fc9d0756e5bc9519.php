        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.item_plural')); ?></li>
                </ol>
            </div>
            <div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                <span class="icon mr-3"><img src="<?php echo e(asset('images/item_image.png')); ?>"></span>
                                <h3 class="mb-0"><?php echo e(trans('lang.item_plural')); ?></h3>
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.item_plural')); ?></h3>
                                    <p class="mb-0 text-dark-2"><?php echo e(trans('lang.item_table_text')); ?></p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">

                                        <a class="btn-primary btn rounded-full" href="<?php echo route('items.create'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.item_create')); ?></a>

                                    </div>
                                    <div class="card-header-btn mr-3">
                                        <a class="btn-secondary btn rounded-full" href="<?php echo route('items.global'); ?>"><i class="mdi mdi-plus mr-2"></i><?php echo e(trans('lang.global_item')); ?></a>    
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="d-none" id="assign-tax-container" style="display: inline-block;margin: 12px;">
                                    <button type="button" class="btn btn-sm btn-warning" id="assign-taxes-btn">
                                        <?php echo e(trans('lang.assign_taxes')); ?>
                                            ...
                                            <tr>
                                                <th class="delete-all"><input type="checkbox" id="is_active"><label
                                                    ...
                                                    <a id="deleteAll" class="do_not_delete" href="javascript:void(0)"><i
                                                            class="fa fa-trash"></i> <?php echo e(trans('lang.all')); ?></a></label>
                                                <th><?php echo e(trans('lang.item_info')); ?></th>
                                                <th><?php echo e(trans('lang.item_price')); ?></th>
                                                <th><?php echo e(trans('lang.item_category_id')); ?></th>
                                                <th><?php echo e(trans('lang.item_publish')); ?></th>
                                                <th><?php echo e(trans('lang.date_created')); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(trans('lang.select_taxes')); ?></h5>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn btn-primary" id="modal-add-taxes-btn">
                        <?php echo e(trans('lang.add_taxes')); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", async function() {       
            if (authRole === 'employee') {               
                ...
                if (!currentPermissions.isActive) {
                    ...
                    $('#itemTable').hide();
                    $('.page-menu').html('<p class="text-center text-danger font-weight-bold"><?php echo e(trans("lang.no_permission")); ?></p>');
                    return;
                }
            }
        ...
        getVendorId(vendorUserId).then(data => {
            ...
            $(document).ready(function() {                    
                    ...
                    var fieldConfig = {
                        columns: [{
                                key: 'name',
                                header: "<?php echo e(trans('lang.item_info')); ?>"
                            },
                            {
                                key: 'finalPrice',
                                header: "<?php echo e(trans('lang.item_price')); ?>"
                            },
                            {
                                key: 'category',
                                header: "<?php echo e(trans('lang.item_category_id')); ?>"
                            },
                            {
                                key: 'publish',
                                header: "<?php echo e(trans('lang.item_publish')); ?>"
                            },
                        ],

                        fileName: "<?php echo e(trans('lang.item_table')); ?>",
                    };
                    ...
                    const table = $('#itemTable').DataTable({
                        ...
                        initComplete: function() {
                            ...
                            $('.dataTables_filter input').attr('placeholder', '<?php echo e(trans('lang.search_here')); ?>')
        ...
        async function buildHTML(val) {
            ...
            var id = val.id;
            var route1 = '<?php echo e(route('items.edit', ':id')); ?>';
                    ...
                    if (vendorData.hasOwnProperty('subscription_plan') && vendorData.subscription_plan != null && vendorData.subscription_plan != '') {
                        ...
                        if (itemLimit != '-1') {
                            $('.food-limit-note').html(
                                '<?php echo e(trans('lang.note')); ?> : <?php echo e(trans('lang.your_item_limit_is')); ?> ' +
                                itemLimit + ' <?php echo e(trans('lang.so_only_first')); ?> ' + itemLimit +
                                ' <?php echo e(trans('lang.items_will_visible_to_customer')); ?>')
                        }
                    }
                }
        ...
        $('#assign-taxes-btn').on('click', async function() {
            ...
            if (!selectedProductIds.length) {
                Swal.fire({ icon: 'warning', text: "<?php echo e(trans('lang.no_products_selected')); ?>" });
        ...
        $('#modal-add-taxes-btn').on('click', async function() {
            ...
            Swal.fire({
                title: '<?php echo e(trans("lang.assigning_taxes")); ?>',
            ...
            try {
                ...
                Swal.fire({
                    icon: 'success',
                    title: "<?php echo e(trans('lang.taxes_assigned_successfully')); ?>",
                ...
                console.error(error);
                Swal.fire({ icon: 'error', text: "<?php echo e(trans('lang.error_assigning_taxes')); ?>" });
            }
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/items/index.blade.php ENDPATH**/ ?>