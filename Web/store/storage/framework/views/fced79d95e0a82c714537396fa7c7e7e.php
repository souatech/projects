...
<div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor restaurantTitle"><?php echo e(trans('lang.document_verification')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.document_verification')); ?></li>
                </ol>
            </div>
        </div>
                            ...
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                <li class="nav-item">
                                    <a class="nav-link active vendor-name"
                                       href="<?php echo url()->current(); ?>"><?php echo e(trans('lang.document_details')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                    ...
                    docRefs.get().then(async function (docrefSnapshot) {
                        ...
                        if (docRef && docRef.hasOwnProperty('backImage') && docRef.hasOwnProperty('frontImage')) {
                            if (docRef.backImage != '' && docRef.frontImage != '' && docRef.backImage!=null && docRef.frontImage != null  && doc.backSide && doc.frontSide  ) {
                                                            trhtml += '<td>' + doc.title + '&nbsp;&nbsp;<a href="#" class="badge badge-info py-2 px-3 font-weight-bold" data-toggle="modal" data-target="#exampleModal" data-image="' + docRef.frontImage + '" data-id="front" class="open-image"><?php echo e(trans('lang.view_front_image')); ?></a>&nbsp;<a href="#" class="badge badge-info py-2 px-3 font-weight-bold" data-toggle="modal" data-target="#exampleModal"  data-image="' + docRef.backImage + '" data-id="back" class="open-image"><?php echo e(trans('lang.view_back_image')); ?></a></td>';
                                                                                                                                                    } else if (docRef.backImage != '' && docRef.backImage != null  && doc.backSide ) {
                                trhtml += '<td>' + doc.title + '&nbsp;<a href="#" data-toggle="modal" class="badge badge-info py-2 px-3 font-weight-bold" data-target="#exampleModal" data-id="back" data-image="' + docRef.backImage + '" class="open-image"><?php echo e(trans('lang.view_back_image')); ?></a></td>';
                                                            } else if (docRef.frontImage != '' && docRef.frontImage != null  && doc.frontSide ) {
                                trhtml += '<td>' + doc.title + '&nbsp;<a href="#" data-toggle="modal" class="badge badge-info py-2 px-3 font-weight-bold" data-target="#exampleModal" data-id="front" class="open-image" data-image="' + docRef.frontImage + '"><?php echo e(trans('lang.view_front_image')); ?></a></td>';
                                                            } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/documents/index.blade.php ENDPATH**/ ?>