    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo e(trans('lang.order_plural')); ?></li>
            </ol>
        </div>
        <div>
        </div>
            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        ...
                        <h3 class="mb-0"><?php echo e(trans('lang.order_plural')); ?></h3>
               ...
               <div class="card border">
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   <div class="card-header-title">
                    <h3 class="text-dark-2 mb-2 h4"><?php echo e(trans('lang.order_plural')); ?></h3>
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", async function() {
        ...
        var fieldConfig = {
                columns: [
                    { key: 'id', header: "<?php echo e(trans('lang.order_id')); ?>" },
                    { key: 'clientName', header: "<?php echo e(trans('lang.order_user_id')); ?>" },                            
                    { key: 'status', header: "<?php echo e(trans('lang.order_order_status_id')); ?>" }, 
                    { key: 'amount', header: "<?php echo e(trans('lang.amount')); ?>" },
                    { key: 'orderType', header: "<?php echo e(trans('lang.order_type')); ?>" },
                    { key: 'createdAt', header: "<?php echo e(trans('lang.date')); ?>" },
                    
                ],
                
                fileName: "<?php echo e(trans('lang.order_list')); ?>",
            };
                ...
                await ref.get().then(async function (querySnapshot) {
                    ...
                    await Promise.all(querySnapshot.docs.map(async (doc) => {
                        ...
                        if(childData.hasOwnProperty('author') && childData.author != ''){
                            ...
                            childData.clientName = '<?php echo e(trans("lang.unknown")); ?>';
                        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/orders/index.blade.php ENDPATH**/ ?>