    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo route('dashboard'); ?>"><?php echo e(trans('lang.dashboard')); ?></a>
                    </li>
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="resttab-sec">
                        ...
                        <div id="noPermissionMsg" class="text-center text-danger font-weight-bold mb-3" style="display:none;">
                            <p><?php echo e(trans("lang.no_permission")); ?></p>
                        </div>
                            ...
                            <div class="vendor_payout_create-inner">
                                <fieldset class="profile_fieldset" style="display:none">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-3 control-label"><?php echo e(trans('lang.user_profile_picture')); ?></label>
                                        <div class="col-9">
                                ...
                                <fieldset class="profile_fieldset" style="display:none">
                                    <legend><?php echo e(trans('lang.password')); ?></legend>
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label"><?php echo e(trans('lang.old_password')); ?></label>
                                        <div class="col-7">
                                    ...
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label"><?php echo e(trans('lang.new_password')); ?></label>
                                        <div class="col-7">
                                    ...
                                    <div class="form-group col-12 text-center">
                                        <button type="button" class="btn btn-primary  change_user_password"><i class="fa fa-save"></i><?php echo e(trans('lang.change_password')); ?>
                                ...
                                <div class="vendor_fieldset" style="display:none">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.wallet_amount')); ?></label>
                                            <h5 class="col-3 control-label text-primary user_wallet"><a href="#"></a></h5>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 control-label "><?php echo e(trans('lang.select_section')); ?></label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.category_plural')); ?></label>
                                            <div class="col-7">
                                                <select id='vendor_cuisines' class="form-control chosen-select" multiple="multiple">
                                                </select>
                                                <div class="form-text text-muted">
                                                    <?php echo e(trans('lang.vendor_category_help')); ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-9">
                                                <h6><?php echo e(trans('lang.cordinates')); ?> <a target="_blank" href="https://www.latlong.net/"></a><?php echo e(trans('lang.lat_long')); ?>
                                    ...
                                    <fieldset style="display:none;" id="showhidedinein">
                                        <legend><?php echo e(trans('lang.dine-in-feature')); ?></legend>
                                        <div class="form-group row">
                                            <div class="form-group row width-50">
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="dine_in_feature" class="">
                                                    <label class="col-3 control-label" for="dine_in_feature"><?php echo e(trans('lang.dine-in-feature')); ?></label>
                                                </div>
                                            </div>                                           
                                            <div class="divein_div" style="display:none">
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label"><?php echo e(trans('lang.cost')); ?></label>
                                                    <div class="col-7">
                                                        <input type="number" class="form-control vendor_cost" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row width-100 vendor_image">
                                                    <label class="col-3 control-label"><?php echo e(trans('lang.menu_card')); ?></label>
                                                    <div class="col-7">
                                    ...
                                    <fieldset id="working_hour_section" class="d-none">
                                        <legend><?php echo e(trans('lang.working_hours')); ?></legend>
                                        <div class="form-group row">
                                            <label class="col-12 control-label" style="color:red;font-size:15px;"><?php echo e(trans('lang.working_hour_note')); ?></label>
                                            <div class="form-group row width-100">
                                                <div class="col-7">
                                                    <button type="button" class="btn btn-primary  add_working_hours_restaurant_btn">
                                                        <i></i><?php echo e(trans('lang.add_working_hours')); ?>
                                            ...
                                            <div class="working_hours_div" style="display:none">
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.sunday')); ?></label>
                                                    <div class="col-12">
                                                        <button type="button" class="btn btn-primary add_more_sunday" onclick="addMorehour('Sunday','sunday', '1')">
                                                            <?php echo e(trans('lang.add_more')); ?>
                                                ...
                                                <div class="restaurant_discount_options_Sunday_div restaurant_discount" style="display:none">
                                                    <table class="booking-table" id="working_hour_table_Sunday">
                                                        <tr>
                                                            <th>
                                                                <label class="col-3 control-label"><?php echo e(trans('lang.from')); ?></label>
                                                            </th>
                                                            <th>
                                                                <label class="col-3 control-label"><?php echo e(trans('lang.to')); ?></label>
                                                            </th>
                                                            <th>
                                                                <label class="col-3 control-label"><?php echo e(trans('lang.actions')); ?></label>
                                                            </th>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.monday')); ?></label>
                                                    <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.tuesday')); ?></label>
                                                    <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.wednesday')); ?></label>
                                                    <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.thursday')); ?></label>
                                                    <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.friday')); ?></label>
                                                    <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-1 control-label"><?php echo e(trans('lang.satuarday')); ?></label>
                                                    <div class="col-12">
                                    ...
                                    <fieldset style="display: none;" id="services_feature">
                                        ...
                                        <div class="form-group row">
                                            <div class="form-check width-100">
                                                ...
                                                <label class="col-3 control-label" for="Free_Wi_Fi"><?php echo e(trans('lang.wifi')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Good_for_Breakfast">
                                                <label class="col-3 control-label" for="Good_for_Breakfast"><?php echo e(trans('lang.breakfast')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Good_for_Dinner">
                                                <label class="col-3 control-label" for="Good_for_Dinner"><?php echo e(trans('lang.dinner')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Good_for_Lunch">
                                                <label class="col-3 control-label" for="Good_for_Lunch"><?php echo e(trans('lang.lunch')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Live_Music">
                                                <label class="col-3 control-label" for="Live_Music"><?php echo e(trans('lang.live_music')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Outdoor_Seating">
                                                <label class="col-3 control-label" for="Outdoor_Seating"><?php echo e(trans('lang.outdoor_seating')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Takes_Reservations">
                                                <label class="col-3 control-label" for="Takes_Reservations"><?php echo e(trans('lang.reservations')); ?></label>
                                            </div>
                                            <div class="form-check width-100">
                                                <input type="checkbox" id="Vegetarian_Friendly">
                                                <label class="col-3 control-label" for="Vegetarian_Friendly"><?php echo e(trans('lang.vegetarian_friendly')); ?></label>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset class="selfDeliveryOption d-none">
                                        <legend><?php echo e(trans('lang.self_delivery_setting')); ?></legend>
                                        <div class="form-group row">
                                            <div class="form-group row width-100">
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="enable_self_delivery" class="">
                                                    <label class="col-3 control-label" for="enable_self_delivery"><?php echo e(trans('lang.enable_self_delivery')); ?></label>
                                                    <div class="form-text text-muted">
                                    ...
                                    <fieldset id="delivery_charges_div">
                                        <legend><?php echo e(trans('lang.deliveryCharge')); ?></legend>
                                        <div class="form-group row">
                                            <div class="form-group row width-100">
                                                <label class="col-4 control-label"><?php echo e(trans('lang.delivery_charges_per_km')); ?></label>
                                                <div class="col-7">
                                                    <input type="number" class="form-control" id="delivery_charges_per_km">
                                                </div>
                                            </div>
                                            <div class="form-group row width-100">
                                                <label class="col-4 control-label"><?php echo e(trans('lang.minimum_delivery_charges')); ?></label>
                                                <div class="col-7">
                                                    <input type="number" class="form-control" id="minimum_delivery_charges">
                                                </div>
                                            </div>
                                            <div class="form-group row width-100">
                                                <label class="col-4 control-label"><?php echo e(trans('lang.minimum_delivery_charges_within_km')); ?></label>
                                                <div class="col-7">
                                    ...
                                    <fieldset id="packagingChargeDiv" class='d-none'>
                                        <legend><?php echo e(trans('lang.packaging_charge')); ?></legend>
                                        <div class="form-group row width-100 packagingChargeEnable d-none">
                                            <label class="col-4 control-label"><?php echo e(trans('lang.packaging_charge')); ?></label>
                                            <div class="col-7">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row width-100">
                                                <label class="col-4 control-label"><?php echo e(trans('lang.holder_name')); ?></label>
                                                <div class="col-7">
                                    ...
                                    <fieldset id="story_upload_div" style="display: none;">
                                        <legend><?php echo e(trans('lang.story_plural')); ?></legend>
                                        <div class="form-group row vendor_image">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.choose_humbling_gif_image')); ?></label>
                                            <div class="">
                                        ...
                                        <div class="form-group row vendor_image">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.select_story_video')); ?></label>
                                            <div class="col-md-12">
            ...
            <div class="form-group col-12 text-center btm-btn page-btn">
                <button type="button" class="btn btn-primary  save_vendor_btn"><i class="fa fa-save"></i>
                    <?php echo e(trans('lang.save')); ?>

                </button>
                <a href="<?php echo route('dashboard'); ?>" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
            </div>
        </div>
    </div>
    </div>
    <div class="dataTables_paginate paging_simple_numbers" id="data-table_paginate">
        <ul class="pagination">
            <li class="paginate_button previous" id="users-table_previous">
                <a href="javascript:void(0);" id="users_table_previous_btn" onclick="prev()" aria-controls="users-table" data-dt-idx="0" tabindex="0"><?php echo e(trans('lang.previous')); ?></a>
            </li>
            <li class="paginate_button">
                <a href="javascript:void(0);" id="users_table_next_btn" onclick="next()" aria-controls="users-table" data-dt-idx="2" tabindex="0"><?php echo e(trans('lang.next')); ?></a>
            </li>
        </ul>
    </div>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        var empVendorId = "<?php echo e($empVendorId); ?>";
        let currentPermissions = {
            isActive: true   
        };
        var section_id = getCookie('section_id') || null;
        var packagingChargeEnable = false;      
        var currentRoute = "<?php echo e(Route::currentRouteName()); ?>";
        ...
        database.collection('users').doc(vendorUserId).get().then(async function(userSnapshots) {
                ...
                ref.get().then(async function(snapshots) {
                    ...
                    await database.collection('vendor_categories').where('publish', '==', true).where('section_id', '==', vendor.section_id).get().then(async function(snapshots) {
                        ...
                        $("#vendor_cuisines").show().chosen({
                            "placeholder_text": "<?php echo e(trans('lang.select_cuisines')); ?>"
                        });
                    });
            ...
            $(".headerText").text("<?php echo e(trans('lang.user_profile')); ?>");
            $(".headerRedirectionText").text("<?php echo e(trans('lang.user_profile_edit')); ?>");
            <?php endif; ?>
            <?php if(Route::is('store')): ?>
            $(".vendor_fieldset").show();
            $(".headerText").text("<?php echo e(trans('lang.mystore_plural')); ?>");
            $(".headerRedirectionText").text("<?php echo e(trans('lang.mystore_plural')); ?>");
            <?php endif; ?>
        ...
        async function getSectionsCategory(sectionId) {
            ...
            await database.collection('vendor_categories').where('section_id', '==', sectionId).get().then(
                async function(snapshots) {
                    ...
                    $("#vendor_cuisines").show().chosen({
                        "placeholder_text": "<?php echo e(trans('lang.select_category')); ?>"
                    });
                });
        }
        ...
        $(".change_user_password").click(function() {
            ...
            if (userOldPassword == '') {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.old_password_error')); ?></p>");
                window.scrollTo(0, 0);
            } else if (userNewPassword == '') {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.new_password_error')); ?></p>");
                window.scrollTo(0, 0);
            } else {
                ...
                firebase.auth().signInWithEmailAndPassword(userEmail, userOldPassword)
                    .then((userCredential) => {
                        ...
                        user.updatePassword(userNewPassword).then(() => {
                            ...
                            $(".error_top").html("");
                            $(".error_top").append(
                                "<p class='text-success'><?php echo e(trans('lang.password_updated_successfully')); ?></p>"
                            );
                            window.scrollTo(0, 0);
                        }).catch((error) => {
                            $(".error_top").show();
                    ...
                    .catch((error) => {
                        ...
                        switch (error.code) {
                            case 'auth/wrong-password':
                                message = "<?php echo e(trans('lang.current_password_incorrect')); ?>";
                                break;

                            case 'auth/user-not-found':
                                message = "<?php echo e(trans('lang.user_not_found_check_email')); ?>";
                                break;

                            case 'auth/invalid-email':
                                message = "<?php echo e(trans('lang.invalid_email_address')); ?>";
                                break;
                            ...
                            default:
                                message = "<?php echo e(trans('lang.something_went_wrong')); ?>";
                        }
        ...
        $(".save_vendor_btn").click(async function(e) {
            ...
            if (userFirstName == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.enter_owners_name_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (userLastName == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.enter_owners_lastname_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (email == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.enter_owners_email')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (userPhone == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.enter_owners_phone')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (section_id == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.select_section_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            }
            ...
            <?php if(Route::is('store')): ?>
                ...
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_name_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (cuisines == '' || cuisines.length == 0) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_cuisine_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (phonenumber == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_phone_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (zoneId == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.select_zone_help')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (address == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_address_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (isNaN(latitude)) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_lattitude_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (latitude < -90 || latitude > 90) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_lattitude_limit_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (isNaN(longitude)) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_longitude_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (longitude < -180 || longitude > 180) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_longitude_limit_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (isInZone == false) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.invalid_location_zone')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (description == '') {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.vendor_description_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            } else if (packagingChargeEnable && (packagingCharge < 0 || packagingCharge === '')) {
                jQuery("#data-table_processing").hide();
                $(".error_top").show();
                $(".error_top").html("<p><?php echo e(trans('lang.packagingCharge_error')); ?></p>");
                window.scrollTo(0, 0);
                return false;
            }
            <?php endif; ?>
            ...
            try {
                ...
                if (story_vedios && story_vedios.length > 0 || story_thumbnail != '') {
                    if (story_vedios.length > 0 && story_thumbnail == '') {
                        throw new Error("<?php echo e(trans('lang.story_error')); ?>");
        ...
        function handleStoryFileSelect(evt) {
            ...
            if (!allowedExtensions.exec(videoValue)) {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.error_invalid_video_type')); ?></p>");
                window.scrollTo(0, 0);
                isVideo.value = '';
                return false;
            }
            ...
            video.onloadedmetadata = function() {
                ...
                if (videoDurationTime > storevideoDuration) {
                    $(".error_top").show();
                    $(".error_top").html("");
                    $(".error_top").append("<p><?php echo e(trans('lang.error_story_video_duration_maximum_allow')); ?>" + storevideoDuration +
                        " <?php echo e(trans('lang.seconds')); ?></p>");
                    window.scrollTo(0, 0);
                    evt.target.value = '';
                    return false;
                }
                ...
                reader.onload = (function(theFile) {
                    return function(e) {
                        ...
                        uploadTask.on('state_changed', function(snapshot) {
                            ...
                            jQuery("#uploding_story_video").text("<?php echo e(trans('lang.video_is_uploading')); ?>");
                        }, function(error) {}, function() {
                            uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                                jQuery("#uploding_story_video").text("<?php echo e(trans('lang.upload_is_completed')); ?>");
                                setTimeout(function() {
        ...
        function handleStoryThumbnailFileSelect(evt) {
            ...
            if (!allowedExtensions.exec(filePath)) {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.error_invalid_file_type')); ?></p>");
                window.scrollTo(0, 0);
                fileInput.value = '';
                return false;
            }
            ...
            if(authRole=='vendor'){
                ...
                if (authRole === 'employee' && isStorePage){        
                    ...
                    if (!currentPermissions.isActive) {
                        alert('<?php echo e(trans("lang.no_permission")); ?>');
        ...
        function addMorehour(day, day2, count) {
            ...
            $('#working_hour_table_' + day + ' tr:last').after('<tr>' +
                ...
                ')" style="width:62%;"><?php echo e(trans('lang.save')); ?></button>' +
                '</td></tr>');
            countAddhours++;
        }
        function addMoreFunctionhour(day1, day2, count) {
            ...
            if (to == '' && from == '') {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.please_enter_valid_time')); ?></p>");
                window.scrollTo(0, 0);
            } else if (from > to) {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.to_time_can_not_be_less_than_from_time')); ?></p>");
                window.scrollTo(0, 0);
            } else {
                var timeslotworkVar = {
                    'from': from,
        ...
        function updatehoursFunctionButton(day, rowCount, dayCount) {
            ...
            if (to == '' && from == '') {
                ...
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.to_ time_can_not_be_less_than_from_time')); ?></p>");
                window.scrollTo(0, 0);
            } else {
                var timeslotworkVar = {
                    'from': from,
        ...
        function chkAlphabets(event, msg) {
            if (!(event.which >= 97 && event.which <= 122) && !(event.which >= 65 && event.which <= 90)) {
                document.getElementById(msg).innerHTML = "<?php echo e(trans('lang.accept_only_alphabets')); ?>";
                return false;
            } else {
        ...
        function chkAlphabets2(event, msg) {
            if (!(event.which >= 48 && event.which <= 57)) {
                document.getElementById(msg).innerHTML = "<?php echo e(trans('lang.accept_only_number')); ?>";
                return false;
            } else {
                document.getElementById(msg).innerHTML = "";
                return true;
        ...
        function chkAlphabets3(event, msg) {
            if ((event.which != 46 || $(this).val().indexOf('.') != -1) && (event.which < 48 || event.which > 57)) {
                document.getElementById(msg).innerHTML = "<?php echo e(trans('lang.accept_number')); ?>";
                return false;
            } else {
                document.getElementById(msg).innerHTML = "";
                return true;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/users/profile.blade.php ENDPATH**/ ?>