...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <link rel="icon" id="favicon" type="image/x-icon" href="<?php echo e(asset('images/logo-light-icon.png')); ?>">
        <!-- Fonts -->
        <link rel="dns-prefetch" href="//fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
        <!-- Styles -->
        <link href="<?php echo e(asset('assets/plugins/slick/slick.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('assets/plugins/slick/slick-theme.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('assets/plugins/slick/slick-lightbox.css')); ?>" rel="stylesheet">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-11 ml-lg-auto mr-lg-auto">
                    <div class="title text-center mb-5">
                        <h2 class="text-primary"><?php echo e(trans('lang.business_plans')); ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row sections-div justify-content-center">
                        ...
                        <select id="section-input" hidden>
                            <option value=""><?php echo e(trans('lang.select')); ?> <?php echo e(trans('lang.section')); ?></option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row backBtn d-none">
                        <div class="col-12 text-center"><a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary"><?php echo e(trans('lang.cancel')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/plugins/slick/slick.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/plugins/slick/slick-lightbox.js')); ?>"></script>
            ...
            async function getSubscriptionPlan() {
                ...
                database.collection('subscription_plans').where('isEnable', '==', true).where('sectionId',
                    ...
                    if (commisionModel == false && snapshots.docs.length == 1) {
                        $('#default-plan').html('<p class="text-danger"><?php echo e(trans('lang.no_subscription_plan_is_created_contact_to_admin')); ?></p><span class="font-weight-bold"><?php echo e(trans("lang.email")); ?> : ' + adminEmail + '<span>');
                    }
                    let plans = [];
                    ...
                    plans.map(async (data) => {
                        ...
                        var activeClass = (data.id == activeSubscriptionId) ? '<span class="badge badge-success"><?php echo e(trans('lang.active')); ?></span>' : '';
                        ...
                        if (data.isCommissionPlan == true) {
                            ...
                            if (subscriptionModel) {
                                ...
                                if (data.type == "free") {
                                    ...
                                    var route =
                                        "<?php echo e(route('subscription-plans.checkout', [':id', ':sectionId'])); ?>";
                                ...
                                html += `<div class="col-md-3 mb-3  pricing-card pricing-card-subscription ${data.name}">
                                    <div class="pricing-card-inner">
                                        ...
                                        <div class="pricing-card-price">
                                            <h3 class="text-dark-2">${data.type!=="free"? (currencyAtRight? parseFloat(data.price).toFixed(decimal_degits)+currentCurrency:currentCurrency+parseFloat(data.price).toFixed(decimal_degits)):'<span style="color:red;"><?php echo e(trans("lang.free")); ?></span>'}</h3>
                                            <span class="price-day">${data.expiryDay==-1? "<?php echo e(trans('lang.unlimited')); ?>":data.expiryDay} <?php echo e(trans('lang.days')); ?></span>
                                        </div>
                                        </div>
                                        <div class="pricing-card-content pt-3 mt-3 border-top">
                                        <ul class="pricing-card-list text-dark-2">
                    ...
                    async function(snapshot) {
                        ...
                        await database.collection('users').doc(userId).update({
                            ...
                            await database.collection('subscription_history').doc(
                                ...
                                var url =
                                    "<?php echo e(route('setSubcriptionFlag')); ?>";
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/subscription_plans/show.blade.php ENDPATH**/ ?>