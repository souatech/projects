...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><?php echo e(trans('lang.upload_document')); ?></h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(trans('lang.dashboard')); ?></a></li>
                <li class="breadcrumb-item"><a href="<?php echo route('vendors.document'); ?>"><?php echo e(trans('lang.document_verification')); ?></a>
                </li>
                <li class="breadcrumb-item active"><?php echo e(trans('lang.upload_document')); ?></li>
            </ol>
        </div>
    </div>
        ...
        <div class="card  pb-4">
            <div class="card-body">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    <button type="button" class="btn btn-primary save-doc"><i class="fa fa-save"></i> <?php echo e(trans('lang.save')); ?>

                    </button>
                    <a href="<?php echo e(route('vendors.document')); ?>" class="btn btn-default"><i
    ...
    <script>
        var docId = "<?php echo e($id); ?>";
        var id = "<?php echo e($vendorId); ?>";
        ...
        var requestUrl = "<?php echo e(request()->is('document-list*')); ?>";
        var back_photo = '';
        var front_photo = '';
        var backFileName = '';
        var frontFileName = '';
                ...
                vendorDocRef.get().then(async function (docrefSnapshot) {
                    ...
                    if (docRef.enable) {
                        ...
                        if (docRef.backSide) {
                            ...
                            html += '<div class="form-group row width-50"><label class="col-3 control-label">' + "<?php echo e(trans('lang.back_image')); ?>" + '<span class="required-field"></span></label><div class="col-7"><input type="file" onChange="handleBackFileSelect(event)" class="form-control image"><div class="placeholder_img_thumb back_image"><span class="image-item"><span class="remove-btn" id="back_image"><i class="fa fa-remove"></i></span><img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="rounded" style="width:200px; height:auto" src="' + (vendorDocRef && vendorDocRef.backImage ? vendorDocRef.backImage : placeholderImage) + '" alt="image"></span></div><div id="uploding_image"></div></div></div>';
                        }
    ...
    if (!allowedTypes.includes(f.type)) {
        $(".error_top").show().html("<p><?php echo e(trans('lang.front_image')); ?> <?php echo e(trans('lang.image_type_validation')); ?></p>");
        window.scrollTo(0, 0);
    ...
    var allowedTypes = ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp'];
    if (!allowedTypes.includes(f.type)) {
        $(".error_top").show().html("<p><?php echo e(trans('lang.back_image')); ?> <?php echo e(trans('lang.image_type_validation')); ?></p>");
        window.scrollTo(0, 0);
        evt.target.value = ''; // Clear the input
        return;
    }
    // ---- END: FILE TYPE VALIDATION ----
        ...
        $(document).on('click', '.save-doc', function () {
            ...
            if (backSide && back_photo == "") {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.document_back_side_help')); ?></p>");
                window.scrollTo(0, 0);
            } else if (frontSide && front_photo == "") {
                $(".error_top").show();
                $(".error_top").html("");
                $(".error_top").append("<p><?php echo e(trans('lang.document_front_side_help')); ?></p>");
                window.scrollTo(0, 0);
            } else {
                jQuery("#data-table_processing").show();
                        ...
                        database.collection('documents_verify').doc(id).set({
                            ...
                            await allVendor.get().then(async function (snapshotsvendor) {
                                if (snapshotsvendor.docs.length > 0) {
                                    ...
                                    if (verification) {
                                        jQuery("#data-table_processing").hide();
                                        window.location.href = "<?php echo e(route('vendors.document')); ?>";
                                    }
                                } else {
                                    jQuery("#data-table_processing").hide();
                                    window.location.href = "<?php echo e(route('vendors.document')); ?>";
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/documents/document_upload.blade.php ENDPATH**/ ?>