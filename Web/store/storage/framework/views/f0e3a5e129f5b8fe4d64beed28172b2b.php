...
<div class="navbar-collapse">
    ...
    <ul class="navbar-nav my-lg-0">
        ...
        <li class="nav-item dropdown">
		 ...
		 <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo e(asset('images/users/user-2.png')); ?>" onerror="this.onerror=null; this.src='<?php echo e(asset('images/users/user-2.png')); ?>';" alt="user" class="profile-pic userimage"></a>
        
            <div class="dropdown-menu dropdown-menu-right scale-up">
                <ul class="dropdown-user">
                    <li>
                        <div class="dw-user-box">
                            <div class="u-img"><img src="<?php echo e(asset('images/users/user-2.png')); ?>" onerror="this.onerror=null; this.src='<?php echo e(asset('images/users/user-2.png')); ?>';"  class="userimage" alt="user" style="max-width: 45px;"></div>
                    ...
                    <li><a href="<?php echo e(route('user.profile')); ?>"><i class="ti-user"></i>  <?php echo trans('lang.user_profile'); ?></a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-power-off"></i> <?php echo e(__('Logout')); ?></a></li>
...
<script>
    var doNotDeleteAlert = "<?php echo e(trans('lang.this_is_for_demo_we_can_not_allow_to_delete')); ?>";
...
</script><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/layouts/header.blade.php ENDPATH**/ ?>