    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><?php echo e(trans('lang.item_plural')); ?></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo route('dashboard'); ?>"><?php echo e(trans('lang.dashboard')); ?></a>
                    </li>
                    <li class="breadcrumb-item"><a href="<?php echo route('items'); ?>"><?php echo e(trans('lang.item_plural')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(trans('lang.item_create')); ?></li>
                </ol>
            </div>
        </div>
        ...
        <div>
            <div class="card-body">
                ...
                <div class="row vendor_payout_create">
                    <div class="vendor_payout_create-inner">
                        ...
                        <fieldset>
                            ...
                            <legend><?php echo e(trans('lang.item_information')); ?></legend>
                            ...
                            <div class="form-group row width-100" id="admin_commision_info" style="display:none">
                                <div class="m-3">
                                    <div class="form-text font-weight-bold text-danger h6">
                                        <?php echo e(trans('lang.price_instruction')); ?></div>
                                    <div class="form-text font-weight-bold text-danger h6" id="admin_commision"></div>
                                </div>
                            </div>

                            <div class="form-group row width-50">
                                 <?php if(isset($openai_settings) && data_get($openai_settings, 'status') == true): ?>
                                    <div class="col-12"> 
                                        <label class="control-label"><?php echo e(trans('lang.item_name')); ?></label>
                                        <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 auto_fill_title"
                                            data-error="<?php echo e(trans('lang.ai_name_error')); ?>"
                                            data-lang="<?php echo e(App::getLocale()); ?>"
                                            data-route="<?php echo e(route('ai.title-auto-fill')); ?>">
                                            <div class="btn-svg-wrapper">
                                                <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                            </div>
                                            <span class="ai-text-animation d-none" role="status">
                                                <?php echo e(trans('lang.ai_just_asecond')); ?>

                                            </span>
                                            <span class="btn-text"><?php echo e(trans('lang.ai_generate')); ?></span>
                                        </button>
                                ...
                                <?php else: ?>
                                    <label class="control-label col-3"><?php echo e(trans('lang.item_name')); ?></label>
                                    <div class="col-7">
                                        <input type="text" class="form-control item_name" id="item_name" required>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="form-group row width-50">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_price')); ?></label>
                                <div class="col-7">
                                    <input type="number" class="form-control item_price" required>
                                    <div class="form-text text-muted">
                                        <?php echo e(trans('lang.item_price_help')); ?>
                            ...
                            <div class="form-group row width-50">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_discount')); ?></label>
                                <div class="col-7">
                                    <input type="number" class="form-control item_discount">
                                    <div class="form-text text-muted">
                                        <?php echo e(trans('lang.item_discount_help')); ?>
                            ...
                            <div class="form-group row width-50">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_category_id')); ?></label>
                                <div class="d-flex page-content">
                                    <div class="col-7">
                                        <select id='item_category' class="form-control" required>
                                            <option value=""><?php echo e(trans('lang.select_category')); ?></option>
                                        </select>
                                        <div class="form-text text-muted">
                                            <?php echo e(trans('lang.item_category_id_help')); ?>
                                    ...
                                    <div class="width-100 text-right">
                                        <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 variation_setup_auto_fill"
                                            data-error="<?php echo e(trans('lang.ai_name_description_error')); ?>"
                                            data-lang="<?php echo e(App::getLocale()); ?>"
                                            data-route="<?php echo e(route('ai.variation-setup-auto-fill')); ?>">
                                            <div class="btn-svg-wrapper">
                                                <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                            </div>
                                            <span class="ai-text-animation d-none" role="status">
                            ...
                            <div class="form-check width-50" id="is_digital_div" style="display: none;">
                                ...
                                <label class="col-3 control-label"
                                    for="item_publish"><?php echo e(trans('lang.item_is_digital')); ?></label>
                            </div>

                            <div class="form-group width-100" id="upload_file_div" style="display: none;">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_upload_file')); ?></label>
                                <div class="col-7">
                                    ...
                                    <div class="form-text text-muted"><?php echo e(trans('lang.item_upload_file_ext')); ?></div>
                                </div>
                            </div>

                            <div class="form-group row width-50">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_quantity')); ?></label>
                                <div class="col-7">
                                    <input type="number" class="form-control item_quantity" value="-1">
                                    <div class="form-text text-muted">
                                        <?php echo e(trans('lang.item_quantity_help')); ?>
                            ...
                            <div class="form-group row width-50 brandDiv" style="display: none;">
                                <label class="col-3 control-label"><?php echo e(trans('lang.brand')); ?></label>
                                <div class="col-7">
                                    <select id='brand' class="form-control" required>
                                        <option value=""><?php echo e(trans('lang.select_brand')); ?></option>
                                    </select>
                                    <div class="form-text text-muted">
                                        <?php echo e(trans('lang.brand_help')); ?>
                            ...
                            <div class="form-group row width-100" id="attributes_div" style="display:none">
                                <label class="col-3 control-label"><?php echo e(trans('lang.item_attribute_id')); ?></label>
                                <div class="col-7">
                            ...
                            <div class="form-group row width-100 desciption-wrapper">
                                <?php if(isset($openai_settings) && data_get($openai_settings, 'status') == true): ?>
                                    <div class="col-12"> 
                                        <label class="control-label"><?php echo e(trans('lang.item_description')); ?></label>
                                        <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 auto_fill_description"
                                            data-error="<?php echo e(trans('lang.ai_description_error')); ?>"
                                            data-lang="<?php echo e(App::getLocale()); ?>"
                                            data-route="<?php echo e(route('ai.description-auto-fill')); ?>">
                                            <div class="btn-svg-wrapper">
                                                <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                            </div>
                                            <span class="ai-text-animation d-none" role="status">
                                ...
                                <?php else: ?>
                                    <label class="control-label col-3"><?php echo e(trans('lang.item_description')); ?></label>
                                    <div class="col-7">
                                        <textarea rows="8" class="form-control item_description" id="item_description"></textarea>
                                    </div>    
                                <?php endif; ?>
                            ...
                            <div class="form-check width-100">
                                ...
                                <label class="col-3 control-label"
                                    for="item_publish"><?php echo e(trans('lang.item_publish')); ?></label>
                            </div>

                            <div class="form-check width-100 food_delivery_div d-none">
                                <input type="checkbox" class="item_nonveg" id="item_nonveg">
                                <label class="col-3 control-label" for="item_nonveg"><?php echo e(trans('lang.non_veg')); ?></label>
                            </div>
                            ...
                            <div class="form-check width-100 food_delivery_take_away d-none">
                                ...
                                <label class="col-3 control-label"
                                    for="item_take_away_option"><?php echo e(trans('lang.item_take_away')); ?></label>
                            </div>

                        </fieldset>
                        <fieldset class="product-taxes d-none">
                            <legend><?php echo e(trans('lang.tax_settings')); ?></legend>
                            <div class="form-group row">
                                <label class="col-3 control-label"><?php echo e(trans('lang.select_taxes')); ?></label>
                                <div class="col-7">
                        ...
                        <fieldset class="food_delivery_div ingredients-wrapper d-none">
                            ...
                            <div class="width-100 text-right">
                                <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 ingredients_auto_fill"
                                    data-error="<?php echo e(trans('lang.ai_ingredients_error')); ?>"
                                    data-lang="<?php echo e(App::getLocale()); ?>"
                                    data-route="<?php echo e(route('ai.ingredients-auto-fill')); ?>">
                                    <div class="btn-svg-wrapper">
                                        <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                    </div>
                                    <span class="ai-text-animation d-none" role="status">
                        ...
                        <fieldset class="addons-wrapper">
                            <legend><?php echo e(trans('lang.item_add_one')); ?></legend>
                            <?php if(isset($openai_settings) && data_get($openai_settings, 'status') == true): ?>
                            <div class="width-100 text-right">
                                <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 addons_auto_fill"
                                    data-error="<?php echo e(trans('lang.ai_addons_error')); ?>"
                                    data-lang="<?php echo e(App::getLocale()); ?>"
                                    data-route="<?php echo e(route('ai.addons-auto-fill')); ?>">
                                    <div class="btn-svg-wrapper">
                                        <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                    </div>
                                    <span class="ai-text-animation d-none" role="status">
                            ...
                            <?php endif; ?>
                             <div class="outline-wrapper">
                                ...
                                <div class="form-group row width-100">
                                    <div class="col-7">
                                        <button type="button" onclick="addOneFunction()" class="btn btn-primary"
                                            id="add_one_btn"><?php echo e(trans('lang.item_add_one')); ?>
                                ...
                                <div class="form-group row width-100" id="add_ones_div" style="display:none">
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.item_title')); ?></label>
                                            <div class="col-7">
                                ...
                                <div class="form-group row save_add_one_btn width-100" style="display:none">
                                    <div class="col-7">
                                        <button type="button" onclick="saveAddOneFunction()" class="btn btn-primary">
                                            <?php echo e(trans('lang.save_add_ones')); ?>
                        ...
                        <fieldset class="specification-wrapper">
                            ...
                            <legend><?php echo e(trans('lang.product_specification')); ?></legend>
                            <?php if(isset($openai_settings) && data_get($openai_settings, 'status') == true): ?>
                            <div class="width-100 text-right">
                                <button type="button" class="btn bg-white text-primary generate_btn_wrapper opacity-1 pl-1 mb-2 specification_auto_fill"
                                    data-error="<?php echo e(trans('lang.ai_specification_error')); ?>"
                                    data-lang="<?php echo e(App::getLocale()); ?>"
                                    data-route="<?php echo e(route('ai.specification-auto-fill')); ?>">
                                    <div class="btn-svg-wrapper">
                                        <img width="18" height="18" class="" src="<?php echo e(asset('images/svg/blink-icon-orange.svg')); ?>" alt="">
                                    </div>
                                    <span class="ai-text-animation d-none" role="status">
                            ...
                            <div class="outline-wrapper">
                                ...
                                <div class="form-group row width-100">
                                    <div class="col-7">
                                        <button type="button" onclick="addProductSpecificationFunction()"
                                            ...
                                            <?php echo e(trans('lang.add_product_specification')); ?>
                                ...
                                <div class="form-group row width-100" id="add_product_specification_div"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.lable')); ?></label>
                                            <div class="col-7">
                                                <input type="text" class="form-control add_label">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.value')); ?></label>
                                            <div class="col-7">
                                ...
                                <div class="form-group row save_product_specification_btn width-100" style="display:none">
                                    <div class="col-7">
                                        <button type="button" onclick="saveProductSpecificationFunction()"
                                            class="btn btn-primary"><?php echo e(trans('lang.save_product_specification')); ?>
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="<?php echo route('items'); ?>" class="btn btn-default"><i
                            class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?></a>
                </div>
            </div>
        </div>
    </div>
    <?php if ($__env->exists('layouts.ai_sidebar')) echo $__env->make('layouts.ai_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
    <?php if(isset($openai_settings) && data_get($openai_settings, 'status') == true): ?>
        <link href="<?php echo e(asset('css/AI/ai-sidebar.css')); ?>" rel="stylesheet">
        <script src="<?php echo e(asset('js/AI/product-details-autofill.js')); ?>"></script>
        <script src="<?php echo e(asset('js/AI/variation-setup-auto-fill.js')); ?>"></script>
        <script src="<?php echo e(asset('js/AI/ai-sidebar.js')); ?>"></script>
        <script src="<?php echo e(asset('js/AI/compressor/image-compressor.js')); ?>"></script>
        <script src="<?php echo e(asset('js/AI/compressor/compressor.min.js')); ?>"></script>
    <?php endif; ?>
        ...
        $(document).ready(async function() {   
            if (authRole === 'employee') {               
                ...
                if (!currentPermissions.isActive) {
                    ...
                    $('.page-btn').hide();
                    $('.restaurant_payout_create').html('<p class="text-center text-danger font-weight-bold"><?php echo e(trans("lang.no_permission")); ?></p>');
                    return;
                }
            }             
        });
        getVendorId(vendorUserId).then(async data => {
                ...
                if(globalTax.taxScope == "product" && countryName){
                    ...
                    database.collection('tax').where('enable','==',true).where('scope','==','product').where('country','==',countryName).where('sectionId','==',section_id).get().then(async function(snapshots) {
                        if(snapshots.docs.length > 0){
                            ...
                            $('#taxes').chosen({
                                width: '100%',
                                placeholder_text_multiple: '<?php echo e(trans('lang.select_taxes')); ?>',
                            });
                        }else{
            ...
            attributes.get().then(async function(snapshots) {
                ...
                $("#item_attribute").show().chosen({
                    "placeholder_text": "<?php echo e(trans('lang.select_attribute')); ?>"
                });
            });
            ...
            digitalProductRef.get().then(async function(snapshots) {
                ...
                $(".max_file_size").text('<?php echo e(trans('lang.item_upload_file_max')); ?>' +
            ...
            $(".create_item_btn").click(async function() {
                if (parseInt(itemLimit) == -1 || parseInt(createdItem) < parseInt(itemLimit)) {
                    ...
                    if (name == '') {
                        ...
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.enter_item_name_error')); ?></p>");
                        window.scrollTo(0, 0);
                    } else if (price == '') {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.enter_item_price_error')); ?></p>");
                        window.scrollTo(0, 0);
                    } else if (price <= 0) {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.enter_positive_price_error')); ?></p>");
                        window.scrollTo(0, 0);
                        ...
                        if (item_quantity == '') {
                            $(".error_top").append(
                                "<p><?php echo e(trans('lang.enter_item_quantity_error')); ?></p>");
                        } else {
                            $(".error_top").append(
                                "<p><?php echo e(trans('lang.invalid_item_quantity_error')); ?></p>");
                        }
                        window.scrollTo(0, 0);
                    } else if (!category) {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.select_item_category_error')); ?></p>");
                        window.scrollTo(0, 0);
                    } else if (brand == '' && $('.brandDiv').is(':visible') == true) {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.select_brand_error')); ?></p>");
                        window.scrollTo(0, 0);
                    } else if (description == '') {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.enter_item_description_error')); ?></p>");
                        window.scrollTo(0, 0);
                    } else if (parseInt(price) < parseInt(discount)) {
                        $(".error_top").show();
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.price_should_not_less_then_discount_error')); ?></p>"
                        );
                        window.scrollTo(0, 0);
                        ...
                        $(".error_top").html("");
                        $(".error_top").append(
                            "<p><?php echo e(trans('lang.upload_digital_file_error')); ?></p>");
                        window.scrollTo(0, 0);
                            ...
                            await storeVariantImageData().then(async (vIMG) => {
                                ...
                                $.each(variantsSet, function(key, variant) {
                                    ...
                                    if (!variant_price || parseFloat(
                                        ...
                                        $(".error_top").html("");
                                        $(".error_top").append(
                                            "<p><?php echo e(trans('lang.enter_positive_variant_price_error')); ?></p>"
                                        );
                                        window.scrollTo(0, 0);
                                        isValid = true;
                    ...
                    $(".error_top").html("");
                    $(".error_top").append(
                        "<p><?php echo e(trans('lang.create_item_limit_exceed')); ?></p>"
                    );
                    window.scrollTo(0, 0);
                }
            ...
            reader.onload = (function(theFile) {
                return function(e) {
                    ...
                    if (size > max_file_size) {
                        ...
                        alert('<?php echo e(trans('lang.max_file_limit_error')); ?>' + allowed_file_size + 'Mb');
                        return false;
                    }
                    ...
                    if (ext == "jpg" || ext == "jpeg" || ext == "png" || ext == "gif" || ext == "zip" || ext ==
                        ...
                        $("#digital_product_file").val('');
                        alert('<?php echo e(trans('lang.enter_valid_file_ext')); ?>')
                        return false;
                    }
                };
            })(f);
        ...
        function variants_update() {
            ...
            if (item_attribute.length > 0) {
                ...
                if (attributeSet.length > 0) {
                    ...
                    html += '<tr>';
                    html += '<th class="text-center"><span class="control-label"><?php echo e(trans('lang.variant')); ?></span></th>';
                    html += '<th class="text-center"><span class="control-label"><?php echo e(trans('lang.variant_price')); ?></span></th>';
                    html += '<th class="text-center"><span class="control-label"><?php echo e(trans('lang.variant_quantity')); ?></span></th>';
                    html += '<th class="text-center"><span class="control-label"><?php echo e(trans('lang.variant_image')); ?></span></th>';
                    html += '</tr>';
                    html += '</thead>';
                    html += '<tbody>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/items/create.blade.php ENDPATH**/ ?>