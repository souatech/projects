<!doctype html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" <?php if (str_replace('_', '-', app()->getLocale()) == 'ar' || @$_COOKIE['is_rtl'] == 'true') { ?> dir="rtl" <?php } ?>>
    ...
    <head>
        ...
        <link href="<?php echo e(asset('assets/plugins/bootstrap/css/bootstrap-rtl.min.css')); ?>" rel="stylesheet">
        <?php } ?>
        <link href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet">
        <?php if (str_replace('_', '-', app()->getLocale()) == 'ar' || @$_COOKIE['is_rtl'] == 'true') { ?>
        <link href="<?php echo e(asset('css/style_rtl.css')); ?>" rel="stylesheet">
        <?php } ?>
    ...
    <body>
                ...
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('orders')); ?>" id="notification_url"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="notification_book_table_order" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('booktable')); ?>" id="notification_book_table_url"><?php echo e(trans('lang.go')); ?></a>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="notification_accepted_order" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('orders')); ?>" id="notification_accepted_a"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="advertisement_accepted_notification" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('advertisements')); ?>" id="advertisement_accepted_route"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="advertisement_canceled_notification" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('advertisements')); ?>" id="advertisement_canceled_route"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="advertisement_paused_notification" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('advertisements')); ?>" id="advertisement_paused_route"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="advertisement_resumed_notification" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered notification-main" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="<?php echo e(route('advertisements')); ?>" id="advertisement_resumed_route"><?php echo e(trans('lang.go')); ?></a></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            const datatableLang = {
                "decimal":        "",
                "emptyTable":     "<?php echo e(trans('lang.no_record_found')); ?>",
                "info":           "<?php echo e(trans('lang.datatable_info')); ?>", 
                "infoEmpty":      "<?php echo e(trans('lang.datatable_info_empty')); ?>", 
                "infoFiltered":   "<?php echo e(trans('lang.datatable_info_filtered')); ?>", 
                "lengthMenu":     "<?php echo e(trans('lang.datatable_length_menu')); ?>",
                "loadingRecords": "<?php echo e(trans('lang.loading')); ?>",
                "processing":     "<?php echo e(trans('lang.processing')); ?>",
                "search":         "<?php echo e(trans('lang.search')); ?>",
                "zeroRecords":    "<?php echo e(trans('lang.no_record_found')); ?>",
                "paginate": {
                    "first":      "<?php echo e(trans('lang.first')); ?>",
                    "last":       "<?php echo e(trans('lang.last')); ?>",
                    "next":       "<?php echo e(trans('lang.next')); ?>",
                    "previous":   "<?php echo e(trans('lang.previous')); ?>"
                },
                "aria": {
                    "sortAscending":  ": <?php echo e(trans('lang.sort_asc')); ?>",
                    "sortDescending": ": <?php echo e(trans('lang.sort_desc')); ?>"
                }
            };
        </script>
        ...
        <script type="text/javascript">
            ...
            var booktable = '<?php echo e(route('booktable.edit', ':id')); ?>';
            ...
            database.collection('users').where('id', '==', cuser_id).get().then(async function(snapshots) {
                ...
                var photoURL = userData.profilePictureURL 
                    ...
                    : "<?php echo e(asset('images/users/user-2.png')); ?>";

                document.querySelectorAll('.userimage').forEach(function(img) {
                    img.src = photoURL;
                    img.onerror = function() {
                        this.onerror = null;
                        this.src = "<?php echo e(asset('images/users/user-2.png')); ?>";
                    };
                });
                        ...
                        if (pageLoadedAdvertisement) {
                            doc.docChanges().forEach(function(change) {
                                ...
                                if (change.type == "modified") {
                                    var routeAdview = "<?php echo e(route('advertisements.view', ':id')); ?>";
            ...
            if (localStorage.getItem('joxmako_new_vendor')) {
                localStorage.removeItem('joxmako_new_vendor');
                Swal.fire({
                    icon: 'info',
                    title: '',
                    text: "<?php echo e(trans('lang.vendor_document_reminder')); ?>",
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/layouts/app.blade.php ENDPATH**/ ?>