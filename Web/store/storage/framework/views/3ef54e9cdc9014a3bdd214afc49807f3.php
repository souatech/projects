<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        ...
        <div class="card-body">
            ...
            <div class="text-right print-btn">
                <a href="<?php echo e(route('vendors.orderprint', $id)); ?>">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="order_detail-top-box">
                                        ...
                                        <div class="form-group row width-100 ">
                                            <label class="col-3 control-label"><?php echo e(trans('lang.status')); ?>:</label>
                                            <div class="col-7">
                                                <select id="order_status" class="form-control">
                                                    ...
                                                    <option value="Order Accepted" id="order_accepted">
                                                        <?php echo e(trans('lang.order_accepted')); ?>
                                                    ...
                                                    <option value="Driver Pending" id="driver_pending">
                                                        <?php echo e(trans('lang.driver_pending')); ?>

                                                    </option>
                                                    <option value="Driver Rejected" id="driver_rejected">
                                                        <?php echo e(trans('lang.driver_rejected')); ?>
                                                    ...
                                                    <option value="In Transit" id="in_transit">
                                                        <?php echo e(trans('lang.in_transit')); ?>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7 text-right">
                                                <button type="button" class="btn btn-primary save_order_btn show_popup" >
                                                    <i class="fa fa-save"></i> <?php echo e(trans('lang.update')); ?>
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="table table-striped table-valign-middle">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-head" style="display:none;"><?php echo e(trans('lang.file')); ?></th>
                                                    <th><?php echo e(trans('lang.price')); ?></th>
                                                    <th><?php echo e(trans('lang.qty')); ?></th>
                                                    <th><?php echo e(trans('lang.extra')); ?></th>
                        ...
                        <div class="order_edit-genrl col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="address order_detail-top-box">
                                        <div class="form-group row widt-100 gendetail-col">
                                            <label class="col-12 control-label"><strong><?php echo e(trans('lang.name')); ?>:</strong>
                                                <span id="billing_name"></span></label>
                                        </div>
                                        <div class="form-group row widt-100 gendetail-col" id="billing_adrs">
                                            <label class="col-12 control-label"><strong><?php echo e(trans('lang.address')); ?>
                            ...
                            <div class="order_addre-edit mt-4 driver_details_hide">
                                <div class="card">
                                    <div class="card-header bg-white">
                                        <h3><?php echo e(trans('lang.driver_detail')); ?></h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="address order_detail-top-box">
                                            <p>
                                ...
                                <div class="rental-review ">
                                    <div class="card">
                                        <div class="card-header bg-white box-header">
                                            <h3><?php echo e(trans('lang.customer_reviews')); ?></h3>
                                        </div>
                                        <div class="card-body">
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="javascript:window.history.go(-1);" class="btn btn-default"><i class="fa fa-undo"></i><?php echo e(trans('lang.cancel')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="order-assign-btn"><?php echo e(trans('lang.assign')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"  data-bs-dismiss="modal" aria-label="Close"><?php echo e(trans('close')); ?></a>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="orderTrakingModal" tabindex="-1" role="dialog" aria-labelledby="orderTrakingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered location_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="orderTrakingModalLabel"><?php echo e(trans('lang.please_provide_details')); ?>
      ...
      $(document).ready(function () {
        ...
        $(document).ready(function() {
            ...
            ref.get().then(async function(snapshots) {
                if (!snapshots || snapshots.empty || !snapshots.docs[0]) {
                    jQuery("#data-table_processing").hide();
                    console.error('[Edit] Order not found: ' + (id || pid || aid || rid));
                    return;
                }
                ...
                if (order.vendor.section_id != undefined && order.vendor.section_id != '') {
                    ...
                    async function loadZones(zoneId) {
                        const $select = $('#zone');
                        $select.empty().append('<option value=""><?php echo e(trans('lang.select_zone')); ?></option>');
                ...
                if (order.hasOwnProperty('scheduleTime') && order.scheduleTime != null && order
                    ...
                    $('.schedule_date').append(
                        '<label class="col-12 control-label"><strong><?php echo e(trans('lang.schedule_date_time')); ?>:</strong><span id=""> ' +
                ...
                if (order.hasOwnProperty('estimatedTimeToPrepare') && order.estimatedTimeToPrepare !=
                    ...
                    $('.prepare_time').append(
                        '<label class="col-12 control-label "><strong><?php echo e(trans('lang.prepare_time')); ?>:</strong><span id=""> ' +
                        time + '</span></label>')
                }
            ...
            $(".save_order_btn").click(async function() {
                ...
                if (parseInt(subscriptionTotalOrders) == 0) {
                    alert("<?php echo e(trans('lang.can_not_accept_more_orders')); ?>");
                    return false;
                }
        ...
        function buildHTMLProductsList(snapshotsProducts) {
            ...
            snapshotsProducts.forEach((product) => {
                ...
                if (extra_count > 1) {
                    html = html +
                        '<div class="extra"><span><?php echo e(trans('lang.extras')); ?> :</span><span class="ext-item">' +
                        extra_html + '</span></div>';
                }
                if (product.size) {
                    html = html +
                        '<div class="type"><span><?php echo e(trans('lang.type')); ?> :</span><span class="ext-size">' +
        ...
        function getProductInfo(product) {
            ...
            database.collection('vendor_products').doc(productId).get().then(async function(snapshots) {
                if (snapshots.exists) {
                    ...
                    $(".base-price-" + product_id).text('(<?php echo e(trans("lang.base_price")); ?>: ' + base_price_format + ')');
                }
            });
        }
        ...
        $('#add-deliveryman-btn').on('click', async function () {
            ...
            var hasError = false;
            if (userFirstName === '') {
                $("#firstname_err").text("<?php echo e(trans('lang.user_first_name_help')); ?>");
                hasError = true;
            }
            if (userLastName === '') {
                $("#lastname_err").text("<?php echo e(trans('lang.user_last_name_help')); ?>");
                hasError = true;
            }
            if (email === '') {
                $("#email_err").text("<?php echo e(trans('lang.user_email_help')); ?>");
                hasError = true;
            }
            if (password === '') {
                $("#password_err").text("<?php echo e(trans('lang.user_password_help')); ?>");
                hasError = true;
            }
            if (userPhone === '') {
                $("#phone_err").text("<?php echo e(trans('lang.user_phone_help')); ?>");
                hasError = true;
            }
            if(!serviceFlag){
                hasError = true;
                $("#error_top").text("<?php echo e(trans('lang.something_went_wrong')); ?>");
            }
            ...
            ref.get().then(async function(snapshot) {
                ...
                try {
                    ...
                    if (orderData.payment_method !== 'cod') {
                        ...
                        customerAmount = parseFloat(orderPaytableAmount);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/orders/edit.blade.php ENDPATH**/ ?>