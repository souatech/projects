...
<div class="container">
    <div class="row page-titles ">
        ...
        <div class="col-md-12 align-self-center text-center">
            <h3 class="text-themecolor  "><?php echo e(trans('lang.sign_up_with_us')); ?></h3>
        </div>
        ...
        <div class="form-group col-12 text-center">
            ...
            <div class="new-acc d-flex align-items-center justify-content-center">
                ...
                <a href="<?php echo e(route('register.phone')); ?>" class="btn btn-primary" id="btn-signup-phone">
            ...
            <a href="<?php echo e(route('login')); ?>">
                ...
                <p class="text-center m-0"> <?php echo e(trans('lang.already_an_account')); ?> <?php echo e(trans('lang.sign_in')); ?></p>
...
<script>
    ...
    $(".create_vendor_btn").click(async function () {
        ...
        isStoreVerification = docData.isStoreVerification || false;
        ...
        if (userFirstName == '') {
            ...
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p><?php echo e(trans('lang.enter_owners_lastname_error')); ?></p>");
            window.scrollTo(0, 0);
        } else if (email == '') {
            $(".error_top").show();
            $(".error_top").html("");
            ...
            window.scrollTo(0, 0);
        } else if (password == '' && !(loginType === 'google' && existingUUID)) {
            $(".error_top").show();
            $(".error_top").html("");
                        ...
                        database.collection('users').doc(existingUUID).set({
                            ...
                            autoAprroveVendor.get().then(async function (snapshots) {
                                ...
                                if (emailTemplatesData) {
                                    ...
                                    emailSubject = emailTemplatesData.subject;
                                    emailMessage = emailTemplatesData.message;
                                }

                                var url = "<?php echo e(url('send-email')); ?>";

                                var sendEmailStatus = await sendEmail(url, emailSubject, emailMessage, [adminEmail]);
                                ...
                                if (sendEmailStatus) {
                                    ...
                                    if (vendordata.auto_approve_vendor == false) {
                                        $(".alert-success").show();
                                        $(".alert-success").html("");
                                        $(".alert-success").append("<p><?php echo e(trans('lang.signup_waiting_approval')); ?></p>");
                                        window.scrollTo(0, 0);
                                        setTimeout(function () {
                                            localStorage.setItem('joxmako_new_vendor', '1');
                                            window.location.href = '<?php echo e(route("login")); ?>';
                                        }, 5000);
                                    } else {
                                        $(".alert-success").show();
                                        $(".alert-success").html("");
                                        $(".alert-success").append("<p><?php echo e(trans('lang.thank_you_signup_msg')); ?></p>");
                                        window.scrollTo(0, 0);
                                        setTimeout(function () {
                                            localStorage.setItem('joxmako_new_vendor', '1');
                                            window.location.href = '<?php echo e(route("login")); ?>';
                        ...
                        .catch(function (error) {
                            ...
                            switch (error.code) {
                                case 'auth/email-already-in-use':
                                    message = "<?php echo e(trans('lang.email_already_in_use')); ?>";
                                    break;
                                case 'auth/invalid-email':
                                    message = "<?php echo e(trans('lang.invalid_email_address')); ?>";
                                    break;
                                case 'auth/weak-password':
                                    message = "<?php echo e(trans('lang.password_too_weak')); ?>";
                                    break;
                                case 'auth/operation-not-allowed':
                                    message = "<?php echo e(trans('lang.email_password_signup_not_enabled')); ?>";
                                    break;
                                ...
                                case 'auth/too-many-requests':
                                    ...
                                    break;
                                default:
                                    message = "<?php echo e(trans('lang.unexpected_error')); ?>";
                            }
                            jQuery("#data-table_processing").hide();
    ...
    function chkAlphabets3(event, msg) {
        if (!((event.which >= 48 && event.which <= 57) || (event.which >= 97 && event.which <= 122))) {
            document.getElementById(msg).innerHTML = "<?php echo e(trans('lang.special_characters_not_accepted')); ?>";
            return false;
        } else {
            document.getElementById(msg).innerHTML = "";
            return true;
...
<?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/auth/register.blade.php ENDPATH**/ ?>