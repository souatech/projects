...
<div id="main-wrapper" class="page-wrapper" style="min-height: 207px;">
	...
	<div class="container-fluid">
		...
		<div id="data-table_processing" class="dataTables_processing panel panel-default"
             style="display: none;margin-top:20px;"><?php echo e(trans('lang.processing')); ?>
		...
		<div class="card mb-3 business-analytics" style="display:none">
			...
			<div class="card-body">
				...
				<div class="row flex-between align-items-center g-2 mb-3 order_stats_header">
					<div class="col-sm-6">
						<h4 class="d-flex align-items-center text-capitalize gap-10 mb-0"><?php echo e(trans('lang.dashboard_business_analytics')); ?></h4>
					</div>
				</div>
				...
				<div class="row business-analytics_list">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-3">
                            <div class="card card-box-with-icon bg--8 redirectionCheck" onclick="location.href='<?php echo route('payments'); ?>'">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="box-icon ab">
                                        <img src="<?php echo e(asset('images/total_earning.png')); ?>"/>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-3">
                            <div class="card card-box-with-icon bg--5 redirectionCheck" onclick="location.href='<?php echo route('orders'); ?>'">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="card-box-with-content">
                                    ...
                                    <span class="box-icon ab">
                                        <img src="<?php echo e(asset('images/active_restaurant.png')); ?>"/>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-3">
                            <div class="card card-box-with-icon bg--24 redirectionCheck" onclick="location.href='<?php echo route('items'); ?>'">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="card-box-with-content">
                                        <h2 class="text-dark-2 mb-1 h4 product_count" id="product_count"></h2>
                                        <p class="mb-0 small text-dark-2"><?php echo e(trans('lang.dashboard_total_products')); ?></p>
                                    </div>
                                
                                    <span class="box-icon ab">
                                        <img src="<?php echo e(asset('images/dproduct.png')); ?>"/>
                                    </span>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status pending redirectionCheck" href="<?php echo route('orders'); ?>">
						<div class="data">
							<i class="mdi mdi-lan-pending"></i>
							<h6 class="status"><?php echo e(trans('lang.dashboard_order_placed')); ?></h6>
						</div> <span class="count" id="placed_count"></span> </a>
					</div>

					<div class="col-sm-6 col-lg-3">
						<a class="order-status confirmed redirectionCheck" href="<?php echo route('orders'); ?>">
						<div class="data">
							<i class="mdi mdi-check-circle"></i>
							<h6 class="status"><?php echo e(trans('lang.dashboard_order_confirmed')); ?></h6>
						</div> <span class="count" id="confirmed_count"></span> </a>
					</div>

					<div class="col-sm-6 col-lg-3">
						<a class="order-status packaging redirectionCheck" href="<?php echo route('orders'); ?>">
						<div class="data">
							<i class="mdi mdi-clipboard-outline"></i>
							<h6 class="status"><?php echo e(trans('lang.dashboard_order_shipped')); ?></h6>
						</div> <span class="count" id="shipped_count"></span> </a>
					</div>

					<div class="col-sm-6 col-lg-3">
						<a class="order-status delivered redirectionCheck" href="<?php echo route('orders'); ?>">
							<div class="data">
								<i class="mdi mdi-check-circle-outline"></i>
								<h6 class="status"><?php echo e(trans('lang.dashboard_order_completed')); ?></h6>
							</div>
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status canceled redirectionCheck" href="<?php echo route('orders'); ?>">
							<div class="data">
								<i class="mdi mdi-window-close"></i>
								<h6 class="status"><?php echo e(trans('lang.dashboard_order_canceled')); ?></h6>
							</div>
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status failed redirectionCheck" href="<?php echo route('orders'); ?>">
							<div class="data">
								<i class="mdi mdi-alert-circle-outline"></i>
								<h6 class="status"><?php echo e(trans('lang.dashboard_order_failed')); ?></h6>
							</div>
					...
					<div class="col-sm-6 col-lg-3">
						<a class="order-status failed redirectionCheck" href="<?php echo route('orders'); ?>">
							<div class="data">
								...
								<h6 class="status"><?php echo e(trans('lang.dashboard_order_pending')); ?></h6>
							</div>
		...
		<div class="row business-analytics-graph" style="display:none">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-row justify-content-end">
                            <span class="mr-2"> <i class="fa fa-square" style="color:#2EC7D9"></i> <?php echo e(trans('lang.dashboard_this_year')); ?> </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
            	<div class="card">
                	<div class="card-header no-border">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title"><?php echo e(trans('lang.sales_overview')); ?></h3>
                        </div>
                    </div>
					<div class="card-body">
            	        <div class="flex-row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header no-border d-flex justify-content-between">
                        <h3 class="card-title"><?php echo e(trans('lang.recent_orders')); ?></h3>
                        <div class="card-tools">
                            <a href="<?php echo e(route('orders')); ?>" class="btn btn-tool btn-sm redirectionCheck"><i class="fa fa-bars"></i> </a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive m-t-10">
                            <table class="display nowrap table table-hover table-striped table-bordered table table-striped"
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(trans('lang.order_date')); ?></th>
    ...
    function setVisitors(){
    	...
    	const data = {
		  labels: [
		    ...
		    "<?php echo e(trans('lang.dashboard_total_products')); ?>",
		  ],
		  datasets: [{
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u844577645/domains/joxmako.com/public_html/store/resources/views/home.blade.php ENDPATH**/ ?>