    ...
    database.collection('users').doc(vendorUserId).get().then(async function(usersnapshots) {
        ...
        if(userData.role == "vendor"){
            ...
            if (checkVendor != null) {
                ...
                newLi += `<li class="{{ request()->routeIs('payments', 'payments.create') ? 'active' : '' }}"> <a class="waves-effect waves-dark" href="{!! route('payments') !!}" aria-expanded="false">
                                    <i class="mdi mdi-file-document-outline"></i>
                                    <span class="hide-menu">Demandes de paiement</span>
                                </a>
            ...
            newLi += `<li class="{{ request()->routeIs('wallettransaction.index') ? 'active' : '' }}"> <a class="waves-effect waves-dark" href="{!! route('wallettransaction.index') !!}" aria-expanded="false">
                                        ...
                                        <span class="hide-menu">Mes revenus</span>
                                    </a>
                                </li>

                                <li class="{{ request()->routeIs('withdraw-method', 'withdraw-method.create') ? 'active' : '' }}">
                                    <a class=" waves-effect waves-dark" href="{!! route('withdraw-method') !!}" aria-expanded="false">
                                        <i class="mdi mdi-cellphone"></i>
                                        <span class="hide-menu">Méthode de paiement</span>
                                    </a>
                                </li>`;
